...
class MacSettingsDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["htmlSubfilter", "tagRegexp", "icuSubFilter", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["htmlSubfilter", "tagRegexp", "icuSubFilter", ], str]):
