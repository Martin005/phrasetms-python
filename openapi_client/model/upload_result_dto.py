...
class UploadResultDto(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            asyncTaskId = schemas.StrSchema
        
            @staticmethod
            def errors() -> typing.Type['ConnectorErrorsDto']:
                return ConnectorErrorsDto
            __annotations__ = {
                "id": id,
                "name": name,
                "folder": folder,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["asyncTaskId"]) -> MetaOapg.properties.asyncTaskId: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["errors"]) -> 'ConnectorErrorsDto': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "folder", "encodedName", "size", "error", "asyncTaskId", "errors", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["asyncTaskId"]) -> typing.Union[MetaOapg.properties.asyncTaskId, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["errors"]) -> typing.Union['ConnectorErrorsDto', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "folder", "encodedName", "size", "error", "asyncTaskId", "errors", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        asyncTaskId: typing.Union[MetaOapg.properties.asyncTaskId, str, schemas.Unset] = schemas.unset,
        errors: typing.Union['ConnectorErrorsDto', schemas.Unset] = schemas.unset,
