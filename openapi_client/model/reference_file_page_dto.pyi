...
class ReferenceFilePageDto(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def access() -> typing.Type['ReferenceFileAccessDto']:
                return ReferenceFileAccessDto
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["access"]) -> 'ReferenceFileAccessDto': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["totalElements", "totalPages", "pageSize", "pageNumber", "numberOfElements", "content", "access", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["access"]) -> typing.Union['ReferenceFileAccessDto', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["totalElements", "totalPages", "pageSize", "pageNumber", "numberOfElements", "content", "access", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        access: typing.Union['ReferenceFileAccessDto', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
