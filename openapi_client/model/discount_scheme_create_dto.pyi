...
class DiscountSchemeCreateDto(
        ...
        class properties:
            ...
            class workflowStepNetSchemes(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['NetRateSchemeWorkflowStepCreate']:
                        return NetRateSchemeWorkflowStepCreate
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['NetRateSchemeWorkflowStepCreate'], typing.List['NetRateSchemeWorkflowStepCreate']],
                ...
                def __getitem__(self, i: int) -> 'NetRateSchemeWorkflowStepCreate':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "rates", "workflowStepNetSchemes", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "rates", "workflowStepNetSchemes", ], str]):
