...
class Query(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["query", "lang", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["query", "lang", ], str]):
