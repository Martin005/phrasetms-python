...
class TransMemoryCreateDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "sourceLang", "targetLangs", "client", "businessUnit", "domain", "subDomain", "note", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "sourceLang", "targetLangs", "client", "businessUnit", "domain", "subDomain", "note", ], str]):
