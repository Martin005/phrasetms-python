...
class RemoteUploadedFileDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["uid", "name", "size", "type", "url", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["uid", "name", "size", "type", "url", ], str]):
