...
class MachineTranslateSettingsDto(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "uid", "baseName", "name", "type", "category", "default_", "includeTags", "mtQualityEstimation", "enabled", "args", "langs", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "uid", "baseName", "name", "type", "category", "default_", "includeTags", "mtQualityEstimation", "enabled", "args", "langs", ], str]):
        return super().get_item_oapg(name)
