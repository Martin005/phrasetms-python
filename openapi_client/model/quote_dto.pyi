...
class QuoteDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "uid", "name", "status", "currency", "billingUnit", "createdBy", "dateCreated", "totalPrice", "netRateScheme", "priceList", "workflowStepList", "provider", "customerEmail", "quoteType", "editable", "outdated", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "uid", "name", "status", "currency", "billingUnit", "createdBy", "dateCreated", "totalPrice", "netRateScheme", "priceList", "workflowStepList", "provider", "customerEmail", "quoteType", "editable", "outdated", ], str]):
