...
class CreateProjectV3Dto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "sourceLang", "targetLangs", "client", "businessUnit", "domain", "subDomain", "costCenter", "purchaseOrder", "workflowSteps", "dateDue", "note", "lqaProfiles", "customFields", "fileHandover", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "sourceLang", "targetLangs", "client", "businessUnit", "domain", "subDomain", "costCenter", "purchaseOrder", "workflowSteps", "dateDue", "note", "lqaProfiles", "customFields", "fileHandover", ], str]):
