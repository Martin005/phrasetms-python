...
class LoginWithGoogleDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["idToken", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["idToken", ], str]):
