...
class WildCardSearchRequestDto(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["sourceLang", "query", "targetLangs", "count", "offset", "sourceLangs", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["sourceLang", "query", "targetLangs", "count", "offset", "sourceLangs", ], str]):
