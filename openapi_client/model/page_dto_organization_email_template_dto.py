...
class PageDtoOrganizationEmailTemplateDto(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class content(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['OrganizationEmailTemplateDto']:
                        return OrganizationEmailTemplateDto
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['OrganizationEmailTemplateDto'], typing.List['OrganizationEmailTemplateDto']],
                ...
                def __getitem__(self, i: int) -> 'OrganizationEmailTemplateDto':
