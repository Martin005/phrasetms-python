...
class Typo3(
    ...
    class MetaOapg:
        ...
        class all_of_1(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["host", "sourceLang", "token", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["host", "sourceLang", "token", ], str]):
