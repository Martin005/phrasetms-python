...
class PageDtoAbstractProjectDto(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class content(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['AbstractProjectDto']:
                        return AbstractProjectDto
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['AbstractProjectDto'], typing.List['AbstractProjectDto']],
                ...
                def __getitem__(self, i: int) -> 'AbstractProjectDto':
