...
class ResxSettingsDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["tagRegexp", "htmlSubFilter", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["tagRegexp", "htmlSubFilter", ], str]):
