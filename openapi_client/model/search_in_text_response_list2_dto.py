        ...
        class properties:
            ...
            class searchResults(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['SearchInTextResponse2Dto']:
                        return SearchInTextResponse2Dto
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['SearchInTextResponse2Dto'], typing.List['SearchInTextResponse2Dto']],
                ...
                def __getitem__(self, i: int) -> 'SearchInTextResponse2Dto':
