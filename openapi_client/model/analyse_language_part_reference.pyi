...
class AnalyseLanguagePartReference(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "sourceLang", "targetLang", "jobs", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "sourceLang", "targetLang", "jobs", ], str]):
