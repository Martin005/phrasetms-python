...
class TypesDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["types", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["types", ], str]):
