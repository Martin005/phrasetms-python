...
class PageDtoTranslationPriceListDto(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class content(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TranslationPriceListDto']:
                        return TranslationPriceListDto
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['TranslationPriceListDto'], typing.List['TranslationPriceListDto']],
                ...
                def __getitem__(self, i: int) -> 'TranslationPriceListDto':
