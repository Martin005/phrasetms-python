...
class CreateProjectFromTemplateV2Dto(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "sourceLang", "targetLangs", "workflowSteps", "dateDue", "note", "client", "businessUnit", "domain", "subDomain", "costCenter", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "sourceLang", "targetLangs", "workflowSteps", "dateDue", "note", "client", "businessUnit", "domain", "subDomain", "costCenter", ], str]):
