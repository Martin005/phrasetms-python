...
class DictionaryItemDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["lang", "word", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["lang", "word", ], str]):
