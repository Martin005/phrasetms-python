...
class JobPartExtendedDto(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            wordsCount = schemas.Int32Schema
            beginIndex = schemas.Int32Schema
            endIndex = schemas.Int32Schema
            isParentJobSplit = schemas.BoolSchema
            updateSourceDate = schemas.DateTimeSchema
            updateTargetDate = schemas.DateTimeSchema
            dateCreated = schemas.DateTimeSchema
        
            @staticmethod
            def jobReference() -> typing.Type['JobReference']:
                return JobReference
        
            @staticmethod
            def project() -> typing.Type['ProjectReference']:
                return ProjectReference
            lastWorkflowLevel = schemas.Int32Schema
            workUnit = schemas.DictSchema
            ...
            @staticmethod
            def continuousJobInfo() -> typing.Type['ContinuousJobInfoDto']:
                return ContinuousJobInfoDto
            ...
            __annotations__ = {
                ...
                "updateSourceDate": updateSourceDate,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["beginIndex"]) -> MetaOapg.properties.beginIndex: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["endIndex"]) -> MetaOapg.properties.endIndex: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["isParentJobSplit"]) -> MetaOapg.properties.isParentJobSplit: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["updateSourceDate"]) -> MetaOapg.properties.updateSourceDate: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["updateTargetDate"]) -> MetaOapg.properties.updateTargetDate: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["dateCreated"]) -> MetaOapg.properties.dateCreated: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["jobReference"]) -> 'JobReference': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["project"]) -> 'ProjectReference': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["lastWorkflowLevel"]) -> MetaOapg.properties.lastWorkflowLevel: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["workUnit"]) -> MetaOapg.properties.workUnit: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["continuousJobInfo"]) -> 'ContinuousJobInfoDto': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["uid", "innerId", "status", "providers", "sourceLang", "targetLang", "workflowLevel", "workflowStep", "filename", "dateDue", "wordsCount", "beginIndex", "endIndex", "isParentJobSplit", "updateSourceDate", "updateTargetDate", "dateCreated", "jobReference", "project", "lastWorkflowLevel", "workUnit", "importStatus", "imported", "continuous", "continuousJobInfo", "originalFileDirectory", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["beginIndex"]) -> typing.Union[MetaOapg.properties.beginIndex, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["endIndex"]) -> typing.Union[MetaOapg.properties.endIndex, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["isParentJobSplit"]) -> typing.Union[MetaOapg.properties.isParentJobSplit, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["updateSourceDate"]) -> typing.Union[MetaOapg.properties.updateSourceDate, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["updateTargetDate"]) -> typing.Union[MetaOapg.properties.updateTargetDate, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["jobReference"]) -> typing.Union['JobReference', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["project"]) -> typing.Union['ProjectReference', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["lastWorkflowLevel"]) -> typing.Union[MetaOapg.properties.lastWorkflowLevel, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["workUnit"]) -> typing.Union[MetaOapg.properties.workUnit, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["continuousJobInfo"]) -> typing.Union['ContinuousJobInfoDto', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        beginIndex: typing.Union[MetaOapg.properties.beginIndex, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        endIndex: typing.Union[MetaOapg.properties.endIndex, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        isParentJobSplit: typing.Union[MetaOapg.properties.isParentJobSplit, bool, schemas.Unset] = schemas.unset,
        updateSourceDate: typing.Union[MetaOapg.properties.updateSourceDate, str, datetime, schemas.Unset] = schemas.unset,
        updateTargetDate: typing.Union[MetaOapg.properties.updateTargetDate, str, datetime, schemas.Unset] = schemas.unset,
        dateCreated: typing.Union[MetaOapg.properties.dateCreated, str, datetime, schemas.Unset] = schemas.unset,
        jobReference: typing.Union['JobReference', schemas.Unset] = schemas.unset,
        project: typing.Union['ProjectReference', schemas.Unset] = schemas.unset,
        lastWorkflowLevel: typing.Union[MetaOapg.properties.lastWorkflowLevel, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        workUnit: typing.Union[MetaOapg.properties.workUnit, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        ...
        continuousJobInfo: typing.Union['ContinuousJobInfoDto', schemas.Unset] = schemas.unset,
