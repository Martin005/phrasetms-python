...
class JobPartUpdateSourceDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["uid", "status", "targetLang", "filename", "workflowLevel", "workflowStep", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["uid", "status", "targetLang", "filename", "workflowLevel", "workflowStep", ], str]):
