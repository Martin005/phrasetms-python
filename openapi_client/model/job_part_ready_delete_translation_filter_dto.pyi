...
class JobPartReadyDeleteTranslationFilterDto(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def owner() -> typing.Type['UidReference']:
                return UidReference
            dateDue = schemas.DateTimeSchema
            dueInHours = schemas.Int32Schema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["owner"]) -> 'UidReference': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["dateDue"]) -> MetaOapg.properties.dateDue: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["dueInHours"]) -> MetaOapg.properties.dueInHours: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["filename", "statuses", "targetLang", "provider", "owner", "dateDue", "dueInHours", "overdue", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["owner"]) -> typing.Union['UidReference', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["dateDue"]) -> typing.Union[MetaOapg.properties.dateDue, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["dueInHours"]) -> typing.Union[MetaOapg.properties.dueInHours, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["filename", "statuses", "targetLang", "provider", "owner", "dateDue", "dueInHours", "overdue", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        owner: typing.Union['UidReference', schemas.Unset] = schemas.unset,
        dateDue: typing.Union[MetaOapg.properties.dateDue, str, datetime, schemas.Unset] = schemas.unset,
        dueInHours: typing.Union[MetaOapg.properties.dueInHours, decimal.Decimal, int, schemas.Unset] = schemas.unset,
