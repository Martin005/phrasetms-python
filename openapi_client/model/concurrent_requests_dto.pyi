...
class ConcurrentRequestsDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["limit", "count", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["limit", "count", ], str]):
