...
class ImportSettingsDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["uid", "name", "createdBy", "dateCreated", "fileImportSettings", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["uid", "name", "createdBy", "dateCreated", "fileImportSettings", ], str]):
