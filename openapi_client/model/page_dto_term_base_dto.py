        ...
        class properties:
            ...
            class content(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TermBaseDto']:
                        return TermBaseDto
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['TermBaseDto'], typing.List['TermBaseDto']],
                ...
                def __getitem__(self, i: int) -> 'TermBaseDto':
