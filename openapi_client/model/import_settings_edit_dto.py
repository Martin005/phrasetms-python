...
class ImportSettingsEditDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["uid", "name", "fileImportSettings", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["fileImportSettings"]) -> 'FileImportSettingsCreateDto': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["uid", "name", "fileImportSettings", ], str]):
