...
class WildCardSearchByJobRequestDtoV3(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["query", "reverse", "count", "offset", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["query", "reverse", "count", "offset", ], str]):
