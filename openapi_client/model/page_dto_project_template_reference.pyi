...
class PageDtoProjectTemplateReference(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class content(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ProjectTemplateReference']:
                        return ProjectTemplateReference
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['ProjectTemplateReference'], typing.List['ProjectTemplateReference']],
                ...
                def __getitem__(self, i: int) -> 'ProjectTemplateReference':
