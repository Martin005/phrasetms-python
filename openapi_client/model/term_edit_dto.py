...
class TermEditDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["text", "lang", "caseSensitive", "exactMatch", "forbidden", "preferred", "status", "usage", "note", "shortTranslation", "termType", "partOfSpeech", "gender", "number", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["text", "lang", "caseSensitive", "exactMatch", "forbidden", "preferred", "status", "usage", "note", "shortTranslation", "termType", "partOfSpeech", "gender", "number", ], str]):
