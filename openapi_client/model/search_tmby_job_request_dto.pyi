...
class SearchTMByJobRequestDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["segment", "workflowLevel", "scoreThreshold", "previousSegment", "nextSegment", "contextKey", "maxSegments", "maxSubSegments", "tagMetadata", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["segment", "workflowLevel", "scoreThreshold", "previousSegment", "nextSegment", "contextKey", "maxSegments", "maxSubSegments", "tagMetadata", ], str]):
