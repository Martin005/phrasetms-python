...
class ProjectTemplateCreateActionDto(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["project", "name", "importSettings", "useDynamicTitle", "dynamicTitle", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["project", "name", "importSettings", "useDynamicTitle", "dynamicTitle", ], str]):
