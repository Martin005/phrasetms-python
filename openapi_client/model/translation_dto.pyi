...
class TranslationDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["lang", "text", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["lang", "text", ], str]):
