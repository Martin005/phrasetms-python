...
class ScimMeta(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["created", "location", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["created", "location", ], str]):
