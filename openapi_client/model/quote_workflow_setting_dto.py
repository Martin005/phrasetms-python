...
class QuoteWorkflowSettingDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["workflowStep", "units", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["workflowStep", "units", ], str]):
