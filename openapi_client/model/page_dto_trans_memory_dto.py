        ...
        class properties:
            ...
            class content(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TransMemoryDto']:
                        return TransMemoryDto
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['TransMemoryDto'], typing.List['TransMemoryDto']],
                ...
                def __getitem__(self, i: int) -> 'TransMemoryDto':
