...
class MisspelledWord(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["word", "offset", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["word", "offset", ], str]):
