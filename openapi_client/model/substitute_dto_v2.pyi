...
class SubstituteDtoV2(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["source", "target", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["source", "target", ], str]):
