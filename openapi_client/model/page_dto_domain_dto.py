        ...
        class properties:
            ...
            class content(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['DomainDto']:
                        return DomainDto
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['DomainDto'], typing.List['DomainDto']],
                ...
                def __getitem__(self, i: int) -> 'DomainDto':
