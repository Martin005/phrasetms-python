...
class SearchTMSegmentDtoV3(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def project() -> typing.Type['SearchTMProjectDtoV3']:
                return SearchTMProjectDtoV3
        
            @staticmethod
            def client() -> typing.Type['SearchTMClientDtoV3']:
                return SearchTMClientDtoV3
        
            @staticmethod
            def domain() -> typing.Type['SearchTMDomainDtoV3']:
                return SearchTMDomainDtoV3
        
            @staticmethod
            def subDomain() -> typing.Type['SearchTMSubDomainDtoV3']:
                return SearchTMSubDomainDtoV3
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["project"]) -> 'SearchTMProjectDtoV3': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["client"]) -> 'SearchTMClientDtoV3': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["domain"]) -> 'SearchTMDomainDtoV3': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["subDomain"]) -> 'SearchTMSubDomainDtoV3': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["targetNote"]) -> MetaOapg.properties.targetNote: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "text", "lang", "rtl", "modifiedAt", "createdAt", "modifiedBy", "createdBy", "filename", "project", "client", "domain", "subDomain", "tagMetadata", "previousSegment", "nextSegment", "key", "targetNote", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["project"]) -> typing.Union['SearchTMProjectDtoV3', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["client"]) -> typing.Union['SearchTMClientDtoV3', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["domain"]) -> typing.Union['SearchTMDomainDtoV3', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["subDomain"]) -> typing.Union['SearchTMSubDomainDtoV3', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["targetNote"]) -> typing.Union[MetaOapg.properties.targetNote, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "text", "lang", "rtl", "modifiedAt", "createdAt", "modifiedBy", "createdBy", "filename", "project", "client", "domain", "subDomain", "tagMetadata", "previousSegment", "nextSegment", "key", "targetNote", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        project: typing.Union['SearchTMProjectDtoV3', schemas.Unset] = schemas.unset,
        client: typing.Union['SearchTMClientDtoV3', schemas.Unset] = schemas.unset,
        domain: typing.Union['SearchTMDomainDtoV3', schemas.Unset] = schemas.unset,
        subDomain: typing.Union['SearchTMSubDomainDtoV3', schemas.Unset] = schemas.unset,
        ...
        targetNote: typing.Union[MetaOapg.properties.targetNote, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
