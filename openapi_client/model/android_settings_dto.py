...
class AndroidSettingsDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["tagRegexp", "icuSubFilter", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["tagRegexp", "icuSubFilter", ], str]):
