...
class JobPartReadyReferences(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["jobs", "getParts", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["jobs", "getParts", ], str]):
