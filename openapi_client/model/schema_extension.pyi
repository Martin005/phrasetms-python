...
class SchemaExtension(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["schema", "required", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["schema", "required", ], str]):
