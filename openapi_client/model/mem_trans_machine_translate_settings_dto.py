...
class MemTransMachineTranslateSettingsDto(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            glossarySupported = schemas.BoolSchema
            ...
            __annotations__ = {
                ...
                "enabled": enabled,
                "glossarySupported": glossarySupported,
                "args": args,
                "langs": langs,
                "charCount": charCount,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["glossarySupported"]) -> MetaOapg.properties.glossarySupported: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "uid", "baseName", "name", "type", "category", "default_", "includeTags", "mtQualityEstimation", "enabled", "glossarySupported", "args", "langs", "charCount", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["glossarySupported"]) -> typing.Union[MetaOapg.properties.glossarySupported, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "uid", "baseName", "name", "type", "category", "default_", "includeTags", "mtQualityEstimation", "enabled", "glossarySupported", "args", "langs", "charCount", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        glossarySupported: typing.Union[MetaOapg.properties.glossarySupported, bool, schemas.Unset] = schemas.unset,
