...
class SegRuleReference(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "uid", "language", "name", "filename", "primary", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "uid", "language", "name", "filename", "primary", ], str]):
