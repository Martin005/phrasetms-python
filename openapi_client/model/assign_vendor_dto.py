...
class AssignVendorDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["vendor", "dateDue", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["vendor", "dateDue", ], str]):
