...
class SegmentationRuleReference(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "filename", "id", "uid", "locale", "primary", "dateCreated", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "filename", "id", "uid", "locale", "primary", "dateCreated", ], str]):
