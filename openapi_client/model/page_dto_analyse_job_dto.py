        ...
        class properties:
            ...
            class content(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['AnalyseJobDto']:
                        return AnalyseJobDto
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['AnalyseJobDto'], typing.List['AnalyseJobDto']],
                ...
                def __getitem__(self, i: int) -> 'AnalyseJobDto':
