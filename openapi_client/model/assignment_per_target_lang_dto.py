...
class AssignmentPerTargetLangDto(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["targetLang", "providers", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["targetLang", "providers", ], str]):
