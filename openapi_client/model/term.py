...
class Term(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["text", "preferred", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["text", "preferred", ], str]):
