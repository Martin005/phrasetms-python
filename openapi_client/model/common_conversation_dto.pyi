...
class CommonConversationDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "type", "dateCreated", "dateModified", "dateEdited", "createdBy", "comments", "status", "deleted", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "type", "dateCreated", "dateModified", "dateEdited", "createdBy", "comments", "status", "deleted", ], str]):
