...
class TermV2Dto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["text", "id", "lang", "rtl", "modifiedAt", "createdAt", "modifiedBy", "createdBy", "caseSensitive", "exactMatch", "forbidden", "preferred", "status", "conceptId", "usage", "note", "writable", "shortTranslation", "termType", "partOfSpeech", "gender", "number", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["text", "id", "lang", "rtl", "modifiedAt", "createdAt", "modifiedBy", "createdBy", "caseSensitive", "exactMatch", "forbidden", "preferred", "status", "conceptId", "usage", "note", "writable", "shortTranslation", "termType", "partOfSpeech", "gender", "number", ], str]):
