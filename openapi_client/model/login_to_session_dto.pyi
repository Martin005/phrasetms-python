...
class LoginToSessionDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["userName", "password", "rememberMe", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["userName", "password", "rememberMe", ], str]):
