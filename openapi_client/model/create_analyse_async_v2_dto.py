...
class CreateAnalyseAsyncV2Dto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["jobs", "type", "includeFuzzyRepetitions", "separateFuzzyRepetitions", "includeConfirmedSegments", "includeNumbers", "includeLockedSegments", "countSourceUnits", "includeTransMemory", "includeNonTranslatables", "includeMachineTranslationMatches", "transMemoryPostEditing", "nonTranslatablePostEditing", "machineTranslatePostEditing", "name", "netRateScheme", "compareWorkflowLevel", "useProjectAnalysisSettings", "callbackUrl", "provider", ], str]):
