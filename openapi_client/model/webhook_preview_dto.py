...
class WebhookPreviewDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["event", "preview", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["event", "preview", ], str]):
