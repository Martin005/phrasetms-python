...
class CustomFileTypeDto(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def fileImportSettings() -> typing.Type['FileImportSettingsDto']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["fileImportSettings"]) -> 'FileImportSettingsDto': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["uid", "name", "filenamePattern", "type", "createdBy", "dateCreated", "fileImportSettings", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["fileImportSettings"]) -> typing.Union['FileImportSettingsDto', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["uid", "name", "filenamePattern", "type", "createdBy", "dateCreated", "fileImportSettings", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        fileImportSettings: typing.Union['FileImportSettingsDto', schemas.Unset] = schemas.unset,
