...
class ContinuousJobInfoDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["dateUpdated", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["dateUpdated", ], str]):
