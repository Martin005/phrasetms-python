...
class WorkflowStepConfiguration(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["assignments", "id", "due", "notifyProvider", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["assignments", "id", "due", "notifyProvider", ], str]):
