...
class AnalyseReference(
        ...
        class properties:
            ...
            class type(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        ...
                        "Compare": "COMPARE",
                        "PreAnalyseProvider": "PRE_ANALYSE_PROVIDER",
                    }
            ...
            class analyseLanguageParts(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['AnalyseLanguagePartReference']:
                        return AnalyseLanguagePartReference
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['AnalyseLanguagePartReference'], typing.List['AnalyseLanguagePartReference']],
                ...
                def __getitem__(self, i: int) -> 'AnalyseLanguagePartReference':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "uid", "innerId", "type", "name", "provider", "createdBy", "dateCreated", "netRateScheme", "analyseLanguageParts", "outdated", "importStatus", "pureWarnings", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "uid", "innerId", "type", "name", "provider", "createdBy", "dateCreated", "netRateScheme", "analyseLanguageParts", "outdated", "importStatus", "pureWarnings", ], str]):
