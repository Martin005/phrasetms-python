...
class PlainReferences(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["transGroupId", "segmentId", "taskId", "jobPartUid", "conversationTitle", "conversationTitleOffset", "commentedText", "correlation", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["transGroupId", "segmentId", "taskId", "jobPartUid", "conversationTitle", "conversationTitleOffset", "commentedText", "correlation", ], str]):
