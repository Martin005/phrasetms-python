...
class TransMemoryDtoV2(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "uid", "internalId", "name", "sourceLang", "targetLangs", "client", "businessUnit", "domain", "subDomain", "note", "dateCreated", "createdBy", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "uid", "internalId", "name", "sourceLang", "targetLangs", "client", "businessUnit", "domain", "subDomain", "note", "dateCreated", "createdBy", ], str]):
