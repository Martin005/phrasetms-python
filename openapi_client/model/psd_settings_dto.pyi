...
class PsdSettingsDto(
    ...
    class MetaOapg:
        ...
        class properties:
            extractHiddenLayers = schemas.BoolSchema
            extractLockedLayers = schemas.BoolSchema
            tagRegexp = schemas.StrSchema
            __annotations__ = {
                "extractHiddenLayers": extractHiddenLayers,
                "extractLockedLayers": extractLockedLayers,
                "tagRegexp": tagRegexp,
            }
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["extractHiddenLayers"]) -> MetaOapg.properties.extractHiddenLayers: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["extractHiddenLayers", "extractLockedLayers", "tagRegexp", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["extractHiddenLayers"]) -> typing.Union[MetaOapg.properties.extractHiddenLayers, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["extractHiddenLayers", "extractLockedLayers", "tagRegexp", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        extractHiddenLayers: typing.Union[MetaOapg.properties.extractHiddenLayers, bool, schemas.Unset] = schemas.unset,
