...
class TranslationSegmentsReferenceV2(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["confirmed", "locked", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["confirmed", "locked", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        confirmed: typing.Union[MetaOapg.properties.confirmed, bool, schemas.Unset] = schemas.unset,
