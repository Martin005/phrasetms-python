...
class ProjectTemplateTransMemoryDtoV3(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["targetLocale", "workflowStep", "readMode", "writeMode", "transMemory", "penalty", "applyPenaltyTo101Only", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["targetLocale", "workflowStep", "readMode", "writeMode", "transMemory", "penalty", "applyPenaltyTo101Only", ], str]):
