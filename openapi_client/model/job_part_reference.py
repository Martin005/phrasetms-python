...
class JobPartReference(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            jobAssignedEmailTemplate = schemas.DictSchema
            notificationIntervalInMinutes = schemas.Int32Schema
            ...
            __annotations__ = {
                ...
                "imported": imported,
                "jobAssignedEmailTemplate": jobAssignedEmailTemplate,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["jobAssignedEmailTemplate"]) -> MetaOapg.properties.jobAssignedEmailTemplate: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["notificationIntervalInMinutes"]) -> MetaOapg.properties.notificationIntervalInMinutes: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["uid", "status", "providers", "targetLang", "workflowLevel", "workflowStep", "filename", "dateDue", "dateCreated", "updateSourceDate", "imported", "jobAssignedEmailTemplate", "notificationIntervalInMinutes", "continuous", "sourceFileUid", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["jobAssignedEmailTemplate"]) -> typing.Union[MetaOapg.properties.jobAssignedEmailTemplate, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["notificationIntervalInMinutes"]) -> typing.Union[MetaOapg.properties.notificationIntervalInMinutes, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["uid", "status", "providers", "targetLang", "workflowLevel", "workflowStep", "filename", "dateDue", "dateCreated", "updateSourceDate", "imported", "jobAssignedEmailTemplate", "notificationIntervalInMinutes", "continuous", "sourceFileUid", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        jobAssignedEmailTemplate: typing.Union[MetaOapg.properties.jobAssignedEmailTemplate, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        notificationIntervalInMinutes: typing.Union[MetaOapg.properties.notificationIntervalInMinutes, decimal.Decimal, int, schemas.Unset] = schemas.unset,
