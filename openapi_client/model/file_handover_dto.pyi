...
class FileHandoverDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["fileId", "filename", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["fileId", "filename", ], str]):
