...
class TranslationPriceSetListDto(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["priceSets", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["priceSets", ], str]):
