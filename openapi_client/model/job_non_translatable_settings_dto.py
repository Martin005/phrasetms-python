...
class JobNonTranslatableSettingsDto(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["preTranslateNonTranslatables", "confirm100PercentMatches", "lock100PercentMatches", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["preTranslateNonTranslatables", "confirm100PercentMatches", "lock100PercentMatches", ], str]):
