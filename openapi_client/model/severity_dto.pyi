...
class SeverityDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["code", "value", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["code", "value", ], str]):
