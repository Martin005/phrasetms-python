...
class SuggestRequestDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["lang", "words", "referenceTexts", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["lang", "words", "referenceTexts", ], str]):
