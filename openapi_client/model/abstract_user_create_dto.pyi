...
class AbstractUserCreateDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["userName", "firstName", "lastName", "email", "password", "role", "timezone", "receiveNewsletter", "note", "active", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["userName", "firstName", "lastName", "email", "password", "role", "timezone", "receiveNewsletter", "note", "active", ], str]):
