...
class BulkEditAnalyseV2Dto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["analyses", "name", "provider", "netRateScheme", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["analyses", "name", "provider", "netRateScheme", ], str]):
