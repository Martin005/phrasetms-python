...
class TtxSettingsDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["saveConfirmedSegments", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["saveConfirmedSegments", ], str]):
