...
class LqaProfileDetailDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["uid", "name", "errorCategories", "penaltyPoints", "passFailThreshold", "isDefault", "createdBy", "dateCreated", "organization", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["penaltyPoints"]) -> 'PenaltyPointsDto': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["passFailThreshold"]) -> 'PassFailThresholdDto': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["uid", "name", "errorCategories", "penaltyPoints", "passFailThreshold", "isDefault", "createdBy", "dateCreated", "organization", ], str]):
