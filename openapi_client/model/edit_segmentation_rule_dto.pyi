...
class EditSegmentationRuleDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "primary", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "primary", ], str]):
