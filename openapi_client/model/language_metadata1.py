...
class LanguageMetadata1(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["segmentsCount", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["segmentsCount", ], str]):
