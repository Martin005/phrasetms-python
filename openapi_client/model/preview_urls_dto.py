        ...
        class properties:
            ...
            class previews(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['PreviewUrlDto']:
                        return PreviewUrlDto
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['PreviewUrlDto'], typing.List['PreviewUrlDto']],
                ...
                def __getitem__(self, i: int) -> 'PreviewUrlDto':
