...
class AnalyseJobReference(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["uid", "filename", "innerId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["uid", "filename", "innerId", ], str]):
