...
ConceptUidSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'termBaseUid': typing.Union[TermBaseUidSchema, str, ],
        'conceptUid': typing.Union[ConceptUidSchema, str, ],
    }
)
...
request_path_concept_uid = api_client.PathParameter(
    name="conceptUid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ConceptUidSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = ConceptEditDto
...
SchemaFor200ResponseBodyApplicationJson = ConceptWithMetadataDto
...
class UpdateConcept(BaseApi):
    ...
    def update_concept(
        ...
        return self._update_concept_oapg(
            body=body,
