...
# body param
SchemaForRequestBody = EditProjectV2Dto
...
SchemaFor200ResponseBody = AbstractProjectDtoV2
...
class EditProjectV2(BaseApi):
    ...
    def edit_project_v2(
        ...
        return self._edit_project_v2_oapg(
            body=body,
