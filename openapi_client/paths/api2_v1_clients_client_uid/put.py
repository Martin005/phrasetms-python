...
# Path params
ClientUidSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'clientUid': typing.Union[ClientUidSchema, str, ],
    }
)
...
request_path_client_uid = api_client.PathParameter(
    name="clientUid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ClientUidSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = ClientEditDto
...
SchemaFor200ResponseBodyApplicationJson = ClientDto
