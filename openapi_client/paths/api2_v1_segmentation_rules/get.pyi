...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'locales': typing.Union[LocalesSchema, list, tuple, ],
...
request_query_locales = api_client.QueryParameter(
    name="locales",
...
SchemaFor200ResponseBodyApplicationJson = PageDtoSegmentationRuleReference
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_list_of_segmentation_rules_oapg(
        self,
...
class GetListOfSegmentationRules(BaseApi):
    ...
    def get_list_of_segmentation_rules(
        ...
        return self._get_list_of_segmentation_rules_oapg(
