...
RequestRequiredHeaderParams = typing_extensions.TypedDict(
    ...
    {
        'segRule': typing.Union[SegRuleSchema, str, ],
    }
)
...
request_header_seg_rule = api_client.HeaderParameter(
    name="segRule",
    style=api_client.ParameterStyle.SIMPLE,
    schema=SegRuleSchema,
    required=True,
)
# body param
...
SchemaFor201ResponseBodyApplicationJson = SegmentationRuleDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_segmentation_rule_oapg(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationOctetStream,dict, frozendict.frozendict, ],
...
class CreateSegmentationRule(BaseApi):
    ...
    def create_segmentation_rule(
        ...
        return self._create_segmentation_rule_oapg(
            body=body,
