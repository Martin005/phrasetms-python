...
# body param
SchemaForRequestBodyApplicationJson = CreatePlainConversationDto
...
SchemaFor201ResponseBodyApplicationJson = PlainConversationDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_segment_target_conversation1_oapg(
        self,
...
class CreateSegmentTargetConversation1(BaseApi):
    ...
    def create_segment_target_conversation1(
        ...
        return self._create_segment_target_conversation1_oapg(
            body=body,
