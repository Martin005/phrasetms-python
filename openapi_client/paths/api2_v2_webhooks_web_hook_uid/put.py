...
request_path_web_hook_uid = api_client.PathParameter(
    name="webHookUid",
...
# body param
SchemaForRequestBodyApplicationJson = CreateWebHookDto
...
SchemaFor200ResponseBodyApplicationJson = WebHookDtoV2
...
class UpdateWebHook1(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_web_hook1(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def update_web_hook1(
        ...
        return self._update_web_hook1_oapg(
            body=body,
