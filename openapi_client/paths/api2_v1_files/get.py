...
CreatedBySchema = schemas.Int64Schema
BiggerThanSchema = schemas.Int64Schema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'createdBy': typing.Union[CreatedBySchema, decimal.Decimal, int, ],
        'biggerThan': typing.Union[BiggerThanSchema, decimal.Decimal, int, ],
    },
    total=False
)
...
request_query_bigger_than = api_client.QueryParameter(
    name="biggerThan",
    style=api_client.ParameterStyle.FORM,
    schema=BiggerThanSchema,
    explode=True,
)
SchemaFor200ResponseBodyApplicationJson = PageDtoUploadedFileDto
