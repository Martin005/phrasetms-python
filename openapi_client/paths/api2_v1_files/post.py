...
# body param
SchemaForRequestBodyApplicationJson = RemoteUploadedFileDto
SchemaForRequestBodyApplicationOctetStream = RemoteUploadedFileDto
SchemaForRequestBodyMultipartFormData = RemoteUploadedFileDto
...
SchemaFor201ResponseBodyApplicationJson = UploadedFileDto
...
class BaseApi(api_client.Api):
    ...
    def _create_url_file_oapg(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,SchemaForRequestBodyApplicationOctetStream,SchemaForRequestBodyMultipartFormData,],
        content_type: str = ...,
        header_params: RequestHeaderParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
...
class CreateUrlFile(BaseApi):
    ...
    def create_url_file(
        ...
        return self._create_url_file_oapg(
            body=body,
