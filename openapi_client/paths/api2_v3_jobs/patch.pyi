...
# body param
SchemaForRequestBodyApplicationJson = JobPartPatchBatchDto
...
SchemaFor200ResponseBodyApplicationJson = JobPartPatchResultDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_update_job_parts_oapg(
        self,
...
class PatchUpdateJobParts(BaseApi):
    ...
    def patch_update_job_parts(
        ...
        return self._patch_update_job_parts_oapg(
            body=body,
