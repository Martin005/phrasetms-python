...
# body param
SchemaForRequestBody = EditAnalyseV2Dto
...
SchemaFor200ResponseBodyApplicationJson = AnalyseV2Dto
...
class EditAnalysis(BaseApi):
    ...
    def edit_analysis(
        ...
        return self._edit_analysis_oapg(
            body=body,
