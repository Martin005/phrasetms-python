...
SchemaFor202ResponseBodyApplicationJson = PlainConversationDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_plain_comment1_oapg(
        self,
...
class UpdatePlainComment1(BaseApi):
    ...
    def update_plain_comment1(
        ...
        return self._update_plain_comment1_oapg(
            body=body,
