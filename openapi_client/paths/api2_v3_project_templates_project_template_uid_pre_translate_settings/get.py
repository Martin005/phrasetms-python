...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_pre_translate_settings_for_project_template2_oapg(
        self,
...
class GetPreTranslateSettingsForProjectTemplate2(BaseApi):
    ...
    def get_pre_translate_settings_for_project_template2(
        ...
        return self._get_pre_translate_settings_for_project_template2_oapg(
