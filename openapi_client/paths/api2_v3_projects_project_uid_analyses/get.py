...
class OrderSchema(
    ...
    def DESC(cls):
        return cls("desc")
OnlyOwnerOrgSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'onlyOwnerOrg': typing.Union[OnlyOwnerOrgSchema, bool, ],
    },
    total=False
)
...
request_query_only_owner_org = api_client.QueryParameter(
    name="onlyOwnerOrg",
    style=api_client.ParameterStyle.FORM,
    schema=OnlyOwnerOrgSchema,
    explode=True,
)
# Path params
...
SchemaFor200ResponseBodyApplicationJson = PageDtoAnalyseReference
...
class ListByProjectV3(BaseApi):
    ...
    def list_by_project_v3(
        ...
        return self._list_by_project_v3_oapg(
