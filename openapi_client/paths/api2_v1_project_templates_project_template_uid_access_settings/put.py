...
# body param
SchemaForRequestBodyApplicationJson = EditProjectSecuritySettingsDtoV2
...
SchemaFor200ResponseBodyApplicationJson = ProjectSecuritySettingsDtoV2
...
class BaseApi(api_client.Api):
    @typing.overload
    def _edit_project_template_access_settings_oapg(
        self,
...
class EditProjectTemplateAccessSettings(BaseApi):
    ...
    def edit_project_template_access_settings(
        ...
        return self._edit_project_template_access_settings_oapg(
            body=body,
