...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'all': typing.Union[AllSchema, bool, ],
...
SchemaFor200ResponseBodyApplicationJson = PageDtoAsyncRequestDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_pending_requests_oapg(
        self,
...
class ListPendingRequests(BaseApi):
    ...
    def list_pending_requests(
        ...
        return self._list_pending_requests_oapg(
