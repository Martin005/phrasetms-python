...
# body param
SchemaForRequestBodyApplicationJson = TargetLanguageDto
...
SchemaFor201ResponseBodyApplicationJson = TransMemoryDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _add_target_lang_to_trans_memory_oapg(
        self,
...
class AddTargetLangToTransMemory(BaseApi):
    ...
    def add_target_lang_to_trans_memory(
        ...
        return self._add_target_lang_to_trans_memory_oapg(
            body=body,
