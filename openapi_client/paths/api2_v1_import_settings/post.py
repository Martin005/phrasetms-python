...
# body param
SchemaForRequestBodyApplicationJson = ImportSettingsCreateDto
...
SchemaFor201ResponseBodyApplicationJson = ImportSettingsDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_import_settings_oapg(
        self,
...
class CreateImportSettings(BaseApi):
    ...
    def create_import_settings(
        ...
        return self._create_import_settings_oapg(
            body=body,
