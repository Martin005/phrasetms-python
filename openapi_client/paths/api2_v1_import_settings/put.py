...
# body param
SchemaForRequestBodyApplicationJson = ImportSettingsEditDto
...
SchemaFor200ResponseBodyApplicationJson = ImportSettingsDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _edit_import_settings_oapg(
        self,
...
class EditImportSettings(BaseApi):
    ...
    def edit_import_settings(
        ...
        return self._edit_import_settings_oapg(
            body=body,
