...
SchemaFor200ResponseBodyApplicationJson = PageDtoImportSettingsReference
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_import_settings_oapg(
        self,
...
class ListImportSettings(BaseApi):
    ...
    def list_import_settings(
        ...
        return self._list_import_settings_oapg(
