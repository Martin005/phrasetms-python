...
SchemaFor200ResponseBodyApplicationJson = PageDtoCustomFileTypeDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_all_custom_file_type_oapg(
        self,
...
class GetAllCustomFileType(BaseApi):
    ...
    def get_all_custom_file_type(
        ...
        return self._get_all_custom_file_type_oapg(
