...
# body param
SchemaForRequestBodyApplicationJson = DeleteCustomFileTypeDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_batch_custom_file_type_oapg(
        self,
...
class DeleteBatchCustomFileType(BaseApi):
    ...
    def delete_batch_custom_file_type(
        ...
        return self._delete_batch_custom_file_type_oapg(
            body=body,
