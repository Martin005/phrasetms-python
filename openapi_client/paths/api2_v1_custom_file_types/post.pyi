...
# body param
SchemaForRequestBodyApplicationJson = CreateCustomFileTypeDto
...
SchemaFor201ResponseBodyApplicationJson = CustomFileTypeDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_custom_file_types_oapg(
        self,
...
class CreateCustomFileTypes(BaseApi):
    ...
    def create_custom_file_types(
        ...
        return self._create_custom_file_types_oapg(
            body=body,
