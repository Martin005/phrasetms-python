...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ScimResourceTypeSchema']:
            return ScimResourceTypeSchema

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ScimResourceTypeSchema'], typing.List['ScimResourceTypeSchema']],
    ...
    def __getitem__(self, i: int) -> 'ScimResourceTypeSchema':
...
class GetResourceTypes(BaseApi):
    ...
    def get_resource_types(
        ...
        return self._get_resource_types_oapg(
