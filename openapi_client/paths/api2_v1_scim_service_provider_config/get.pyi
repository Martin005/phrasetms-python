...
SchemaFor200ResponseBodyApplicationJson = ServiceProviderConfigDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_service_provider_config_dto_oapg(
        self,
...
class GetServiceProviderConfigDto(BaseApi):
    ...
    def get_service_provider_config_dto(
        ...
        return self._get_service_provider_config_dto_oapg(
