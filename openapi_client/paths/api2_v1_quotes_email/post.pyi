...
# body param
SchemaForRequestBodyApplicationJson = EmailQuotesRequestDto
...
SchemaFor200ResponseBodyApplicationJson = EmailQuotesResponseDto
...
class EmailQuotes(BaseApi):
    ...
    def email_quotes(
        ...
        return self._email_quotes_oapg(
            body=body,
