...
# body param
SchemaForRequestBodyApplicationJson = PatchProjectDto
...
SchemaFor200ResponseBodyApplicationJson = AbstractProjectDto
...
class PatchProject(BaseApi):
    ...
    def patch_project(
        ...
        return self._patch_project_oapg(
            body=body,
