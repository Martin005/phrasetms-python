...
# body param
SchemaForRequestBody = CreateWebEditorLinkDtoV2
...
SchemaFor200ResponseBody = WebEditorLinkDtoV2
...
class WebEditorLinkV2(BaseApi):
    ...
    def web_editor_link_v2(
        ...
        return self._web_editor_link_v2_oapg(
            body=body,
