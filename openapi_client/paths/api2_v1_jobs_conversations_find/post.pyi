...
# body param
SchemaForRequestBodyApplicationJson = FindConversationsDto
...
class FindConversations(BaseApi):
    ...
    def find_conversations(
        ...
        return self._find_conversations_oapg(
            body=body,
