...
# Path params
MtsUidSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'mtsUid': typing.Union[MtsUidSchema, str, ],
    }
)
...
request_path_mts_uid = api_client.PathParameter(
    name="mtsUid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=MtsUidSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = MachineTranslateSettingsPbmDto
...
class GetMtSettings(BaseApi):
    ...
    def get_mt_settings(
        ...
        return self._get_mt_settings_oapg(
