...
# Query params
CharsetSchema = schemas.StrSchema
StrictLangMatchingSchema = schemas.BoolSchema
UpdateTermsSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'charset': typing.Union[CharsetSchema, str, ],
        'strictLangMatching': typing.Union[StrictLangMatchingSchema, bool, ],
        'updateTerms': typing.Union[UpdateTermsSchema, bool, ],
    },
    total=False
)
...
request_query_charset = api_client.QueryParameter(
    name="charset",
    style=api_client.ParameterStyle.FORM,
    schema=CharsetSchema,
    explode=True,
)
...
request_query_update_terms = api_client.QueryParameter(
    name="updateTerms",
    style=api_client.ParameterStyle.FORM,
...
# Path params
TermBaseUidSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'termBaseUid': typing.Union[TermBaseUidSchema, str, ],
    }
)
...
request_path_term_base_uid = api_client.PathParameter(
    name="termBaseUid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=TermBaseUidSchema,
    required=True,
)
# body param
...
SchemaFor200ResponseBodyApplicationJson = ImportTermBaseResponseDto
...
class BaseApi(api_client.Api):
    ...
    def _import_term_base_oapg(
        ...
        for parameter in (
            request_query_charset,
            request_query_strict_lang_matching,
            request_query_update_terms,
        ):
...
class ImportTermBase(BaseApi):
    ...
    def import_term_base(
        ...
        return self._import_term_base_oapg(
            body=body,
