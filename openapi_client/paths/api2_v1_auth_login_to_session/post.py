...
# body param
SchemaForRequestBodyApplicationJson = LoginToSessionDto
...
SchemaFor200ResponseBodyApplicationJson = LoginToSessionResponseDto
...
class LoginToSession(BaseApi):
    ...
    def login_to_session(
        ...
        return self._login_to_session_oapg(
            body=body,
