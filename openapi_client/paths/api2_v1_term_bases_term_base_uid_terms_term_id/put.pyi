...
TermIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'termBaseUid': typing.Union[TermBaseUidSchema, str, ],
        'termId': typing.Union[TermIdSchema, str, ],
    }
)
...
request_path_term_id = api_client.PathParameter(
    name="termId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=TermIdSchema,
    required=True,
...
# body param
SchemaForRequestBodyApplicationJson = TermEditDto
...
SchemaFor200ResponseBodyApplicationJson = TermDto
