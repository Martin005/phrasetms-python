...
# Path params
SchemaUrnSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'schemaUrn': typing.Union[SchemaUrnSchema, str, ],
    }
)
...
request_path_schema_urn = api_client.PathParameter(
    name="schemaUrn",
    style=api_client.ParameterStyle.SIMPLE,
    schema=SchemaUrnSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = ScimResourceSchema
...
class GetSchemaByUrn(BaseApi):
    ...
    def get_schema_by_urn(
        ...
        return self._get_schema_by_urn_oapg(
