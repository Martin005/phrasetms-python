...
# body param
SchemaForRequestBody = WorkflowChangesDto
...
SchemaFor200ResponseBodyTextHtml = Response
...
class BaseApi(api_client.Api):
    @typing.overload
    def _download_workflow_changes_oapg(
        self,
...
class DownloadWorkflowChanges(BaseApi):
    ...
    def download_workflow_changes(
        ...
        return self._download_workflow_changes_oapg(
            body=body,
