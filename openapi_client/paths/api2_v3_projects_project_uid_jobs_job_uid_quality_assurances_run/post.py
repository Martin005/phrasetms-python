...
# body param
SchemaForRequestBodyApplicationJson = QualityAssuranceRunDtoV3
...
SchemaFor200ResponseBodyApplicationJson = QualityAssuranceResponseDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _run_qa_for_job_part_v3_oapg(
        self,
...
class RunQaForJobPartV3(BaseApi):
    ...
    def run_qa_for_job_part_v3(
        ...
        return self._run_qa_for_job_part_v3_oapg(
            body=body,
