...
SchemaFor201ResponseBodyApplicationJson = AddPlainCommentResultDto
...
class AddPlainComment2(BaseApi):
    ...
    def add_plain_comment2(
        ...
        return self._add_plain_comment2_oapg(
            body=body,
