...
SchemaFor200ResponseBodyApplicationOctetStream = InputStreamLength
...
class GetPreparedFile(BaseApi):
    ...
    def get_prepared_file(
        ...
        return self._get_prepared_file_oapg(
