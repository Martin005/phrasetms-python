...
# Path params
FileUidSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'fileUid': typing.Union[FileUidSchema, str, ],
    }
)
...
request_path_file_uid = api_client.PathParameter(
    name="fileUid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=FileUidSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = UploadedFileDto
...
class GetFileJson(BaseApi):
    ...
    def get_file_json(
        ...
        return self._get_file_json_oapg(
