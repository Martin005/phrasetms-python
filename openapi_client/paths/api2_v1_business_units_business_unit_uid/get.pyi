...
# Path params
BusinessUnitUidSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'businessUnitUid': typing.Union[BusinessUnitUidSchema, str, ],
    }
)
...
request_path_business_unit_uid = api_client.PathParameter(
    name="businessUnitUid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=BusinessUnitUidSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = BusinessUnitDto
...
class BaseApi(api_client.Api):
    ...
    def _get_business_unit_oapg(
        ...
        _path_params = {}
        for parameter in (
            request_path_business_unit_uid,
        ):
...
class GetBusinessUnit(BaseApi):
    ...
    def get_business_unit(
        ...
        return self._get_business_unit_oapg(
