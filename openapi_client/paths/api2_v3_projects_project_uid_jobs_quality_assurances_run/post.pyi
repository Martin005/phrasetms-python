...
# body param
SchemaForRequestBodyApplicationJson = QualityAssuranceBatchRunDtoV3
...
class BaseApi(api_client.Api):
    @typing.overload
    def _run_qa_for_job_parts_v3_oapg(
        self,
...
class RunQaForJobPartsV3(BaseApi):
    ...
    def run_qa_for_job_parts_v3(
        ...
        return self._run_qa_for_job_parts_v3_oapg(
            body=body,
