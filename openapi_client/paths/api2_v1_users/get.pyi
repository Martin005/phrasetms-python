...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'nameOrEmail': typing.Union[NameOrEmailSchema, str, ],
        ...
        'order': typing.Union[OrderSchema, list, tuple, ],
    },
    total=False
)
...
request_query_name_or_email = api_client.QueryParameter(
    name="nameOrEmail",
    style=api_client.ParameterStyle.FORM,
    schema=NameOrEmailSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = PageDtoUserDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_list_of_users_filtered_oapg(
        self,
...
class GetListOfUsersFiltered(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_list_of_users_filtered(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_list_of_users_filtered(
        ...
        return self._get_list_of_users_filtered_oapg(
