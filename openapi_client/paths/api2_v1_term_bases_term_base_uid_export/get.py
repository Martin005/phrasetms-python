...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'termStatus': typing.Union[TermStatusSchema, str, ],
    },
    total=False
)
...
request_query_term_status = api_client.QueryParameter(
    name="termStatus",
    style=api_client.ParameterStyle.FORM,
    schema=TermStatusSchema,
    explode=True,
)
# Path params
...
class ExportTermBase(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def export_term_base(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        stream: bool = False,
    ...
    def export_term_base(
        ...
        return self._export_term_base_oapg(
