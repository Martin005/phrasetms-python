...
request_path_segment_id = api_client.PathParameter(
    name="segmentId",
    style=api_client.ParameterStyle.SIMPLE,
...
# body param
SchemaForRequestBodyApplicationJson = TranslationDto
...
class UpdateTranslation(BaseApi):
    ...
    def update_translation(
        ...
        return self._update_translation_oapg(
            body=body,
