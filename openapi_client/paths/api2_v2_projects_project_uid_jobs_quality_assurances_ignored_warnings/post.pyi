...
# body param
SchemaForRequestBody = UpdateIgnoredWarningsDto
...
SchemaFor200ResponseBody = UpdateIgnoredWarningsDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _add_ignored_warnings1_oapg(
        self,
...
class AddIgnoredWarnings1(BaseApi):
    ...
    def add_ignored_warnings1(
        ...
        return self._add_ignored_warnings1_oapg(
            body=body,
