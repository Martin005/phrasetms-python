...
SchemaFor200ResponseBodyApplicationJson = TranslationResourcesDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_translation_resources_oapg(
        self,
...
class GetTranslationResources(BaseApi):
    ...
    def get_translation_resources(
        ...
        return self._get_translation_resources_oapg(
