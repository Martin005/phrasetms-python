...
# Path params
AsyncRequestIdSchema = schemas.Int64Schema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'asyncRequestId': typing.Union[AsyncRequestIdSchema, decimal.Decimal, int, ],
    }
)
...
SchemaFor200ResponseBodyApplicationJson = AsyncRequestDto
...
class GetAsyncRequest(BaseApi):
    ...
    def get_async_request(
        ...
        return self._get_async_request_oapg(
