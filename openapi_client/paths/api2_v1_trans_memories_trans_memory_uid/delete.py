...
# Query params
PurgeSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'purge': typing.Union[PurgeSchema, bool, ],
    },
    total=False
)
...
class DeleteTransMemory(BaseApi):
    ...
    def delete_trans_memory(
        ...
        return self._delete_trans_memory_oapg(
