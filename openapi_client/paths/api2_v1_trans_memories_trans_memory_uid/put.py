...
# body param
SchemaForRequestBodyApplicationJson = TransMemoryEditDto
...
SchemaFor200ResponseBodyApplicationJson = TransMemoryDto
...
class EditTransMemory(BaseApi):
    ...
    def edit_trans_memory(
        ...
        return self._edit_trans_memory_oapg(
            body=body,
