...
SchemaFor200ResponseBodyApplicationJson = LQAConversationDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_lqa_conversation_oapg(
        self,
...
class GetLqaConversation(BaseApi):
    ...
    def get_lqa_conversation(
        ...
        return self._get_lqa_conversation_oapg(
