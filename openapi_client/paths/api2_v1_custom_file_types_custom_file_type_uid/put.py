...
# Path params
CustomFileTypeUidSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'customFileTypeUid': typing.Union[CustomFileTypeUidSchema, str, ],
    }
)
...
request_path_custom_file_type_uid = api_client.PathParameter(
    name="customFileTypeUid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=CustomFileTypeUidSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = UpdateCustomFileTypeDto
...
SchemaFor200ResponseBodyApplicationJson = CustomFileTypeDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_custom_file_type_oapg(
        self,
    ...
    def _update_custom_file_type_oapg(
        ...
        _path_params = {}
        for parameter in (
            request_path_custom_file_type_uid,
        ):
...
class UpdateCustomFileType(BaseApi):
    ...
    def update_custom_file_type(
        ...
        return self._update_custom_file_type_oapg(
            body=body,
