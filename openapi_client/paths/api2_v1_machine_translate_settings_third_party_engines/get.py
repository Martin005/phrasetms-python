...
SchemaFor200ResponseBodyApplicationJson = PageDtoMachineTranslateSettingsPbmDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_third_party_engines_list_oapg(
        self,
...
class GetThirdPartyEnginesList(BaseApi):
    ...
    def get_third_party_engines_list(
        ...
        return self._get_third_party_engines_list_oapg(
