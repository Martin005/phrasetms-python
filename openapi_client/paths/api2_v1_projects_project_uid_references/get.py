...
DateCreatedSinceSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'dateCreatedSince': typing.Union[DateCreatedSinceSchema, str, ],
        'createdBy': typing.Union[CreatedBySchema, str, ],
...
request_query_date_created_since = api_client.QueryParameter(
    name="dateCreatedSince",
    style=api_client.ParameterStyle.FORM,
    schema=DateCreatedSinceSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = ReferenceFilePageDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_reference_files_oapg(
        self,
    ...
    def _list_reference_files_oapg(
        ...
        for parameter in (
            ...
            request_query_date_created_since,
...
class ListReferenceFiles(BaseApi):
    ...
    def list_reference_files(
        ...
        return self._list_reference_files_oapg(
