...
# body param
SchemaForRequestBodyApplicationJson = TermBaseSearchRequestDto
...
SchemaFor200ResponseBodyApplicationJson = SearchResponseListTbDto
...
class SearchTerms(BaseApi):
    ...
    def search_terms(
        ...
        return self._search_terms_oapg(
            body=body,
