...
# body param
SchemaForRequestBodyApplicationJson = AnalyseRecalculateRequestDto
...
SchemaFor200ResponseBodyApplicationJson = AnalyseRecalculateResponseDto
