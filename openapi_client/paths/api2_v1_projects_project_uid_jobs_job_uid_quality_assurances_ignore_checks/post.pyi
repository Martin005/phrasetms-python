...
# body param
SchemaForRequestBodyApplicationJson = UpdateIgnoredChecksDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_ignored_checks_oapg(
        self,
...
class UpdateIgnoredChecks(BaseApi):
    ...
    def update_ignored_checks(
        ...
        return self._update_ignored_checks_oapg(
            body=body,
