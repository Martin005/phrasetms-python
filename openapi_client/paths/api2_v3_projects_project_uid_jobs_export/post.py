...
# body param
SchemaForRequestBody = JobExportActionDto
...
SchemaFor200ResponseBodyApplicationJson = JobExportResponseDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _export_to_online_repository_oapg(
        self,
...
class ExportToOnlineRepository(BaseApi):
    ...
    def export_to_online_repository(
        ...
        return self._export_to_online_repository_oapg(
            body=body,
