...
# body param
SchemaForRequestBodyApplicationJson = QualityAssuranceSegmentsRunDtoV3
...
class BaseApi(api_client.Api):
    @typing.overload
    def _run_qa_for_segments_v3_oapg(
        self,
...
class RunQaForSegmentsV3(BaseApi):
    ...
    def run_qa_for_segments_v3(
        ...
        return self._run_qa_for_segments_v3_oapg(
            body=body,
