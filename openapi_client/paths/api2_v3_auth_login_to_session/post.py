...
# body param
SchemaForRequestBodyApplicationJson = LoginToSessionV3Dto
...
SchemaFor200ResponseBodyApplicationJson = LoginToSessionResponseV3Dto
...
class LoginToSession2(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def login_to_session2(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def login_to_session2(
        ...
        return self._login_to_session2_oapg(
            body=body,
