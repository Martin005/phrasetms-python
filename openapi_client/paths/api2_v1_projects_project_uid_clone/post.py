...
# body param
SchemaForRequestBodyApplicationJson = CloneProjectDto
...
SchemaFor201ResponseBodyApplicationJson = AbstractProjectDto
...
class CloneProject(BaseApi):
    ...
    def clone_project(
        ...
        return self._clone_project_oapg(
            body=body,
