...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'sourceLanguages': typing.Union[SourceLanguagesSchema, list, tuple, ],
        'targetLanguages': typing.Union[TargetLanguagesSchema, list, tuple, ],
    },
    total=False
)
...
request_query_source_languages = api_client.QueryParameter(
    name="sourceLanguages",
    style=api_client.ParameterStyle.FORM,
    schema=SourceLanguagesSchema,
    explode=True,
)
request_query_target_languages = api_client.QueryParameter(
    name="targetLanguages",
    style=api_client.ParameterStyle.FORM,
    schema=TargetLanguagesSchema,
    explode=True,
)
# Path params
PriceListUidSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'priceListUid': typing.Union[PriceListUidSchema, str, ],
    }
)
...
request_path_price_list_uid = api_client.PathParameter(
    name="priceListUid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=PriceListUidSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = PageDtoTranslationPriceSetDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_prices_with_workflow_steps_oapg(
        self,
    ...
    def _get_prices_with_workflow_steps_oapg(
        ...
        for parameter in (
            ...
            request_query_source_languages,
            request_query_target_languages,
        ):
...
class GetPricesWithWorkflowSteps(BaseApi):
    ...
    def get_prices_with_workflow_steps(
        ...
        return self._get_prices_with_workflow_steps_oapg(
