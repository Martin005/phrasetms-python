...
# body param
SchemaForRequestBodyApplicationJson = TranslationPriceSetCreateDto
...
SchemaFor201ResponseBodyApplicationJson = TranslationPriceSetListDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_language_pair_oapg(
        self,
...
class CreateLanguagePair(BaseApi):
    ...
    def create_language_pair(
        ...
        return self._create_language_pair_oapg(
            body=body,
