...
# body param
SchemaForRequestBody = AdditionalWorkflowStepRequestDto
...
SchemaFor201ResponseBody = AdditionalWorkflowStepDto
...
class CreateAwfStep(BaseApi):
    ...
    def create_awf_step(
        ...
        return self._create_awf_step_oapg(
            body=body,
