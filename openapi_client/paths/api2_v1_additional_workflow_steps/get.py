...
SchemaFor200ResponseBodyApplicationJson = PageDtoAdditionalWorkflowStepDto
...
class ListAwfSteps(BaseApi):
    ...
    def list_awf_steps(
        ...
        return self._list_awf_steps_oapg(
