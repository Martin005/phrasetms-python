...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'jobUid': typing.Union[JobUidSchema, list, tuple, ],
    },
    total=False
)
...
request_query_job_uid = api_client.QueryParameter(
    name="jobUid",
...
class GetHandoverFiles(BaseApi):
    ...
    def get_handover_files(
        ...
        return self._get_handover_files_oapg(
