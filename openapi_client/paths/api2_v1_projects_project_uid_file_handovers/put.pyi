...
SchemaFor200ResponseBodyApplicationJson = FileHandoverDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _upload_handover_file_oapg(
        self,
...
class UploadHandoverFile(BaseApi):
    ...
    def upload_handover_file(
        ...
        return self._upload_handover_file_oapg(
            body=body,
