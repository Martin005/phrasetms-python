...
# body param
SchemaForRequestBodyApplicationJson = CreateAnalyseAsyncV2Dto
...
SchemaFor200ResponseBodyApplicationJson = AsyncAnalyseListResponseV2Dto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_analyse_async1_oapg(
        self,
...
class CreateAnalyseAsync1(BaseApi):
    ...
    def create_analyse_async1(
        ...
        return self._create_analyse_async1_oapg(
            body=body,
