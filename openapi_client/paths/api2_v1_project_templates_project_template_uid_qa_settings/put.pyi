...
# body param
SchemaForRequestBodyApplicationJson = EditQASettingsDtoV2
...
SchemaFor200ResponseBody = QASettingsDtoV2
...
class BaseApi(api_client.Api):
    @typing.overload
    def _set_project_template_qa_settings_oapg(
        self,
...
class SetProjectTemplateQaSettings(BaseApi):
    ...
    def set_project_template_qa_settings(
        ...
        return self._set_project_template_qa_settings_oapg(
            body=body,
