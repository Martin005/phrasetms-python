...
SchemaFor200ResponseBodyApplicationJson = QASettingsDtoV2
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_project_template_qa_settings_oapg(
        self,
...
class GetProjectTemplateQaSettings(BaseApi):
    ...
    def get_project_template_qa_settings(
        ...
        return self._get_project_template_qa_settings_oapg(
