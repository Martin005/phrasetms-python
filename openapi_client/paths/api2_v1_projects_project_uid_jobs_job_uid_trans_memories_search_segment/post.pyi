...
# body param
SchemaForRequestBodyApplicationJson = SearchTMByJobRequestDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _search_segment_by_job_oapg(
        self,
...
class SearchSegmentByJob(BaseApi):
    ...
    def search_segment_by_job(
        ...
        return self._search_segment_by_job_oapg(
            body=body,
