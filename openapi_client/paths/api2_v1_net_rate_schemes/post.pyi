...
# body param
SchemaForRequestBodyApplicationJson = DiscountSchemeCreateDto
...
SchemaFor201ResponseBodyApplicationJson = NetRateScheme
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_discount_scheme_oapg(
        self,
...
class CreateDiscountScheme(BaseApi):
    ...
    def create_discount_scheme(
        ...
        return self._create_discount_scheme_oapg(
            body=body,
