...
SchemaFor200ResponseBodyApplicationJson = PageDtoNetRateSchemeReference
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_discount_schemes_oapg(
        self,
...
class GetDiscountSchemes(BaseApi):
    ...
    def get_discount_schemes(
        ...
        return self._get_discount_schemes_oapg(
