...
FieldInstanceUidSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'projectTemplateUid': typing.Union[ProjectTemplateUidSchema, str, ],
        'fieldInstanceUid': typing.Union[FieldInstanceUidSchema, str, ],
    }
)
...
request_path_field_instance_uid = api_client.PathParameter(
    name="fieldInstanceUid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=FieldInstanceUidSchema,
    required=True,
)
# body param
SchemaForRequestBody = UpdateCustomFieldInstanceDto
...
SchemaFor200ResponseBody = CustomFieldInstanceDto
...
class BaseApi(api_client.Api):
    ...
    def _edit_custom_field1_oapg(
        ...
        for parameter in (
            ...
            request_path_field_instance_uid,
        ):
...
class EditCustomField1(BaseApi):
    ...
    def edit_custom_field1(
        ...
        return self._edit_custom_field1_oapg(
            body=body,
