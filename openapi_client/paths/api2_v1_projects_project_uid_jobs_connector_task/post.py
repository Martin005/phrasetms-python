...
# Query params
DownloadTaskIdSchema = schemas.StrSchema
ContinuousSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'downloadTaskId': typing.Union[DownloadTaskIdSchema, str, ],
        'continuous': typing.Union[ContinuousSchema, bool, ],
    },
    total=False
)
...
request_query_download_task_id = api_client.QueryParameter(
    name="downloadTaskId",
    style=api_client.ParameterStyle.FORM,
    schema=DownloadTaskIdSchema,
    explode=True,
)
request_query_continuous = api_client.QueryParameter(
    name="continuous",
    style=api_client.ParameterStyle.FORM,
...
# body param
SchemaForRequestBodyApplicationJson = JobCreateRequestDto
...
SchemaFor201ResponseBodyApplicationJson = JobListDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_job_from_async_download_task_oapg(
        self,
    ...
    def _create_job_from_async_download_task_oapg(
        ...
        for parameter in (
            request_query_download_task_id,
            request_query_continuous,
        ):
...
class CreateJobFromAsyncDownloadTask(BaseApi):
    ...
    def create_job_from_async_download_task(
        ...
        return self._create_job_from_async_download_task_oapg(
            body=body,
