...
SchemaFor200ResponseBodyApplicationJson = QualityAssuranceChecksDtoV2
...
class BaseApi(api_client.Api):
    @typing.overload
    def _enabled_quality_checks_for_job_oapg(
        self,
...
class EnabledQualityChecksForJob(BaseApi):
    ...
    def enabled_quality_checks_for_job(
        ...
        return self._enabled_quality_checks_for_job_oapg(
