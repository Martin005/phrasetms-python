...
# Query params
StrictLangMatchingSchema = schemas.BoolSchema
StripNativeCodesSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'strictLangMatching': typing.Union[StrictLangMatchingSchema, bool, ],
        'stripNativeCodes': typing.Union[StripNativeCodesSchema, bool, ],
    },
    total=False
)
...
request_query_strict_lang_matching = api_client.QueryParameter(
    name="strictLangMatching",
    style=api_client.ParameterStyle.FORM,
    schema=StrictLangMatchingSchema,
    explode=True,
)
request_query_strip_native_codes = api_client.QueryParameter(
    name="stripNativeCodes",
    style=api_client.ParameterStyle.FORM,
    schema=StripNativeCodesSchema,
    explode=True,
)
# Header params
...
RequestOptionalHeaderParams = typing_extensions.TypedDict(
    ...
    {
        'Content-Length': typing.Union[ContentLengthSchema, decimal.Decimal, int, ],
    },
    total=False
)
...
request_header_content_length = api_client.HeaderParameter(
    name="Content-Length",
...
# Path params
TransMemoryUidSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'transMemoryUid': typing.Union[TransMemoryUidSchema, str, ],
    }
)
...
request_path_trans_memory_uid = api_client.PathParameter(
    name="transMemoryUid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=TransMemoryUidSchema,
    required=True,
)
# body param
...
SchemaFor202ResponseBodyApplicationJson = AsyncRequestWrapperV2Dto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _import_trans_memory_v2_oapg(
        self,
    ...
    def _import_trans_memory_v2_oapg(
        self,
        content_type: str = ...,
        body: typing.Union[SchemaForRequestBodyApplicationOctetStream, dict, frozendict.frozendict, SchemaForRequestBodyMultipartFormData, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        query_params: RequestQueryParams = frozendict.frozendict(),
        header_params: RequestHeaderParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def _import_trans_memory_v2_oapg(
        ...
        for parameter in (
            request_query_strict_lang_matching,
            request_query_strip_native_codes,
        ):
...
class ImportTransMemoryV2(BaseApi):
    ...
    def import_trans_memory_v2(
        ...
        return self._import_trans_memory_v2_oapg(
            body=body,
