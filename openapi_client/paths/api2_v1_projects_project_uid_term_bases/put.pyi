...
# body param
SchemaForRequestBodyApplicationJson = SetTermBaseDto
...
SchemaFor200ResponseBodyApplicationJson = ProjectTermBaseListDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _set_project_term_bases_oapg(
        self,
...
class SetProjectTermBases(BaseApi):
    ...
    def set_project_term_bases(
        ...
        return self._set_project_term_bases_oapg(
            body=body,
