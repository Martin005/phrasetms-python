...
SchemaFor200ResponseBodyApplicationJson = EnabledQualityChecksDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _enabled_quality_checks_oapg(
        self,
...
class EnabledQualityChecks(BaseApi):
    ...
    def enabled_quality_checks(
        ...
        return self._enabled_quality_checks_oapg(
