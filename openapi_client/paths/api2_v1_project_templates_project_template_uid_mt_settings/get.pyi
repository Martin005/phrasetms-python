...
SchemaFor200ResponseBodyApplicationJson = MTSettingsPerLanguageListDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_machine_translate_settings_for_project_template_oapg(
        self,
...
class GetMachineTranslateSettingsForProjectTemplate(BaseApi):
    ...
    def get_machine_translate_settings_for_project_template(
        ...
        return self._get_machine_translate_settings_for_project_template_oapg(
