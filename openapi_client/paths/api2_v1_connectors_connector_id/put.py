...
# Query params
ConnectionTestSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'connectionTest': typing.Union[ConnectionTestSchema, bool, ],
    },
    total=False
)
...
request_query_connection_test = api_client.QueryParameter(
    name="connectionTest",
...
# body param
SchemaForRequestBodyApplicationJson = AbstractConnectorDto
...
SchemaFor200ResponseBodyApplicationJson = ConnectorCreateResponseDto
...
class EditConnector(BaseApi):
    ...
    def edit_connector(
        ...
        return self._edit_connector_oapg(
            body=body,
