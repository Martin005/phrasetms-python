...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'atWorkflowLevel': typing.Union[AtWorkflowLevelSchema, decimal.Decimal, int, ],
        'withWorkflowLevel': typing.Union[WithWorkflowLevelSchema, decimal.Decimal, int, ],
    },
    total=False
)
...
request_query_at_workflow_level = api_client.QueryParameter(
    name="atWorkflowLevel",
    style=api_client.ParameterStyle.FORM,
    schema=AtWorkflowLevelSchema,
    explode=True,
)
request_query_with_workflow_level = api_client.QueryParameter(
    name="withWorkflowLevel",
    style=api_client.ParameterStyle.FORM,
    schema=WithWorkflowLevelSchema,
    explode=True,
)
# Path params
...
# body param
SchemaForRequestBodyApplicationJson = JobPartReadyReferences
...
SchemaFor200ResponseBodyApplicationJson = ComparedSegmentsDto
...
class BaseApi(api_client.Api):
    ...
    def _compare_part_oapg(
        ...
        for parameter in (
            request_query_at_workflow_level,
            request_query_with_workflow_level,
        ):
...
class ComparePart(BaseApi):
    ...
    def compare_part(
        ...
        return self._compare_part_oapg(
            body=body,
