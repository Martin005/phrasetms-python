...
SchemaFor200ResponseBodyApplicationJson = PageDtoOrganizationEmailTemplateDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_org_email_templates_oapg(
        self,
...
class ListOrgEmailTemplates(BaseApi):
    ...
    def list_org_email_templates(
        ...
        return self._list_org_email_templates_oapg(
