...
# body param
SchemaForRequestBodyApplicationJson = EditLqaConversationDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_lqa_conversation1_oapg(
        self,
...
class UpdateLqaConversation1(BaseApi):
    ...
    def update_lqa_conversation1(
        ...
        return self._update_lqa_conversation1_oapg(
            body=body,
