...
# Path params
MtSettingsUidSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'mtSettingsUid': typing.Union[MtSettingsUidSchema, str, ],
    }
)
...
request_path_mt_settings_uid = api_client.PathParameter(
    name="mtSettingsUid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=MtSettingsUidSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = TranslationRequestExtendedDto
...
SchemaFor200ResponseBodyApplicationJson = MachineTranslateResponse
...
class MachineTranslation(BaseApi):
    ...
    def machine_translation(
        ...
        return self._machine_translation_oapg(
            body=body,
