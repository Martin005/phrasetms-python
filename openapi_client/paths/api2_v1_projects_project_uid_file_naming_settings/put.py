...
# body param
SchemaForRequestBodyApplicationJson = FileNamingSettingsDto
...
SchemaFor200ResponseBodyApplicationJson = FileNamingSettingsDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_file_naming_settings_oapg(
        self,
...
class UpdateFileNamingSettings(BaseApi):
    ...
    def update_file_naming_settings(
        ...
        return self._update_file_naming_settings_oapg(
            body=body,
