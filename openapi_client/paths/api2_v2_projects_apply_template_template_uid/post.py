...
# body param
SchemaForRequestBodyApplicationJson = CreateProjectFromTemplateV2Dto
...
SchemaFor201ResponseBodyApplicationJson = AbstractProjectDtoV2
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_project_from_template_v2_oapg(
        self,
...
class CreateProjectFromTemplateV2(BaseApi):
    ...
    def create_project_from_template_v2(
        ...
        return self._create_project_from_template_v2_oapg(
            body=body,
