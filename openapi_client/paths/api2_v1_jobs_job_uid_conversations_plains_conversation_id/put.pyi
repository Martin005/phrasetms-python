...
# body param
SchemaForRequestBodyApplicationJson = EditPlainConversationDto
...
SchemaFor200ResponseBodyApplicationJson = PlainConversationDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_plain_conversation_oapg(
        self,
...
class UpdatePlainConversation(BaseApi):
    ...
    def update_plain_conversation(
        ...
        return self._update_plain_conversation_oapg(
            body=body,
