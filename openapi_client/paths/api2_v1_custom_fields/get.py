...
class UidsSchema(
    ...
    def __getitem__(self, i: int) -> MetaOapg.items:
        return super().__getitem__(i)
RequiredSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'allowedEntities': typing.Union[AllowedEntitiesSchema, list, tuple, ],
        'types': typing.Union[TypesSchema, list, tuple, ],
        'createdBy': typing.Union[CreatedBySchema, list, tuple, ],
        'modifiedBy': typing.Union[ModifiedBySchema, list, tuple, ],
        'uids': typing.Union[UidsSchema, list, tuple, ],
        'required': typing.Union[RequiredSchema, bool, ],
        'sortField': typing.Union[SortFieldSchema, str, ],
        'sortTrend': typing.Union[SortTrendSchema, str, ],
    },
    total=False
)
...
request_query_allowed_entities = api_client.QueryParameter(
    name="allowedEntities",
    style=api_client.ParameterStyle.FORM,
    schema=AllowedEntitiesSchema,
    explode=True,
)
...
request_query_modified_by = api_client.QueryParameter(
    name="modifiedBy",
    style=api_client.ParameterStyle.FORM,
    schema=ModifiedBySchema,
    explode=True,
)
request_query_uids = api_client.QueryParameter(
    name="uids",
    style=api_client.ParameterStyle.FORM,
    schema=UidsSchema,
    explode=True,
)
request_query_required = api_client.QueryParameter(
    name="required",
    style=api_client.ParameterStyle.FORM,
...
request_query_sort_trend = api_client.QueryParameter(
    name="sortTrend",
    style=api_client.ParameterStyle.FORM,
    schema=SortTrendSchema,
    explode=True,
)
SchemaFor200ResponseBodyApplicationJson = PageDtoCustomFieldDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_custom_field_list_oapg(
        self,
    ...
    def _get_custom_field_list_oapg(
        ...
        for parameter in (
            ...
            request_query_name,
            request_query_allowed_entities,
            request_query_types,
            request_query_created_by,
            request_query_modified_by,
            request_query_uids,
            request_query_required,
            request_query_sort_field,
            request_query_sort_trend,
        ):
...
class GetCustomFieldList(BaseApi):
    ...
    def get_custom_field_list(
        ...
        return self._get_custom_field_list_oapg(
