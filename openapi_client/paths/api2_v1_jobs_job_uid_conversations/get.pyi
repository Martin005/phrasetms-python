...
SchemaFor200ResponseBodyApplicationJson = ConversationListDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_all_conversations_oapg(
        self,
...
class ListAllConversations(BaseApi):
    ...
    def list_all_conversations(
        ...
        return self._list_all_conversations_oapg(
