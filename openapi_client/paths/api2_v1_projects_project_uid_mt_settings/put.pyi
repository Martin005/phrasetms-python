...
# body param
SchemaForRequestBodyApplicationJson = EditProjectMTSettingsDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _set_mt_settings_for_project_oapg(
        self,
...
class SetMtSettingsForProject(BaseApi):
    ...
    def set_mt_settings_for_project(
        ...
        return self._set_mt_settings_for_project_oapg(
            body=body,
