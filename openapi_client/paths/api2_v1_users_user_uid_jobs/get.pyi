...
class TargetLangSchema(
    ...
    def __getitem__(self, i: int) -> MetaOapg.items:
        return super().__getitem__(i)
WorkflowStepIdSchema = schemas.Int64Schema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'targetLang': typing.Union[TargetLangSchema, list, tuple, ],
        'workflowStepId': typing.Union[WorkflowStepIdSchema, decimal.Decimal, int, ],
...
request_query_project_uid = api_client.QueryParameter(
    name="projectUid",
    style=api_client.ParameterStyle.FORM,
...
request_query_workflow_step_id = api_client.QueryParameter(
    name="workflowStepId",
    style=api_client.ParameterStyle.FORM,
    schema=WorkflowStepIdSchema,
    explode=True,
)
...
# Path params
UserUidSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'userUid': typing.Union[UserUidSchema, str, ],
    }
)
...
request_path_user_uid = api_client.PathParameter(
    name="userUid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=UserUidSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = PageDtoAssignedJobDto
...
class BaseApi(api_client.Api):
    ...
    def _list_jobs_oapg(
        ...
        for parameter in (
            ...
            request_query_project_uid,
            request_query_target_lang,
            request_query_workflow_step_id,
