...
SchemaFor200ResponseBodyApplicationJson = MetadataTbDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_term_base_metadata_oapg(
        self,
...
class GetTermBaseMetadata(BaseApi):
    ...
    def get_term_base_metadata(
        ...
        return self._get_term_base_metadata_oapg(
