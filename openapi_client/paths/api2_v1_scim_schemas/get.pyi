...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ScimResourceSchema']:
            return ScimResourceSchema

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ScimResourceSchema'], typing.List['ScimResourceSchema']],
    ...
    def __getitem__(self, i: int) -> 'ScimResourceSchema':
