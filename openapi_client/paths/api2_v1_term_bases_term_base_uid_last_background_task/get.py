...
SchemaFor200ResponseBodyApplicationJson = BackgroundTasksTbDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_last_background_task_oapg(
        self,
...
class GetLastBackgroundTask(BaseApi):
    ...
    def get_last_background_task(
        ...
        return self._get_last_background_task_oapg(
