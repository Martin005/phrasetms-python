...
# Query params
WithAssignedJobsSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'withAssignedJobs': typing.Union[WithAssignedJobsSchema, bool, ],
    },
    total=False
)
...
request_query_with_assigned_jobs = api_client.QueryParameter(
    name="withAssignedJobs",
    style=api_client.ParameterStyle.FORM,
    schema=WithAssignedJobsSchema,
    explode=True,
)
# Path params
...
SchemaFor200ResponseBodyApplicationJson = ProjectWorkflowStepListDtoV2
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_project_workflow_steps_v2_oapg(
        self,
    ...
    def _get_project_workflow_steps_v2_oapg(
        ...
        for parameter in (
            request_query_with_assigned_jobs,
        ):
...
class GetProjectWorkflowStepsV2(BaseApi):
    ...
    def get_project_workflow_steps_v2(
        ...
        return self._get_project_workflow_steps_v2_oapg(
