...
# Path params
GlossaryUidSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'glossaryUid': typing.Union[GlossaryUidSchema, str, ],
    }
)
...
request_path_glossary_uid = api_client.PathParameter(
    name="glossaryUid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=GlossaryUidSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = GlossaryEditDto
...
SchemaFor200ResponseBodyApplicationJson = GlossaryDto
...
class UpdateGlossary(BaseApi):
    ...
    def update_glossary(
        ...
        return self._update_glossary_oapg(
            body=body,
