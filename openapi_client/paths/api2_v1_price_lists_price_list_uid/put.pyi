...
# body param
SchemaForRequestBodyApplicationJson = TranslationPriceListCreateDto
...
class UpdatePriceList(BaseApi):
    ...
    def update_price_list(
        ...
        return self._update_price_list_oapg(
            body=body,
