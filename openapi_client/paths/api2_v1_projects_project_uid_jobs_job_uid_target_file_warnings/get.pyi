...
SchemaFor200ResponseBodyApplicationJson = TargetFileWarningsDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_completed_file_warnings_oapg(
        self,
...
class GetCompletedFileWarnings(BaseApi):
    ...
    def get_completed_file_warnings(
        ...
        return self._get_completed_file_warnings_oapg(
