...
# body param
SchemaForRequestBody = CreateCustomFieldInstancesDto
...
SchemaFor200ResponseBody = CustomFieldInstancesDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_custom_fields1_oapg(
        self,
...
class CreateCustomFields1(BaseApi):
    ...
    def create_custom_fields1(
        ...
        return self._create_custom_fields1_oapg(
            body=body,
