...
# body param
SchemaForRequestBodyApplicationJson = ProjectTemplateCreateActionDto
...
SchemaFor201ResponseBodyApplicationJson = ProjectTemplateDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_project_template_oapg(
        self,
...
class CreateProjectTemplate(BaseApi):
    ...
    def create_project_template(
        ...
        return self._create_project_template_oapg(
            body=body,
