...
OwnerUidSchema = schemas.StrSchema
...
class SortSchema(
    ...
    class MetaOapg:
        regex=[{
            'pattern': r'dateCreated|templateName',  # noqa: E501
        }]
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'ownerUid': typing.Union[OwnerUidSchema, str, ],
...
request_query_owner_uid = api_client.QueryParameter(
    name="ownerUid",
    style=api_client.ParameterStyle.FORM,
    schema=OwnerUidSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = PageDtoProjectTemplateReference
