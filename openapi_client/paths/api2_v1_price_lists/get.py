...
SchemaFor200ResponseBodyApplicationJson = PageDtoTranslationPriceListDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_list_of_price_list_oapg(
        self,
...
class GetListOfPriceList(BaseApi):
    ...
    def get_list_of_price_list(
        ...
        return self._get_list_of_price_list_oapg(
