...
SchemaFor201ResponseBodyApplicationJson = TranslationPriceListDto
...
class CreatePriceList(BaseApi):
    ...
    def create_price_list(
        ...
        return self._create_price_list_oapg(
            body=body,
