...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'costCenterUid': typing.Union[CostCenterUidSchema, str, ],
    }
)
...
request_path_cost_center_uid = api_client.PathParameter(
    name="costCenterUid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=CostCenterUidSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = CostCenterEditDto
...
SchemaFor200ResponseBodyApplicationJson = CostCenterDto
...
class UpdateCostCenter(BaseApi):
    ...
    def update_cost_center(
        ...
        return self._update_cost_center_oapg(
            body=body,
