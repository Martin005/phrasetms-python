...
SchemaFor200ResponseBodyApplicationJson = ConnectorListDto
...
class GetConnectorList(BaseApi):
    ...
    def get_connector_list(
        ...
        return self._get_connector_list_oapg(
