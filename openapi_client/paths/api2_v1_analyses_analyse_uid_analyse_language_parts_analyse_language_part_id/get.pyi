...
AnalyseLanguagePartIdSchema = schemas.Int64Schema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'analyseUid': typing.Union[AnalyseUidSchema, str, ],
        'analyseLanguagePartId': typing.Union[AnalyseLanguagePartIdSchema, decimal.Decimal, int, ],
    }
)
...
request_path_analyse_language_part_id = api_client.PathParameter(
    name="analyseLanguagePartId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=AnalyseLanguagePartIdSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = AnalyseLanguagePartDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_analyse_language_part_oapg(
        self,
    ...
    def _get_analyse_language_part_oapg(
        ...
        for parameter in (
            ...
            request_path_analyse_language_part_id,
        ):
...
class GetAnalyseLanguagePart(BaseApi):
    ...
    def get_analyse_language_part(
        ...
        return self._get_analyse_language_part_oapg(
