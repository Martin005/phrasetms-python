...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['UserReference']:
            return UserReference

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['UserReference'], typing.List['UserReference']],
    ...
    def __getitem__(self, i: int) -> 'UserReference':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_lqa_profile_authors_oapg(
        self,
...
class GetLqaProfileAuthors(BaseApi):
    ...
    def get_lqa_profile_authors(
        ...
        return self._get_lqa_profile_authors_oapg(
