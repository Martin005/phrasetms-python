...
# body param
SchemaForRequestBodyApplicationJson = ProjectReferenceFilesRequestDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _batch_download_reference_files_oapg(
        self,
...
class BatchDownloadReferenceFiles(BaseApi):
    ...
    def batch_download_reference_files(
        ...
        return self._batch_download_reference_files_oapg(
            body=body,
