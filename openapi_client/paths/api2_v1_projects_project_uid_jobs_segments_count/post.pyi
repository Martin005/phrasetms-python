...
SchemaFor200ResponseBodyApplicationJson = SegmentsCountsResponseListDto
...
class GetSegmentsCount(BaseApi):
    ...
    def get_segments_count(
        ...
        return self._get_segments_count_oapg(
            body=body,
