...
# body param
SchemaForRequestBodyApplicationJson = BrowseRequestDto
...
SchemaFor200ResponseBodyApplicationJson = BrowseResponseListDto
...
class BrowseTerms(BaseApi):
    ...
    def browse_terms(
        ...
        return self._browse_terms_oapg(
            body=body,
