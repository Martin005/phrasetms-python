...
# body param
SchemaForRequestBodyApplicationJson = NetRateSchemeEdit
...
SchemaFor200ResponseBodyApplicationJson = NetRateScheme
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_discount_scheme_oapg(
        self,
...
class UpdateDiscountScheme(BaseApi):
    ...
    def update_discount_scheme(
        ...
        return self._update_discount_scheme_oapg(
            body=body,
