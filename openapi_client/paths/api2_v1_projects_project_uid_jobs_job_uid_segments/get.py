...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'beginIndex': typing.Union[BeginIndexSchema, decimal.Decimal, int, ],
        'endIndex': typing.Union[EndIndexSchema, decimal.Decimal, int, ],
    },
    total=False
)
...
request_query_begin_index = api_client.QueryParameter(
    name="beginIndex",
    style=api_client.ParameterStyle.FORM,
    schema=BeginIndexSchema,
    explode=True,
)
request_query_end_index = api_client.QueryParameter(
    name="endIndex",
    style=api_client.ParameterStyle.FORM,
    schema=EndIndexSchema,
    explode=True,
)
# Path params
...
SchemaFor200ResponseBodyApplicationJson = SegmentListDto
...
class BaseApi(api_client.Api):
    ...
    def _list_segments_oapg(
        ...
        for parameter in (
            request_query_begin_index,
            request_query_end_index,
        ):
