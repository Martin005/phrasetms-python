...
SchemaFor200ResponseBodyApplicationJson = LQAConversationsListDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_lqa_conversations_oapg(
        self,
...
class ListLqaConversations(BaseApi):
    ...
    def list_lqa_conversations(
        ...
        return self._list_lqa_conversations_oapg(
