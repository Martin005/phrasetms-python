...
# body param
SchemaForRequestBodyApplicationJson = BulkDeleteAnalyseDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _bulk_delete_analyses_oapg(
        self,
...
class BulkDeleteAnalyses(BaseApi):
    ...
    def bulk_delete_analyses(
        ...
        return self._bulk_delete_analyses_oapg(
            body=body,
