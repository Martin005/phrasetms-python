...
# Path params
SegRuleIdSchema = schemas.Int64Schema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'segRuleId': typing.Union[SegRuleIdSchema, decimal.Decimal, int, ],
    }
)
...
request_path_seg_rule_id = api_client.PathParameter(
    name="segRuleId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=SegRuleIdSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = EditSegmentationRuleDto
...
SchemaFor200ResponseBodyApplicationJson = SegmentationRuleDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _updates_segmentation_rule_oapg(
        self,
...
class UpdatesSegmentationRule(BaseApi):
    ...
    def updates_segmentation_rule(
        ...
        return self._updates_segmentation_rule_oapg(
            body=body,
