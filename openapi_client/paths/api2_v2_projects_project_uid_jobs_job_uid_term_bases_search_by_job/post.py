...
# body param
SchemaForRequestBodyApplicationJson = SearchTbByJobRequestDto
...
SchemaFor200ResponseBodyApplicationJson = SearchTbResponseListDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _search_terms_by_job1_oapg(
        self,
...
class SearchTermsByJob1(BaseApi):
    ...
    def search_terms_by_job1(
        ...
        return self._search_terms_by_job1_oapg(
            body=body,
