...
# Query params
NativeSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'native': typing.Union[NativeSchema, bool, ],
    },
    total=False
)
...
request_query_native = api_client.QueryParameter(
    name="native",
...
# body param
SchemaForRequestBodyApplicationJson = LoginWithAppleDto
...
SchemaFor200ResponseBodyApplicationJson = LoginResponseDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _login_by_apple_with_code_oapg(
        self,
...
class LoginByAppleWithCode(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def login_by_apple_with_code(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def login_by_apple_with_code(
        ...
        return self._login_by_apple_with_code_oapg(
            body=body,
