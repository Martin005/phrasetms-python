...
SchemaFor200ResponseBodyApplicationJson = ProjectWorkflowStepDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_parts_workflow_step_oapg(
        self,
...
class GetPartsWorkflowStep(BaseApi):
    ...
    def get_parts_workflow_step(
        ...
        return self._get_parts_workflow_step_oapg(
