...
# body param
SchemaForRequestBody = JobPartReadyDeleteTranslationDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_all_translations1_oapg(
        self,
...
class DeleteAllTranslations1(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def delete_all_translations1(
        self,
        content_type: typing_extensions.Literal["*/*"] = ...,
        body: typing.Union[SchemaForRequestBody, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def delete_all_translations1(
        ...
        return self._delete_all_translations1_oapg(
            body=body,
