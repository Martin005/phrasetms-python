...
# body param
SchemaForRequestBodyApplicationJson = CleanedTransMemoriesDto
...
SchemaFor202ResponseBodyApplicationJson = AsyncRequestWrapperDto
...
class ExportCleanedTms(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def export_cleaned_tms(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def export_cleaned_tms(
        ...
        return self._export_cleaned_tms_oapg(
            body=body,
