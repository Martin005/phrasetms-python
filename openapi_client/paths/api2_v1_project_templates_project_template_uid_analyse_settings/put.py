...
# body param
SchemaForRequestBodyApplicationJson = EditAnalyseSettingsDto
...
SchemaFor200ResponseBodyApplicationJson = AbstractAnalyseSettingsDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_analyse_settings_for_project_template_oapg(
        self,
...
class UpdateAnalyseSettingsForProjectTemplate(BaseApi):
    ...
    def update_analyse_settings_for_project_template(
        ...
        return self._update_analyse_settings_for_project_template_oapg(
            body=body,
