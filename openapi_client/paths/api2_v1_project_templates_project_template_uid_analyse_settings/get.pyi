...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_analyse_settings_for_project_template_oapg(
        self,
...
class GetAnalyseSettingsForProjectTemplate(BaseApi):
    ...
    def get_analyse_settings_for_project_template(
        ...
        return self._get_analyse_settings_for_project_template_oapg(
