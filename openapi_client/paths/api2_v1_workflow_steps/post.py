...
# body param
SchemaForRequestBodyApplicationJson = CreateWorkflowStepDto
...
SchemaFor201ResponseBodyApplicationJson = WorkflowStepDto
...
class CreateWfStep(BaseApi):
    ...
    def create_wf_step(
        ...
        return self._create_wf_step_oapg(
            body=body,
