...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'abbr': typing.Union[AbbrSchema, str, ],
    },
    total=False
)
...
request_query_abbr = api_client.QueryParameter(
    name="abbr",
    style=api_client.ParameterStyle.FORM,
    schema=AbbrSchema,
    explode=True,
)
SchemaFor200ResponseBodyApplicationJson = PageDtoWorkflowStepDto
...
class ListWfSteps(BaseApi):
    ...
    def list_wf_steps(
        ...
        return self._list_wf_steps_oapg(
