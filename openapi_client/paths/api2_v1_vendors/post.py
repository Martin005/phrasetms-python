...
# body param
SchemaForRequestBody = CreateVendorDto
...
SchemaFor201ResponseBodyApplicationJson = VendorDto
...
class CreateVendor(BaseApi):
    ...
    def create_vendor(
        ...
        return self._create_vendor_oapg(
            body=body,
