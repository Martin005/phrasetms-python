...
SchemaFor200ResponseBodyApplicationJson = PageDtoProviderReference
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_project_assignments_oapg(
        self,
...
class GetProjectAssignments(BaseApi):
    ...
    def get_project_assignments(
        ...
        return self._get_project_assignments_oapg(
