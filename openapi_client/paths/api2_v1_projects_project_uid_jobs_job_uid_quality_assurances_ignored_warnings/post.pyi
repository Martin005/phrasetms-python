...
# body param
SchemaForRequestBodyApplicationJson = UpdateIgnoredWarningsDto
...
SchemaFor200ResponseBodyApplicationJson = UpdateIgnoredWarningsDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _add_ignored_warnings_oapg(
        self,
...
class AddIgnoredWarnings(BaseApi):
    ...
    def add_ignored_warnings(
        ...
        return self._add_ignored_warnings_oapg(
            body=body,
