...
request_path_webhook_uid = api_client.PathParameter(
    name="webhookUid",
...
class SendTestWebhook(BaseApi):
    ...
    def send_test_webhook(
        ...
        return self._send_test_webhook_oapg(
