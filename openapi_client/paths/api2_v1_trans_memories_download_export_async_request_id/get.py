...
class FieldsSchema(
    ...
    class MetaOapg:
        ...
        class items(
            ...
            @schemas.classproperty
            def PREVIOUS_SEGMENT(cls):
                return cls("PREVIOUS_SEGMENT")
            
            @schemas.classproperty
            def NEXT_SEGMENT(cls):
...
class BaseApi(api_client.Api):
    @typing.overload
    def _download_search_result_oapg(
        self,
...
class DownloadSearchResult(BaseApi):
    ...
    def download_search_result(
        ...
        return self._download_search_result_oapg(
