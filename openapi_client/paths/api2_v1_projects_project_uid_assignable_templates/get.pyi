...
SchemaFor200ResponseBodyApplicationJson = AssignableTemplatesDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _assignable_templates_oapg(
        self,
...
class AssignableTemplates(BaseApi):
    ...
    def assignable_templates(
        ...
        return self._assignable_templates_oapg(
