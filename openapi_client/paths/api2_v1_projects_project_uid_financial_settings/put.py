...
# body param
SchemaForRequestBodyApplicationJson = SetFinancialSettingsDto
...
SchemaFor200ResponseBodyApplicationJson = FinancialSettingsDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _set_financial_settings_oapg(
        self,
...
class SetFinancialSettings(BaseApi):
    ...
    def set_financial_settings(
        ...
        return self._set_financial_settings_oapg(
            body=body,
