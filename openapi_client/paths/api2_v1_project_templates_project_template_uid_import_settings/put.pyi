...
# body param
SchemaForRequestBodyApplicationJson = FileImportSettingsCreateDto
...
SchemaFor200ResponseBodyApplicationJson = FileImportSettingsDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _edit_project_template_import_settings_oapg(
        self,
...
class EditProjectTemplateImportSettings(BaseApi):
    ...
    def edit_project_template_import_settings(
        ...
        return self._edit_project_template_import_settings_oapg(
            body=body,
