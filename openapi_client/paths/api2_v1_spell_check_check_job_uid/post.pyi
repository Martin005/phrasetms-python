...
# body param
SchemaForRequestBodyApplicationJson = SpellCheckRequestDto
...
SchemaFor200ResponseBodyApplicationJson = SpellCheckResponseDto
...
class CheckByJob(BaseApi):
    ...
    def check_by_job(
        ...
        return self._check_by_job_oapg(
            body=body,
