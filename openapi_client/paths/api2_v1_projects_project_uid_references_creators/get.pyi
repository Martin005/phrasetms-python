...
SchemaFor200ResponseBodyApplicationJson = UserReferencesDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_reference_file_creators_oapg(
        self,
...
class ListReferenceFileCreators(BaseApi):
    ...
    def list_reference_file_creators(
        ...
        return self._list_reference_file_creators_oapg(
