...
# body param
SchemaForRequestBodyApplicationJson = CreateTermsDto
...
SchemaFor200ResponseBodyApplicationJson = TermPairDto
...
class CreateTermByJob(BaseApi):
    ...
    def create_term_by_job(
        ...
        return self._create_term_by_job_oapg(
            body=body,
