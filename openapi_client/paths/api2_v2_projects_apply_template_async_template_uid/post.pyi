...
# Path params
TemplateUidSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'templateUid': typing.Union[TemplateUidSchema, str, ],
    }
)
...
request_path_template_uid = api_client.PathParameter(
    name="templateUid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=TemplateUidSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = CreateProjectFromTemplateAsyncV2Dto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_project_from_template_v2_async_oapg(
        self,
...
class CreateProjectFromTemplateV2Async(BaseApi):
    ...
    def create_project_from_template_v2_async(
        ...
        return self._create_project_from_template_v2_async_oapg(
            body=body,
