...
# body param
SchemaForRequestBodyApplicationJson = JobPartReferences
...
class BaseApi(api_client.Api):
    @typing.overload
    def _assign_linguists_from_template_to_job_parts_oapg(
        self,
...
class AssignLinguistsFromTemplateToJobParts(BaseApi):
    ...
    def assign_linguists_from_template_to_job_parts(
        ...
        return self._assign_linguists_from_template_to_job_parts_oapg(
            body=body,
