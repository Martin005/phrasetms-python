...
# body param
SchemaForRequestBodyApplicationJson = TransMemoryCreateDto
...
class CreateTransMemory(BaseApi):
    ...
    def create_trans_memory(
        ...
        return self._create_trans_memory_oapg(
            body=body,
