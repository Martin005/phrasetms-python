...
SchemaFor200ResponseBodyApplicationJson = LqaProfileReferenceDto
...
class DuplicateProfile(BaseApi):
    ...
    def duplicate_profile(
        ...
        return self._duplicate_profile_oapg(
