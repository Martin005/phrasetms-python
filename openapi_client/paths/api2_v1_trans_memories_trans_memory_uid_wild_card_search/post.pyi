...
# body param
SchemaForRequestBodyApplicationJson = WildCardSearchRequestDto
...
SchemaFor200ResponseBodyApplicationJson = SearchResponseListTmDto
...
class WildcardSearch(BaseApi):
    ...
    def wildcard_search(
        ...
        return self._wildcard_search_oapg(
            body=body,
