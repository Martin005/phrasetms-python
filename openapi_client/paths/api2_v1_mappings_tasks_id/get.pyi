...
SchemaFor200ResponseBodyApplicationJson = TaskMappingDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_mapping_for_task_oapg(
        self,
...
class GetMappingForTask(BaseApi):
    ...
    def get_mapping_for_task(
        ...
        return self._get_mapping_for_task_oapg(
