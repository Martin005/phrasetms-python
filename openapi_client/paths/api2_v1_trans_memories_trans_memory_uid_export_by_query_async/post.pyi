...
# body param
SchemaForRequestBodyApplicationJson = ExportByQueryDto
...
SchemaFor200ResponseBodyApplicationJson = AsyncExportTMByQueryResponseDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _export_by_query_async_oapg(
        self,
...
class ExportByQueryAsync(BaseApi):
    ...
    def export_by_query_async(
        ...
        return self._export_by_query_async_oapg(
            body=body,
