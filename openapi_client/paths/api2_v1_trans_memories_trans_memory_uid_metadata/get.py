...
# Query params
ByLanguageSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'byLanguage': typing.Union[ByLanguageSchema, bool, ],
    },
    total=False
)
...
request_query_by_language = api_client.QueryParameter(
    name="byLanguage",
    style=api_client.ParameterStyle.FORM,
    schema=ByLanguageSchema,
    explode=True,
)
# Path params
...
SchemaFor200ResponseBodyApplicationJson = MetadataResponse
