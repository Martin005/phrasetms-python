...
SchemaFor200ResponseBodyApplicationJson = PageDtoCostCenterDto
...
class ListCostCenters(BaseApi):
    ...
    def list_cost_centers(
        ...
        return self._list_cost_centers_oapg(
