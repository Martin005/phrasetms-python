...
# body param
SchemaForRequestBodyApplicationJson = AssignVendorDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _assign_vendor_to_project_oapg(
        self,
...
class AssignVendorToProject(BaseApi):
    ...
    def assign_vendor_to_project(
        ...
        return self._assign_vendor_to_project_oapg(
            body=body,
