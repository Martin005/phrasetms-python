...
SchemaFor200ResponseBodyApplicationJson = PageDtoNetRateSchemeWorkflowStepReference
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_discount_scheme_workflow_steps_oapg(
        self,
...
class GetDiscountSchemeWorkflowSteps(BaseApi):
    ...
    def get_discount_scheme_workflow_steps(
        ...
        return self._get_discount_scheme_workflow_steps_oapg(
