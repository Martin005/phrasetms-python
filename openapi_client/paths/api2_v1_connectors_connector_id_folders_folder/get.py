...
class FileTypeSchema(
    ...
    class MetaOapg:
        regex=[{
            'pattern': r'ALL|FILES_ONLY|FOLDERS_ONLY',  # noqa: E501
        }]
...
class SortSchema(
    ...
    class MetaOapg:
        regex=[{
            'pattern': r'NAME|SIZE|LAST_MODIFIED',  # noqa: E501
        }]
...
request_query__file_type = api_client.QueryParameter(
    name="fileType",
    style=api_client.ParameterStyle.FORM,
