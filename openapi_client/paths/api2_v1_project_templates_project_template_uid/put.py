...
# body param
SchemaForRequestBodyApplicationJson = ProjectTemplateEditDto
...
SchemaFor200ResponseBodyApplicationJson = ProjectTemplateDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _edit_project_template_oapg(
        self,
...
class EditProjectTemplate(BaseApi):
    ...
    def edit_project_template(
        ...
        return self._edit_project_template_oapg(
            body=body,
