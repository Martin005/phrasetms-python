...
SchemaFor200ResponseBodyApplicationJson = PageDtoQuoteDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_quotes_for_project_oapg(
        self,
...
class GetQuotesForProject(BaseApi):
    ...
    def get_quotes_for_project(
        ...
        return self._get_quotes_for_project_oapg(
