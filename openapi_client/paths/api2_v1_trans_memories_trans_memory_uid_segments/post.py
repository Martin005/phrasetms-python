...
# body param
SchemaForRequestBodyApplicationJson = SegmentDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _insert_to_trans_memory_oapg(
        self,
...
class InsertToTransMemory(BaseApi):
    ...
    def insert_to_trans_memory(
        ...
        return self._insert_to_trans_memory_oapg(
            body=body,
