...
SchemaFor200ResponseBodyApplicationJson = PageDtoWorkflowStepReference
...
class ListWorkflowSteps(BaseApi):
    ...
    def list_workflow_steps(
        ...
        return self._list_workflow_steps_oapg(
