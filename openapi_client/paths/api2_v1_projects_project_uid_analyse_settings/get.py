...
SchemaFor200ResponseBodyApplicationJson = AnalyseSettingsDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_analyse_settings_for_project_oapg(
        self,
...
class GetAnalyseSettingsForProject(BaseApi):
    ...
    def get_analyse_settings_for_project(
        ...
        return self._get_analyse_settings_for_project_oapg(
