...
# body param
SchemaForRequestBodyApplicationJson = HumanTranslateJobsDto
...
SchemaFor200ResponseBodyApplicationJson = AsyncRequestWrapperDto
...
class HumanTranslate(BaseApi):
    ...
    def human_translate(
        ...
        return self._human_translate_oapg(
            body=body,
