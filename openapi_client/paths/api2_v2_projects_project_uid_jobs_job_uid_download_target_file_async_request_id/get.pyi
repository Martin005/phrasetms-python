...
request_path_async_request_id = api_client.PathParameter(
    name="asyncRequestId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=AsyncRequestIdSchema,
    required=True,
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _download_completed_file_oapg(
        self,
...
class DownloadCompletedFile(BaseApi):
    ...
    def download_completed_file(
        ...
        return self._download_completed_file_oapg(
