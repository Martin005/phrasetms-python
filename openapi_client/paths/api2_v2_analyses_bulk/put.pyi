...
# body param
SchemaForRequestBody = BulkEditAnalyseV2Dto
...
SchemaFor200ResponseBodyApplicationJson = AnalysesV2Dto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _analyses_batch_edit_v2_oapg(
        self,
...
class AnalysesBatchEditV2(BaseApi):
    ...
    def analyses_batch_edit_v2(
        ...
        return self._analyses_batch_edit_v2_oapg(
            body=body,
