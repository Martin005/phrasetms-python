...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_pre_translate_settings_for_project2_oapg(
        self,
...
class GetPreTranslateSettingsForProject2(BaseApi):
    ...
    def get_pre_translate_settings_for_project2(
        ...
        return self._get_pre_translate_settings_for_project2_oapg(
