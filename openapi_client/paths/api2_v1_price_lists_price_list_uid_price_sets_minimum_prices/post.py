...
# body param
SchemaForRequestBodyApplicationJson = TranslationPriceSetBulkMinimumPricesDto
...
SchemaFor200ResponseBodyApplicationJson = TranslationPriceListDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _set_minimum_price_for_set_oapg(
        self,
...
class SetMinimumPriceForSet(BaseApi):
    ...
    def set_minimum_price_for_set(
        ...
        return self._set_minimum_price_for_set_oapg(
            body=body,
