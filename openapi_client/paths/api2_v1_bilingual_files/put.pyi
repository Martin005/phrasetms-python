...
class SaveToTransMemorySchema(
    ...
    def NONE(cls):
        return cls("None")
SetCompletedSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'saveToTransMemory': typing.Union[SaveToTransMemorySchema, str, ],
        'setCompleted': typing.Union[SetCompletedSchema, bool, ],
    },
    total=False
)
...
request_query_save_to_trans_memory = api_client.QueryParameter(
    name="saveToTransMemory",
    style=api_client.ParameterStyle.FORM,
    schema=SaveToTransMemorySchema,
    explode=True,
)
request_query_set_completed = api_client.QueryParameter(
    name="setCompleted",
    style=api_client.ParameterStyle.FORM,
...
SchemaFor200ResponseBodyApplicationJson = JobPartsDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _upload_bilingual_file_oapg(
        self,
    ...
    def _upload_bilingual_file_oapg(
        ...
        for parameter in (
            ...
            request_query_save_to_trans_memory,
            request_query_set_completed,
        ):
...
class UploadBilingualFile(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def upload_bilingual_file(
        self,
        content_type: typing_extensions.Literal["application/octet-stream"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationOctetStream, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def upload_bilingual_file(
        ...
        return self._upload_bilingual_file_oapg(
            body=body,
