...
request_path_file = api_client.PathParameter(
    name="file",
    style=api_client.ParameterStyle.SIMPLE,
    schema=FileSchema,
    required=True,
...
# body param
SchemaForRequestBodyApplicationJson = GetFileRequestParamsDto
