...
# Path params
VendorUidSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'vendorUid': typing.Union[VendorUidSchema, str, ],
    }
)
...
request_path_vendor_uid = api_client.PathParameter(
    name="vendorUid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=VendorUidSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = VendorDto
