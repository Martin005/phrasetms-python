...
# Path params
QuoteUidSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'quoteUid': typing.Union[QuoteUidSchema, str, ],
    }
)
...
request_path_quote_uid = api_client.PathParameter(
    name="quoteUid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=QuoteUidSchema,
    required=True,
)
...
class DeleteQuote(BaseApi):
    ...
    def delete_quote(
        ...
        return self._delete_quote_oapg(
