...
# body param
SchemaForRequestBodyApplicationJson = TranslationRequestDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _machine_translation_job_oapg(
        self,
...
class MachineTranslationJob(BaseApi):
    ...
    def machine_translation_job(
        ...
        return self._machine_translation_job_oapg(
            body=body,
