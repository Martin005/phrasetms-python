...
# Path params
DomainUidSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'domainUid': typing.Union[DomainUidSchema, str, ],
    }
)
...
request_path_domain_uid = api_client.PathParameter(
    name="domainUid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=DomainUidSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = DomainEditDto
...
SchemaFor200ResponseBodyApplicationJson = DomainDto
...
class UpdateDomain(BaseApi):
    ...
    def update_domain(
        ...
        return self._update_domain_oapg(
            body=body,
