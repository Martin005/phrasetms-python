...
# body param
SchemaForRequestBodyApplicationJson = SetProjectTemplateTermBaseDto
...
SchemaFor200ResponseBody = ProjectTemplateTermBaseListDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _set_project_template_term_bases_oapg(
        self,
...
class SetProjectTemplateTermBases(BaseApi):
    ...
    def set_project_template_term_bases(
        ...
        return self._set_project_template_term_bases_oapg(
            body=body,
