...
SchemaFor200ResponseBodyApplicationJson = ProjectTemplateTermBaseListDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_project_template_term_bases_oapg(
        self,
...
class GetProjectTemplateTermBases(BaseApi):
    ...
    def get_project_template_term_bases(
        ...
        return self._get_project_template_term_bases_oapg(
