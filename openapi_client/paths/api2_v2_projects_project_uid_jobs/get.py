...
AssignedUserSchema = schemas.Int64Schema
DueInHoursSchema = schemas.Int32Schema
FilenameSchema = schemas.StrSchema
TargetLangSchema = schemas.StrSchema
AssignedVendorSchema = schemas.Int64Schema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'workflowLevel': typing.Union[WorkflowLevelSchema, decimal.Decimal, int, ],
        'status': typing.Union[StatusSchema, list, tuple, ],
        'assignedUser': typing.Union[AssignedUserSchema, decimal.Decimal, int, ],
        'dueInHours': typing.Union[DueInHoursSchema, decimal.Decimal, int, ],
        'filename': typing.Union[FilenameSchema, str, ],
        'targetLang': typing.Union[TargetLangSchema, str, ],
        'assignedVendor': typing.Union[AssignedVendorSchema, decimal.Decimal, int, ],
    },
    total=False
)
...
request_query_workflow_level = api_client.QueryParameter(
    name="workflowLevel",
    style=api_client.ParameterStyle.FORM,
    schema=WorkflowLevelSchema,
    explode=True,
)
...
request_query_assigned_user = api_client.QueryParameter(
    name="assignedUser",
    style=api_client.ParameterStyle.FORM,
    schema=AssignedUserSchema,
    explode=True,
)
...
request_query_target_lang = api_client.QueryParameter(
    name="targetLang",
    style=api_client.ParameterStyle.FORM,
    schema=TargetLangSchema,
    explode=True,
)
request_query_assigned_vendor = api_client.QueryParameter(
    name="assignedVendor",
    style=api_client.ParameterStyle.FORM,
    schema=AssignedVendorSchema,
    explode=True,
)
# Path params
...
SchemaFor200ResponseBodyApplicationJson = PageDtoJobPartReferenceV2
...
class BaseApi(api_client.Api):
    ...
    def _list_parts_v2_oapg(
        ...
        for parameter in (
            ...
            request_query_count,
            request_query_workflow_level,
            request_query_status,
            request_query_assigned_user,
            request_query_due_in_hours,
            request_query_filename,
            request_query_target_lang,
            request_query_assigned_vendor,
        ):
...
class ListPartsV2(BaseApi):
    ...
    def list_parts_v2(
        ...
        return self._list_parts_v2_oapg(
