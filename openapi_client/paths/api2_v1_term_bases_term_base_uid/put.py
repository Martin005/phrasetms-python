...
# body param
SchemaForRequestBodyApplicationJson = TermBaseEditDto
...
SchemaFor200ResponseBodyApplicationJson = TermBaseDto
...
class UpdateTermBase(BaseApi):
    ...
    def update_term_base(
        ...
        return self._update_term_base_oapg(
            body=body,
