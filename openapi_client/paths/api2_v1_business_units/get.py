...
SchemaFor200ResponseBodyApplicationJson = PageDtoBusinessUnitDto
...
class ListBusinessUnits(BaseApi):
    ...
    def list_business_units(
        ...
        return self._list_business_units_oapg(
