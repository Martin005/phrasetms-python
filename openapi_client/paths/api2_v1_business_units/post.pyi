...
SchemaFor201ResponseBodyApplicationJson = BusinessUnitDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_business_unit_oapg(
        self,
...
class CreateBusinessUnit(BaseApi):
    ...
    def create_business_unit(
        ...
        return self._create_business_unit_oapg(
            body=body,
