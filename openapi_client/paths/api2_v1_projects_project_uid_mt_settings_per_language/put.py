...
# body param
SchemaForRequestBodyApplicationJson = EditProjectMTSettPerLangListDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _set_mt_settings_per_language_for_project_oapg(
        self,
...
class SetMtSettingsPerLanguageForProject(BaseApi):
    ...
    def set_mt_settings_per_language_for_project(
        ...
        return self._set_mt_settings_per_language_for_project_oapg(
            body=body,
