...
# Path params
FieldUidSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'fieldUid': typing.Union[FieldUidSchema, str, ],
    }
)
...
request_path_field_uid = api_client.PathParameter(
    name="fieldUid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=FieldUidSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = PageDtoCustomFieldOptionDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_custom_field_option_list_oapg(
        self,
...
class GetCustomFieldOptionList(BaseApi):
    ...
    def get_custom_field_option_list(
        ...
        return self._get_custom_field_option_list_oapg(
