...
SchemaFor200ResponseBodyApplicationJson = WebhookPreviewsDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_webhook_previews_oapg(
        self,
...
class GetWebhookPreviews(BaseApi):
    ...
    def get_webhook_previews(
        ...
        return self._get_webhook_previews_oapg(
