...
# body param
SchemaForRequestBodyApplicationJson = PseudoTranslateActionDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _pseudo_translate_job_part_oapg(
        self,
...
class PseudoTranslateJobPart(BaseApi):
    ...
    def pseudo_translate_job_part(
        ...
        return self._pseudo_translate_job_part_oapg(
            body=body,
