...
# Path params
SubDomainUidSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'subDomainUid': typing.Union[SubDomainUidSchema, str, ],
    }
)
...
request_path_sub_domain_uid = api_client.PathParameter(
    name="subDomainUid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=SubDomainUidSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = SubDomainEditDto
...
SchemaFor200ResponseBodyApplicationJson = SubDomainDto
...
class UpdateSubDomain(BaseApi):
    ...
    def update_sub_domain(
        ...
        return self._update_sub_domain_oapg(
            body=body,
