...
# body param
SchemaForRequestBodyApplicationJson = SearchJobsRequestDto
...
SchemaFor200ResponseBodyApplicationJson = SearchJobsDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _search_parts_in_project_oapg(
        self,
...
class SearchPartsInProject(BaseApi):
    ...
    def search_parts_in_project(
        ...
        return self._search_parts_in_project_oapg(
            body=body,
