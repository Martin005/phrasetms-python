...
# Path params
ProfileUidSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'profileUid': typing.Union[ProfileUidSchema, str, ],
    }
)
...
request_path_profile_uid = api_client.PathParameter(
    name="profileUid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ProfileUidSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = UpdateLqaProfileDto
...
SchemaFor200ResponseBodyApplicationJson = LqaProfileDetailDto
...
class UpdateLqaProfile(BaseApi):
    ...
    def update_lqa_profile(
        ...
        return self._update_lqa_profile_oapg(
            body=body,
