...
# body param
SchemaForRequestBodyApplicationJson = CreateLqaProfileDto
...
SchemaFor201ResponseBodyApplicationJson = LqaProfileDetailDto
...
class CreateLqaProfile(BaseApi):
    ...
    def create_lqa_profile(
        ...
        return self._create_lqa_profile_oapg(
            body=body,
