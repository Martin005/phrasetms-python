...
# body param
SchemaForRequestBodyApplicationJson = CreateLqaConversationDto
...
SchemaFor201ResponseBodyApplicationJson = LQAConversationDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_lqa_conversation1_oapg(
        self,
...
class CreateLqaConversation1(BaseApi):
    ...
    def create_lqa_conversation1(
        ...
        return self._create_lqa_conversation1_oapg(
            body=body,
