...
# body param
SchemaForRequestBodyApplicationJson = AddTargetLangDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _add_target_language_to_project_oapg(
        self,
...
class AddTargetLanguageToProject(BaseApi):
    ...
    def add_target_language_to_project(
        ...
        return self._add_target_language_to_project_oapg(
            body=body,
