...
SchemaFor200ResponseBodyApplicationJson = OrganizationEmailTemplateDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_org_email_template_oapg(
        self,
...
class GetOrgEmailTemplate(BaseApi):
    ...
    def get_org_email_template(
        ...
        return self._get_org_email_template_oapg(
