...
SchemaFor200ResponseBodyApplicationJson = AnalyseJobDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_job_part_analyse_oapg(
        self,
...
class GetJobPartAnalyse(BaseApi):
    ...
    def get_job_part_analyse(
        ...
        return self._get_job_part_analyse_oapg(
