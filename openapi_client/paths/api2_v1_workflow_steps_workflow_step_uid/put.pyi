...
# Path params
WorkflowStepUidSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'workflowStepUid': typing.Union[WorkflowStepUidSchema, str, ],
    }
)
...
request_path_workflow_step_uid = api_client.PathParameter(
    name="workflowStepUid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=WorkflowStepUidSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = EditWorkflowStepDto
...
SchemaFor200ResponseBodyApplicationJson = WorkflowStepDto
...
class BaseApi(api_client.Api):
    ...
    def _edit_wf_step_oapg(
        ...
        _path_params = {}
        for parameter in (
            request_path_workflow_step_uid,
        ):
...
class EditWfStep(BaseApi):
    ...
    def edit_wf_step(
        ...
        return self._edit_wf_step_oapg(
            body=body,
