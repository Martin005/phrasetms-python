...
SchemaFor201ResponseBodyApplicationJson = AddLqaCommentResultDto
...
class AddLqaComment1(BaseApi):
    ...
    def add_lqa_comment1(
        ...
        return self._add_lqa_comment1_oapg(
            body=body,
