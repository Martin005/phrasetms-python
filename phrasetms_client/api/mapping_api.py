...
class MappingApi(object):
    ...
    def get_mapping_for_task(self, id : StrictStr, workflow_level : Optional[conint(strict=True, le=15, ge=1)] = None, **kwargs) -> TaskMappingDto:  # noqa: E501
        ...
        >>> thread = api.get_mapping_for_task(id, workflow_level, async_req=True)
        >>> result = thread.get()
    ...
    def get_mapping_for_task_with_http_info(self, id : StrictStr, workflow_level : Optional[conint(strict=True, le=15, ge=1)] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.get_mapping_for_task_with_http_info(id, workflow_level, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(TaskMappingDto, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_mapping_for_task" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
