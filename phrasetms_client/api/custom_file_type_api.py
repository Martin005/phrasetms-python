...
class CustomFileTypeApi(object):
    ...
    def create_custom_file_types(self, body : Optional[CreateCustomFileTypeDto] = None, **kwargs) -> CustomFileTypeDto:  # noqa: E501
        ...
        >>> thread = api.create_custom_file_types(body, async_req=True)
        >>> result = thread.get()

        :param body:
        :type body: CreateCustomFileTypeDto
    ...
    def create_custom_file_types_with_http_info(self, body : Optional[CreateCustomFileTypeDto] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.create_custom_file_types_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CustomFileTypeDto, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method create_custom_file_types" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def delete_batch_custom_file_type(self, body : Optional[DeleteCustomFileTypeDto] = None, **kwargs) -> None:  # noqa: E501
        ...
        >>> thread = api.delete_batch_custom_file_type(body, async_req=True)
        >>> result = thread.get()

        :param body:
        :type body: DeleteCustomFileTypeDto
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
    ...
    def delete_batch_custom_file_type_with_http_info(self, body : Optional[DeleteCustomFileTypeDto] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.delete_batch_custom_file_type_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_batch_custom_file_type" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def delete_custom_file_type(self, custom_file_type_uid : StrictStr, **kwargs) -> None:  # noqa: E501
        ...
        :param custom_file_type_uid: (required)
        :type custom_file_type_uid: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
    ...
    def delete_custom_file_type_with_http_info(self, custom_file_type_uid : StrictStr, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_custom_file_type" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the path parameters
        _path_params = {}
        if _params['custom_file_type_uid']:
            _path_params['customFileTypeUid'] = _params['custom_file_type_uid']
    ...
    def get_all_custom_file_type(self, page_number : Annotated[Optional[conint(strict=True, ge=0)], Field(description="Page number, starting with 0, default 0")] = None, page_size : Annotated[Optional[conint(strict=True, le=50, ge=1)], Field(description="Page size, accepts values between 1 and 50, default 50")] = None, **kwargs) -> PageDtoCustomFileTypeDto:  # noqa: E501
        ...
        >>> thread = api.get_all_custom_file_type(page_number, page_size, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: PageDtoCustomFileTypeDto
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
    ...
    def get_all_custom_file_type_with_http_info(self, page_number : Annotated[Optional[conint(strict=True, ge=0)], Field(description="Page number, starting with 0, default 0")] = None, page_size : Annotated[Optional[conint(strict=True, le=50, ge=1)], Field(description="Page size, accepts values between 1 and 50, default 50")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.get_all_custom_file_type_with_http_info(page_number, page_size, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PageDtoCustomFileTypeDto, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_all_custom_file_type" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def get_custom_file_type_with_http_info(self, custom_file_type_uid : StrictStr, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_custom_file_type" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def update_custom_file_type(self, custom_file_type_uid : StrictStr, body : Optional[UpdateCustomFileTypeDto] = None, **kwargs) -> CustomFileTypeDto:  # noqa: E501
        ...
        >>> thread = api.update_custom_file_type(custom_file_type_uid, body, async_req=True)
        >>> result = thread.get()

        :param custom_file_type_uid: (required)
        :type custom_file_type_uid: str
        :param body:
        :type body: UpdateCustomFileTypeDto
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
    ...
    def update_custom_file_type_with_http_info(self, custom_file_type_uid : StrictStr, body : Optional[UpdateCustomFileTypeDto] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.update_custom_file_type_with_http_info(custom_file_type_uid, body, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_custom_file_type" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
