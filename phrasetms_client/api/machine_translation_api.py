...
class MachineTranslationApi(object):
    ...
    def machine_translation(self, mt_settings_uid, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.machine_translation_with_http_info(mt_settings_uid, **kwargs)  # noqa: E501
        else:
            (data) = self.machine_translation_with_http_info(mt_settings_uid, **kwargs)  # noqa: E501
            return data

    def machine_translation_with_http_info(self, mt_settings_uid, **kwargs):  # noqa: E501
        """Translate with MT  # noqa: E501
        ...
        if ('mt_settings_uid' not in params or
                params['mt_settings_uid'] is None):
            raise ValueError("Missing the required parameter `mt_settings_uid` when calling `machine_translation`")  # noqa: E501
