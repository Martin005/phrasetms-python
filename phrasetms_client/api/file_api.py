...
class FileApi(object):
    ...
    def create_url_file(self, uid, name, size, type, url, content_disposition, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_url_file(uid, name, size, type, url, content_disposition, async_req=True)
        >>> result = thread.get()
    ...
    def create_url_file_with_http_info(self, uid, name, size, type, url, content_disposition, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_url_file_with_http_info(uid, name, size, type, url, content_disposition, async_req=True)
        >>> result = thread.get()
