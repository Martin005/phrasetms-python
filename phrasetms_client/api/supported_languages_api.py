...
class SupportedLanguagesApi(object):
    ...
    def list_of_languages(self, active : Optional[StrictBool] = None, **kwargs) -> LanguageListDto:  # noqa: E501
        ...
        >>> thread = api.list_of_languages(active, async_req=True)
        >>> result = thread.get()
    ...
    def list_of_languages_with_http_info(self, active : Optional[StrictBool] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.list_of_languages_with_http_info(active, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(LanguageListDto, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method list_of_languages" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
