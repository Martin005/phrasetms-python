...
class WorkflowStepApi(object):
    ...
    def create_wf_step(self, **kwargs):  # noqa: E501
    ...
    def create_wf_step_with_http_info(self, **kwargs):  # noqa: E501
        """Create workflow step  # noqa: E501
    ...
    def edit_wf_step(self, workflow_step_uid, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.edit_wf_step_with_http_info(workflow_step_uid, **kwargs)  # noqa: E501
        else:
            (data) = self.edit_wf_step_with_http_info(workflow_step_uid, **kwargs)  # noqa: E501
            return data

    def edit_wf_step_with_http_info(self, workflow_step_uid, **kwargs):  # noqa: E501
        """Edit workflow step  # noqa: E501
        ...
        if ('workflow_step_uid' not in params or
                params['workflow_step_uid'] is None):
            raise ValueError("Missing the required parameter `workflow_step_uid` when calling `edit_wf_step`")  # noqa: E501
    ...
    def list_wf_steps_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['page_number', 'page_size', 'sort', 'order', 'name', 'abbr']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
