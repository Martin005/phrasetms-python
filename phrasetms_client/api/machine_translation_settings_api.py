...
class MachineTranslationSettingsApi(object):
    ...
    def get_list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['name', 'page_number', 'page_size', 'sort', 'order']  # noqa: E501
    ...
    def get_mt_settings(self, mts_uid, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_mt_settings_with_http_info(mts_uid, **kwargs)  # noqa: E501
            return data

    def get_mt_settings_with_http_info(self, mts_uid, **kwargs):  # noqa: E501
        """Get machine translate settings  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            ...
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'mts_uid' is set
        if ('mts_uid' not in params or
                params['mts_uid'] is None):
            raise ValueError("Missing the required parameter `mts_uid` when calling `get_mt_settings`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'mts_uid' in params:
            path_params['mtsUid'] = params['mts_uid']  # noqa: E501
    ...
    def get_mt_types(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_mt_types_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_mt_types_with_http_info(self, **kwargs):  # noqa: E501
        """Get machine translate settings types  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='TypesDto',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_status(self, mts_uid, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_status_with_http_info(mts_uid, **kwargs)  # noqa: E501
            return data

    def get_status_with_http_info(self, mts_uid, **kwargs):  # noqa: E501
        """Get status of machine translate engine  # noqa: E501
        ...
        if ('mts_uid' not in params or
                params['mts_uid'] is None):
            raise ValueError("Missing the required parameter `mts_uid` when calling `get_status`")  # noqa: E501
    ...
    def get_third_party_engines_list(self, **kwargs):  # noqa: E501
        """List third party machine translate settings  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_third_party_engines_list(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_third_party_engines_list_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_third_party_engines_list_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_third_party_engines_list_with_http_info(self, **kwargs):  # noqa: E501
        """List third party machine translate settings  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_third_party_engines_list_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_third_party_engines_list" % key
                )
            params[key] = val
        del params['kwargs']
