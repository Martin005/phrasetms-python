...
class CustomFieldsApi(object):
    ...
    def get_custom_field(self, field_uid, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_custom_field_with_http_info(field_uid, **kwargs)  # noqa: E501
            return data

    def get_custom_field_with_http_info(self, field_uid, **kwargs):  # noqa: E501
        """Get custom field  # noqa: E501
        ...
        if ('field_uid' not in params or
                params['field_uid'] is None):
            raise ValueError("Missing the required parameter `field_uid` when calling `get_custom_field`")  # noqa: E501
    ...
    def get_custom_field_list(self, **kwargs):  # noqa: E501
    ...
    def get_custom_field_list_with_http_info(self, **kwargs):  # noqa: E501
        """Lists custom fields  # noqa: E501
        ...
        all_params = ['page_number', 'page_size', 'name', 'allowed_entities', 'types', 'created_by', 'modified_by', 'uids', 'required', 'sort_field', 'sort_trend']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'allowed_entities' in params:
            query_params.append(('allowedEntities', params['allowed_entities']))  # noqa: E501
    ...
    def get_custom_field_option_list(self, field_uid, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_custom_field_option_list_with_http_info(field_uid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_custom_field_option_list_with_http_info(field_uid, **kwargs)  # noqa: E501
            return data

    def get_custom_field_option_list_with_http_info(self, field_uid, **kwargs):  # noqa: E501
        """Lists options of custom field  # noqa: E501
        ...
        all_params = ['field_uid', 'page_number', 'page_size', 'name', 'sort_field', 'sort_trend']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('field_uid' not in params or
                params['field_uid'] is None):
            raise ValueError("Missing the required parameter `field_uid` when calling `get_custom_field_option_list`")  # noqa: E501
