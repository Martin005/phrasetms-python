...
class NetRateSchemeApi(object):
    ...
    def create_discount_scheme(self, body : Optional[DiscountSchemeCreateDto] = None, **kwargs) -> NetRateScheme:  # noqa: E501
        ...
        >>> thread = api.create_discount_scheme(body, async_req=True)
        >>> result = thread.get()

        :param body:
        :type body: DiscountSchemeCreateDto
    ...
    def create_discount_scheme_with_http_info(self, body : Optional[DiscountSchemeCreateDto] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.create_discount_scheme_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(NetRateScheme, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method create_discount_scheme" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def edit_discount_scheme_workflow_step(self, net_rate_scheme_uid : StrictStr, net_rate_scheme_workflow_step_id : StrictInt, body : Optional[NetRateSchemeWorkflowStepEdit] = None, **kwargs) -> NetRateSchemeWorkflowStep:  # noqa: E501
        ...
        >>> thread = api.edit_discount_scheme_workflow_step(net_rate_scheme_uid, net_rate_scheme_workflow_step_id, body, async_req=True)
        >>> result = thread.get()

        :param net_rate_scheme_uid: (required)
        :type net_rate_scheme_uid: str
        :param net_rate_scheme_workflow_step_id: (required)
        :type net_rate_scheme_workflow_step_id: int
        :param body:
        :type body: NetRateSchemeWorkflowStepEdit
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: NetRateSchemeWorkflowStep
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
    ...
    def edit_discount_scheme_workflow_step_with_http_info(self, net_rate_scheme_uid : StrictStr, net_rate_scheme_workflow_step_id : StrictInt, body : Optional[NetRateSchemeWorkflowStepEdit] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.edit_discount_scheme_workflow_step_with_http_info(net_rate_scheme_uid, net_rate_scheme_workflow_step_id, body, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(NetRateSchemeWorkflowStep, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method edit_discount_scheme_workflow_step" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the path parameters
        _path_params = {}
        if _params['net_rate_scheme_uid']:
            _path_params['netRateSchemeUid'] = _params['net_rate_scheme_uid']

        if _params['net_rate_scheme_workflow_step_id']:
            _path_params['netRateSchemeWorkflowStepId'] = _params['net_rate_scheme_workflow_step_id']
    ...
    def get_discount_scheme_with_http_info(self, net_rate_scheme_uid : StrictStr, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_discount_scheme" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def get_discount_scheme_workflow_step_with_http_info(self, net_rate_scheme_uid : StrictStr, net_rate_scheme_workflow_step_id : StrictInt, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_discount_scheme_workflow_step" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def get_discount_scheme_workflow_steps(self, net_rate_scheme_uid : StrictStr, page_number : Optional[Annotated[int, Field(strict=True, ge=0)]] = None, page_size : Annotated[Optional[Annotated[int, Field(strict=True, le=50, ge=1)]], Field(description="Page size, accepts values between 1 and 50, default 50")] = None, **kwargs) -> PageDtoNetRateSchemeWorkflowStepReference:  # noqa: E501
        ...
        >>> thread = api.get_discount_scheme_workflow_steps(net_rate_scheme_uid, page_number, page_size, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: PageDtoNetRateSchemeWorkflowStepReference
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
    ...
    def get_discount_scheme_workflow_steps_with_http_info(self, net_rate_scheme_uid : StrictStr, page_number : Optional[Annotated[int, Field(strict=True, ge=0)]] = None, page_size : Annotated[Optional[Annotated[int, Field(strict=True, le=50, ge=1)]], Field(description="Page size, accepts values between 1 and 50, default 50")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.get_discount_scheme_workflow_steps_with_http_info(net_rate_scheme_uid, page_number, page_size, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PageDtoNetRateSchemeWorkflowStepReference, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_discount_scheme_workflow_steps" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "PageDtoNetRateSchemeWorkflowStepReference",
            '400': None,
            '401': None,
            '403': None,
            '404': None,
    ...
    def get_discount_schemes(self, page_number : Optional[Annotated[int, Field(strict=True, ge=0)]] = None, page_size : Annotated[Optional[Annotated[int, Field(strict=True, le=50, ge=1)]], Field(description="Page size, accepts values between 1 and 50, default 50")] = None, **kwargs) -> PageDtoNetRateSchemeReference:  # noqa: E501
        ...
        >>> thread = api.get_discount_schemes(page_number, page_size, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: PageDtoNetRateSchemeReference
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
    ...
    def get_discount_schemes_with_http_info(self, page_number : Optional[Annotated[int, Field(strict=True, ge=0)]] = None, page_size : Annotated[Optional[Annotated[int, Field(strict=True, le=50, ge=1)]], Field(description="Page size, accepts values between 1 and 50, default 50")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.get_discount_schemes_with_http_info(page_number, page_size, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PageDtoNetRateSchemeReference, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_discount_schemes" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "PageDtoNetRateSchemeReference",
            '400': None,
            '401': None,
            '403': None,
            '404': None,
    ...
    def update_discount_scheme(self, net_rate_scheme_uid : StrictStr, body : Optional[NetRateSchemeEdit] = None, **kwargs) -> NetRateScheme:  # noqa: E501
        ...
        >>> thread = api.update_discount_scheme(net_rate_scheme_uid, body, async_req=True)
        >>> result = thread.get()

        :param net_rate_scheme_uid: (required)
        :type net_rate_scheme_uid: str
        :param body:
        :type body: NetRateSchemeEdit
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
    ...
    def update_discount_scheme_with_http_info(self, net_rate_scheme_uid : StrictStr, body : Optional[NetRateSchemeEdit] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.update_discount_scheme_with_http_info(net_rate_scheme_uid, body, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_discount_scheme" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
