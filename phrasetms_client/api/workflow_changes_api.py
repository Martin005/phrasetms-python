...
class WorkflowChangesApi(object):
    ...
    def download_workflow_changes(self, body : Optional[WorkflowChangesDto] = None, **kwargs) -> None:  # noqa: E501
        ...
        >>> thread = api.download_workflow_changes(body, async_req=True)
        >>> result = thread.get()

        :param body:
        :type body: WorkflowChangesDto
    ...
    def download_workflow_changes_with_http_info(self, body : Optional[WorkflowChangesDto] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.download_workflow_changes_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method download_workflow_changes" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
