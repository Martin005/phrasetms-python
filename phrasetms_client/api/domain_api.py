...
class DomainApi(object):
    ...
    def update_domain(self, domain_uid, **kwargs) -> DomainDto:  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_domain(domain_uid, async_req=True)
        >>> result = thread.get()
    ...
    def update_domain_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_domain_with_http_info(domain_uid, async_req=True)
        >>> result = thread.get()
