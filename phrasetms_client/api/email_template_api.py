...
class EmailTemplateApi(object):
    ...
    def get_org_email_template(
    ...
    ) -> OrganizationEmailTemplateDto:  # noqa: E501
        ...
        if kwargs.get("async_req"):
            return self.get_org_email_template_with_http_info(
                template_uid, **kwargs
            )  # noqa: E501
        else:
            (data) = self.get_org_email_template_with_http_info(
                template_uid, **kwargs
            )  # noqa: E501
            return data

    def get_org_email_template_with_http_info(
        self, template_uid, **kwargs
    ) -> OrganizationEmailTemplateDto:  # noqa: E501
        """Get email template  # noqa: E501
        ...
        if "template_uid" not in params or params["template_uid"] is None:
            raise ValueError(
                "Missing the required parameter `template_uid` when calling `get_org_email_template`"
            )  # noqa: E501
    ...
    def list_org_email_templates(
        ...
        if kwargs.get("async_req"):
            ...
            (data) = self.list_org_email_templates_with_http_info(
                **kwargs
            )  # noqa: E501
            return data
