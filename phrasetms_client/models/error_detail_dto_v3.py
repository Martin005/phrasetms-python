...
class ErrorDetailDtoV3(BaseModel):
    ...
    ErrorDetailDtoV3
    """
    code: Optional[StrictStr] = Field(None, description="Code, e.g. NOT_FOUND.")
    args: Optional[Dict[str, Dict[str, Any]]] = Field(None, description="Related arguments, e.g. number => \"hello world\"")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ErrorDetailDtoV3:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ErrorDetailDtoV3:
