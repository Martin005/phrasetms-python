...
class VerityWeightsDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VerityWeightsDto:
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic by calling `to_dict()` of culture_specific_reference
        if self.culture_specific_reference:
            _dict['cultureSpecificReference'] = self.culture_specific_reference.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> VerityWeightsDto:
