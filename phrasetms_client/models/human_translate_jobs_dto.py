...
class HumanTranslateJobsDto(object):
    ...
    def __init__(
        self,
        jobs=None,
        human_translate_settings=None,
        comment=None,
        glossary_id=None,
        use_preferred_translators=None,
        level=None,
        callback_url=None,
    ):  # noqa: E501
    ...
    @property
    def human_translate_settings(self) -> IdReference:
    ...
    def human_translate_settings(self, human_translate_settings):
        ...
        if human_translate_settings is None:
            raise ValueError(
                "Invalid value for `human_translate_settings`, must not be `None`"
            )  # noqa: E501
    ...
    @property
    def use_preferred_translators(self) -> bool:
