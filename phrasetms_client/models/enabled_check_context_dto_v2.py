...
class EnabledCheckContextDtoV2(BaseModel):
    ...
    """
    moravia_profile_id: Optional[StrictStr] = Field(None, alias="moraviaProfileId")
    custom_qa_display_name: Optional[StrictStr] = Field(None, alias="customQaDisplayName")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EnabledCheckContextDtoV2:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EnabledCheckContextDtoV2:
