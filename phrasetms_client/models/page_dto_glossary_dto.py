...
class PageDtoGlossaryDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoGlossaryDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoGlossaryDto:
        ...
        _obj = PageDtoGlossaryDto.parse_obj({
            ...
            "content": [GlossaryDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
