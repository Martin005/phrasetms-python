...
class PageDtoProjectReference(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoProjectReference:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoProjectReference:
        ...
        _obj = PageDtoProjectReference.parse_obj({
            ...
            "content": [ProjectReference.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
