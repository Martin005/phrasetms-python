...
class RegexpCheckRuleDtoV2(BaseModel):
    ...
    source_regexp: Optional[StrictStr] = Field(None, alias="sourceRegexp")
    target_regexp: Optional[StrictStr] = Field(None, alias="targetRegexp")
    id: Optional[StrictStr] = None
    ignorable: Optional[StrictBool] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RegexpCheckRuleDtoV2:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RegexpCheckRuleDtoV2:
