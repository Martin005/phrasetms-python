...
class PageDtoWebHookDtoV2(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoWebHookDtoV2:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoWebHookDtoV2:
        ...
        _obj = PageDtoWebHookDtoV2.parse_obj({
            ...
            "content": [WebHookDtoV2.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
