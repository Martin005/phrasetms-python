...
class PageDtoImportSettingsReference(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoImportSettingsReference:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoImportSettingsReference:
        ...
        _obj = PageDtoImportSettingsReference.parse_obj({
            ...
            "content": [ImportSettingsReference.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
