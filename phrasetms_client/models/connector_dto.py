...
class ConnectorDto(object):
    ...
    def type(self, type):
        ...
        :type: str
        """
        allowed_values = ["DROPBOX", "GOOGLE", "FTP", "WORDPRESS", "GITHUB", "SFTP", "DRUPAL", "BOX", "GIT", "ZENDESK", "ONEDRIVE", "GITLAB", "MARKETO", "HUBSPOT", "HELPSCOUT", "SALESFORCE", "BITBUCKET", "BITBUCKETSERVER", "BRAZE", "SHAREPOINT", "AZURE", "SITECORE", "KENTICO", "KENTICO_KONTENT", "MAGENTO", "CONTENTFULENTRYLEVEL", "CONTENTFUL", "CONTENTSTACK", "JOOMLA", "CONFLUENCE", "TRIDION", "TYPO3", "AEM_PLUGIN", "DRUPAL_PLUGIN", "AMAZON_S3", "PARDOT", "PHRASE"]  # noqa: E501
