...
from phrasetms_client.models import AutomatedProjectSettingsDto, NameDto
...
class ConnectorDto(object):
    ...
    def __init__(
        ...
        created_at=None,
        local_token=None,
        automated_project_settings=None,
    ):  # noqa: E501
    ...
    @property
    def automated_project_settings(self) -> list[AutomatedProjectSettingsDto]:
