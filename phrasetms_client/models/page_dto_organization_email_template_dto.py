...
class PageDtoOrganizationEmailTemplateDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoOrganizationEmailTemplateDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoOrganizationEmailTemplateDto:
        ...
        _obj = PageDtoOrganizationEmailTemplateDto.parse_obj({
            ...
            "content": [OrganizationEmailTemplateDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
