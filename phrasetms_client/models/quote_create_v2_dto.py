...
class QuoteCreateV2Dto(object):
    ...
    def __init__(self, name=None, project=None, analyse=None, price_list=None, net_rate_scheme=None, provider=None, workflow_settings=None, units=None, additional_steps=None):  # noqa: E501
    ...
    def analyse(self, analyse):
        ...
        """
        if analyse is None:
            raise ValueError("Invalid value for `analyse`, must not be `None`")  # noqa: E501
