...
class PageDtoAnalyseReference(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoAnalyseReference:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoAnalyseReference:
        ...
        _obj = PageDtoAnalyseReference.parse_obj({
            ...
            "content": [AnalyseReference.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
