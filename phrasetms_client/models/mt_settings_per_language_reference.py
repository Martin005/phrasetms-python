...
class MTSettingsPerLanguageReference(BaseModel):
    ...
    """
    target_lang: Optional[StrictStr] = Field(None, alias="targetLang", description="mtSettings is set for whole project if targetLang == null")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MTSettingsPerLanguageReference:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MTSettingsPerLanguageReference:
