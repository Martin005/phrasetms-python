...
class PsdSettingsDto(BaseModel):
    ...
    PsdSettingsDto
    """
    extract_hidden_layers: Optional[StrictBool] = Field(None, alias="extractHiddenLayers", description="Default: true")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PsdSettingsDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PsdSettingsDto:
