...
class UpdateIgnoredWarningsDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateIgnoredWarningsDto:
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of each item in job_parts (list)
        _items = []
        if self.job_parts:
            for _item in self.job_parts:
                if _item:
                    _items.append(_item.to_dict())
            _dict['jobParts'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> UpdateIgnoredWarningsDto:
