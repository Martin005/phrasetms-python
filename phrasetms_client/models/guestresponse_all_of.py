...
class GUESTRESPONSEAllOf(BaseModel):
    ...
    project_view_other_linguist: Optional[StrictBool] = Field(None, alias="projectViewOtherLinguist")
    project_view_other_editor: Optional[StrictBool] = Field(None, alias="projectViewOtherEditor")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GUESTRESPONSEAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GUESTRESPONSEAllOf:
