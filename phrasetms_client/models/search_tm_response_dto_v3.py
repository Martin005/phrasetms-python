...
from phrasetms_client.models import SearchTMTransMemoryDtoV3, SearchTMSegmentDtoV3
...
class SearchTMResponseDtoV3(object):
    ...
    @property
    def source(self) -> SearchTMSegmentDtoV3:
    ...
    @property
    def translations(self) -> list[SearchTMSegmentDtoV3]:
    ...
    @property
    def trans_memory(self) -> SearchTMTransMemoryDtoV3:
