...
class Attribute(object):
    ...
    def mutability(self, mutability):
        ...
        if mutability not in allowed_values:
            raise ValueError(
                "Invalid value for `mutability` ({0}), must be one of {1}".format(  # noqa: E501
                    mutability, allowed_values
                )
            )
    ...
    def returned(self, returned):
        ...
        if returned not in allowed_values:
            raise ValueError(
                "Invalid value for `returned` ({0}), must be one of {1}".format(  # noqa: E501
                    returned, allowed_values
                )
            )
    ...
    def uniqueness(self, uniqueness):
        ...
        if uniqueness not in allowed_values:
            raise ValueError(
                "Invalid value for `uniqueness` ({0}), must be one of {1}".format(  # noqa: E501
                    uniqueness, allowed_values
                )
            )
