...
from phrasetms_client.models import UserStatisticsDto
...
class UserStatisticsListDto(object):
    ...
    """
    swagger_types = {"user_statistics": "list[UserStatisticsDto]"}

    attribute_map = {"user_statistics": "userStatistics"}
    ...
    @property
    def user_statistics(self) -> list[UserStatisticsDto]:
    ...
    def user_statistics(self, user_statistics):
        ...
        if user_statistics is None:
            raise ValueError(
                "Invalid value for `user_statistics`, must not be `None`"
            )  # noqa: E501
