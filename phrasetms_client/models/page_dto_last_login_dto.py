...
class PageDtoLastLoginDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoLastLoginDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoLastLoginDto:
        ...
        _obj = PageDtoLastLoginDto.parse_obj({
            ...
            "content": [LastLoginDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
