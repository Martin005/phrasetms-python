...
class CreateCustomFieldDto(object):
    ...
    def __init__(self, name=None, allowed_entities=None, options=None, type=None, required=None, description=None):  # noqa: E501
    ...
    def allowed_entities(self, allowed_entities):
        ...
        if allowed_entities is None:
            raise ValueError("Invalid value for `allowed_entities`, must not be `None`")  # noqa: E501
