...
class EnabledCheckDtoV2(BaseModel):
    ...
    EnabledCheckDtoV2
    """
    checker_type: Optional[StrictStr] = Field(None, alias="checkerType")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EnabledCheckDtoV2:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EnabledCheckDtoV2:
