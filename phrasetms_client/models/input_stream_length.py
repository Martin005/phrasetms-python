...
class InputStreamLength(BaseModel):
    ...
    character_encoding: Optional[StrictStr] = Field(None, alias="characterEncoding")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InputStreamLength:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InputStreamLength:
        ...
        _obj = InputStreamLength.parse_obj({
            ...
            "name": obj.get("name"),
            "character_encoding": obj.get("characterEncoding"),
            "extension": obj.get("extension"),
            "cleanup_task": obj.get("cleanupTask")
        })
        return _obj
