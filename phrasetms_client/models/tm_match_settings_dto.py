...
class TMMatchSettingsDto(object):
    ...
    def __init__(self, context_type=None, prev_or_next_segment=None, penalize_multi_context_match=None, ignore_tag_metadata=None, metadata_priority=None):  # noqa: E501
