...
class ProjectTranslationMemoryReference(BaseModel):
    ...
    trans_mem: Optional[Dict[str, Any]] = Field(None, alias="transMem")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProjectTranslationMemoryReference:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProjectTranslationMemoryReference:
