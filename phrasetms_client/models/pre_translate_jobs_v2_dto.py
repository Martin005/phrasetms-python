...
class PreTranslateJobsV2Dto(object):
    ...
    def __init__(self, jobs=None, segment_filters=None, use_project_pre_translate_settings=None, callback_url=None, pre_translate_settings=None):  # noqa: E501
    ...
    @property
    def pre_translate_settings(self):
