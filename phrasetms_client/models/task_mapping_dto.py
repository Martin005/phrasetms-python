...
class TaskMappingDto(BaseModel):
    ...
    workflow_level: Optional[StrictStr] = Field(None, alias="workflowLevel")
    resource_path: Optional[StrictStr] = Field(None, alias="resourcePath")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskMappingDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskMappingDto:
