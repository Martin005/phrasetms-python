...
from phrasetms_client.models import QualityAssuranceDto
...
class SegmentsCountsDto(object):
    ...
    def __init__(
        ...
        all_confirmed=None,
        chars_count=None,
        completed_chars_count=None,
        confirmed_chars_count=None,
        confirmed_locked_chars_count=None,
        locked_chars_count=None,
        segments_count=None,
        completed_segments_count=None,
        locked_segments_count=None,
        segment_groups_count=None,
        translated_segments_count=None,
        translated_locked_segments_count=None,
        words_count=None,
        completed_words_count=None,
        confirmed_words_count=None,
        confirmed_locked_words_count=None,
        locked_words_count=None,
        added_segments=None,
        added_words=None,
        machine_translation_post_edited_segments_count=None,
        machine_translation_relevant_segments_count=None,
        quality_assurance=None,
        quality_assurance_resolved=None,
    ):  # noqa: E501
        ...
        self._added_segments = None
        self._added_words = None
        ...
        if added_segments is not None:
            self.added_segments = added_segments
        if added_words is not None:
            self.added_words = added_words
        if machine_translation_post_edited_segments_count is not None:
            self.machine_translation_post_edited_segments_count = (
                machine_translation_post_edited_segments_count
            )
        if machine_translation_relevant_segments_count is not None:
            self.machine_translation_relevant_segments_count = (
                machine_translation_relevant_segments_count
            )
    ...
    @property
    def completed_chars_count(self) -> int:
    ...
    @property
    def confirmed_chars_count(self) -> int:
    ...
    @property
    def confirmed_locked_chars_count(self) -> int:
    ...
    @property
    def locked_chars_count(self) -> int:
    ...
    @property
    def completed_segments_count(self) -> int:
    ...
    @property
    def locked_segments_count(self) -> int:
    ...
    @property
    def segment_groups_count(self) -> int:
    ...
    @property
    def translated_segments_count(self) -> int:
    ...
    @property
    def translated_locked_segments_count(self) -> int:
    ...
    @property
    def completed_words_count(self) -> int:
    ...
    @property
    def confirmed_words_count(self) -> int:
    ...
    @property
    def confirmed_locked_words_count(self) -> int:
    ...
    @property
    def locked_words_count(self) -> int:
    ...
    @property
    def added_segments(self) -> int:
        """Gets the added_segments of this SegmentsCountsDto.  # noqa: E501


        :return: The added_segments of this SegmentsCountsDto.  # noqa: E501
        :rtype: int
        """
        return self._added_segments

    @added_segments.setter
    def added_segments(self, added_segments):
        """Sets the added_segments of this SegmentsCountsDto.


        :param added_segments: The added_segments of this SegmentsCountsDto.  # noqa: E501
        :type: int
        """

        self._added_segments = added_segments

    @property
    def added_words(self) -> int:
        """Gets the added_words of this SegmentsCountsDto.  # noqa: E501


        :return: The added_words of this SegmentsCountsDto.  # noqa: E501
        :rtype: int
        """
        return self._added_words

    @added_words.setter
    def added_words(self, added_words):
        """Sets the added_words of this SegmentsCountsDto.


        :param added_words: The added_words of this SegmentsCountsDto.  # noqa: E501
        :type: int
        """

        self._added_words = added_words

    @property
    def machine_translation_post_edited_segments_count(self) -> int:
    ...
    def machine_translation_post_edited_segments_count(
        self, machine_translation_post_edited_segments_count
    ):
        ...
        self._machine_translation_post_edited_segments_count = (
            machine_translation_post_edited_segments_count
        )

    @property
    def machine_translation_relevant_segments_count(self) -> int:
    ...
    def machine_translation_relevant_segments_count(
        self, machine_translation_relevant_segments_count
    ):
        ...
        self._machine_translation_relevant_segments_count = (
            machine_translation_relevant_segments_count
        )

    @property
    def quality_assurance(self) -> QualityAssuranceDto:
    ...
    @property
    def quality_assurance_resolved(self) -> bool:
