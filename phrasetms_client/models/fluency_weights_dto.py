...
class FluencyWeightsDto(object):
    ...
    @property
    def fluency(self) -> ToggleableWeightDto:
    ...
    @property
    def punctuation(self) -> ToggleableWeightDto:
    ...
    @property
    def spelling(self) -> ToggleableWeightDto:
    ...
    @property
    def grammar(self) -> ToggleableWeightDto:
    ...
    @property
    def grammatical_register(self) -> ToggleableWeightDto:
    ...
    @property
    def inconsistency(self) -> ToggleableWeightDto:
    ...
    @property
    def cross_reference(self) -> ToggleableWeightDto:
    ...
    @property
    def character_encoding(self) -> ToggleableWeightDto:
