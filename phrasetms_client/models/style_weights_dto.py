...
class StyleWeightsDto(object):
    ...
    def __init__(self, style=None, awkward=None, company_style=None, inconsistent_style=None, third_party_style=None, unidiomatic=None):  # noqa: E501
