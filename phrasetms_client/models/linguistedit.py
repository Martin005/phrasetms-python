...
class LINGUISTEDIT(AbstractUserEditDto):
    ...
    LINGUISTEDIT
    """
    edit_all_terms_in_tb: Optional[StrictBool] = Field(None, alias="editAllTermsInTB", description="Edit all terms in TB. Default: false")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LINGUISTEDIT:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LINGUISTEDIT:
        ...
        _obj = LINGUISTEDIT.parse_obj({
            ...
            "translation_price_list": UidReference.from_dict(obj.get("translationPriceList")) if obj.get("translationPriceList") is not None else None
        })
        return _obj
