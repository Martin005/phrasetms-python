...
class PageDtoNetRateSchemeWorkflowStepReference(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoNetRateSchemeWorkflowStepReference:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoNetRateSchemeWorkflowStepReference:
        ...
        _obj = PageDtoNetRateSchemeWorkflowStepReference.parse_obj({
            ...
            "content": [NetRateSchemeWorkflowStepReference.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
