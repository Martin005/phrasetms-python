...
class HtmlSettingsDto(object):
    ...
    def __init__(
        self,
        break_tag_creates_segment=None,
        unknown_tag_creates_tag=None,
        preserve_whitespace=None,
        import_comments=None,
        exclude_elements=None,
        tag_regexp=None,
        char_entities_to_tags=None,
        translate_meta_tag_regexp=None,
        import_default_meta_tags=None,
        translatable_attributes=None,
        import_default_attributes=None,
        non_translatable_inline_elements=None,
        translatable_inline_elements=None,
        update_lang=None,
        escape_disabled=None,
    ):  # noqa: E501
    ...
    @property
    def break_tag_creates_segment(self) -> bool:
    ...
    @property
    def unknown_tag_creates_tag(self) -> bool:
    ...
    @property
    def char_entities_to_tags(self) -> str:
    ...
    @property
    def translate_meta_tag_regexp(self) -> str:
    ...
    @property
    def import_default_meta_tags(self) -> bool:
    ...
    @property
    def translatable_attributes(self) -> str:
    ...
    @property
    def import_default_attributes(self) -> bool:
    ...
    @property
    def non_translatable_inline_elements(self) -> str:
    ...
    @property
    def translatable_inline_elements(self) -> str:
