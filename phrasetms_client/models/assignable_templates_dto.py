...
class AssignableTemplatesDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AssignableTemplatesDto:
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of each item in assignable_templates (list)
        _items = []
        if self.assignable_templates:
            for _item in self.assignable_templates:
                if _item:
                    _items.append(_item.to_dict())
            _dict['assignableTemplates'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> AssignableTemplatesDto:
