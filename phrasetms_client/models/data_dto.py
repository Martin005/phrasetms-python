...
class DataDto(object):
    ...
    def __init__(self, available=None, estimate=None, all=None, repetitions=None, trans_memory_matches=None, machine_translation_matches=None, non_translatables_matches=None, internal_fuzzy_matches=None):  # noqa: E501
