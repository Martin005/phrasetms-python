...
class DataDto(BaseModel):
    ...
    non_translatables_matches: Optional[MatchCountsNTDto] = Field(None, alias="nonTranslatablesMatches")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DataDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DataDto:
        ...
        _obj = DataDto.parse_obj({
            ...
            "non_translatables_matches": MatchCountsNTDto.from_dict(obj.get("nonTranslatablesMatches")) if obj.get("nonTranslatablesMatches") is not None else None,
