...
'PreAnalyseTarget, Compare': 'PreAnalyseTargetCompare'    }
    ...
    def __init__(self, type=None, include_confirmed_segments=None, include_numbers=None, include_locked_segments=None, count_source_units=None, include_trans_memory=None, naming_pattern=None, analyze_by_language=None, analyze_by_provider=None, allow_automatic_post_analysis=None):  # noqa: E501
