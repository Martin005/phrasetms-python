...
class LINGUISTRESPONSE(UserDetailsDtoV3):
    ...
    @property
    def workflow_steps(self) -> list[WorkflowStepReferenceV3]:
    ...
    @property
    def clients(self) -> list[ClientReference]:
    ...
    @property
    def domains(self) -> list[DomainReference]:
    ...
    @property
    def sub_domains(self) -> list[SubDomainReference]:
    ...
    @property
    def net_rate_scheme(self) -> DiscountSchemeReference:
    ...
    @property
    def translation_price_list(self) -> PriceListReference:
