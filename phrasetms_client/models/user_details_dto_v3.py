...
'SUBMITTER_RESPONSE': 'SUBMITTERRESPONSE'    }
    ...
    def __init__(self, uid=None, user_name=None, first_name=None, last_name=None, email=None, date_created=None, date_deleted=None, created_by=None, role=None, timezone=None, note=None, receive_newsletter=None, active=None, pending_email_change=None):  # noqa: E501
