...
class JobPartReadyDeleteTranslationDto(object):
    ...
    @property
    def delete_settings(self) -> TranslationSegmentsReferenceV2:
    ...
    @property
    def filter(self) -> JobPartReadyDeleteTranslationFilterDto:
