...
class PageDtoClientDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoClientDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoClientDto:
        ...
        _obj = PageDtoClientDto.parse_obj({
            ...
            "content": [ClientDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
