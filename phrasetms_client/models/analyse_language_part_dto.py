...
class AnalyseLanguagePartDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AnalyseLanguagePartDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AnalyseLanguagePartDto:
        ...
        _obj = AnalyseLanguagePartDto.parse_obj({
            ...
            "discounted_data": DataDtoV1.from_dict(obj.get("discountedData")) if obj.get("discountedData") is not None else None,
