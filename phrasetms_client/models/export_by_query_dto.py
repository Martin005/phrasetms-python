...
from phrasetms_client.models import UidReference, IdReference
...
class ExportByQueryDto(object):
    ...
    def export_target_langs(self, export_target_langs):
        ...
        if export_target_langs is None:
            raise ValueError(
                "Invalid value for `export_target_langs`, must not be `None`"
            )  # noqa: E501
    ...
    def query_langs(self, query_langs):
        ...
        if query_langs is None:
            raise ValueError(
                "Invalid value for `query_langs`, must not be `None`"
            )  # noqa: E501

        self._query_langs = query_langs

    @property
    def created_at_min(self) -> datetime:
    ...
    @property
    def created_at_max(self) -> datetime:
    ...
    @property
    def modified_at_min(self) -> datetime:
    ...
    @property
    def modified_at_max(self) -> datetime:
    ...
    @property
    def created_by(self) -> IdReference:
    ...
    @property
    def modified_by(self) -> IdReference:
