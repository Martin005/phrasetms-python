...
class PageDtoTransMemoryDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoTransMemoryDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoTransMemoryDto:
        ...
        _obj = PageDtoTransMemoryDto.parse_obj({
            ...
            "content": [TransMemoryDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
