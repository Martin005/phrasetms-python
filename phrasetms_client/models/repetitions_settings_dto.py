...
class RepetitionsSettingsDto(object):
    ...
    def __init__(
        ...
        auto_propagate_to_locked_repetitions=None,
        lock_subsequent_repetitions=None,
    ):  # noqa: E501
        ...
        if auto_propagate_to_locked_repetitions is not None:
            self.auto_propagate_to_locked_repetitions = (
                auto_propagate_to_locked_repetitions
            )
    ...
    @property
    def auto_propagate_to_locked_repetitions(self) -> bool:
    ...
    def auto_propagate_to_locked_repetitions(
        self, auto_propagate_to_locked_repetitions
    ):
        ...
        self._auto_propagate_to_locked_repetitions = (
            auto_propagate_to_locked_repetitions
        )

    @property
    def lock_subsequent_repetitions(self) -> bool:
