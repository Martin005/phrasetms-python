...
class GitAllOf(BaseModel):
    ...
    commit_message: Optional[StrictStr] = Field(None, alias="commitMessage")
    ssh_key_name: Optional[StrictStr] = Field(None, alias="sshKeyName")
    ssh_key: Optional[StrictStr] = Field(None, alias="sshKey")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GitAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GitAllOf:
        ...
        _obj = GitAllOf.parse_obj({
            ...
            "ssh_key_name": obj.get("sshKeyName"),
            "ssh_key": obj.get("sshKey"),
            "ssh_pass_phrase": obj.get("sshPassPhrase")
        })
        return _obj
