...
class ConnectorErrorDetailDto(BaseModel):
    ...
    message_code: Optional[StrictStr] = Field(None, alias="messageCode")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConnectorErrorDetailDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConnectorErrorDetailDto:
        ...
        _obj = ConnectorErrorDetailDto.parse_obj({
            ...
            "args": obj.get("args"),
            "skip_prefix": obj.get("skipPrefix")
        })
        return _obj
