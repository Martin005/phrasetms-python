...
class JobPartExtendedDto(object):
    ...
    def __init__(self, uid=None, inner_id=None, status=None, providers=None, source_lang=None, target_lang=None, workflow_level=None, workflow_step=None, filename=None, date_due=None, words_count=None, begin_index=None, end_index=None, is_parent_job_split=None, update_source_date=None, update_target_date=None, date_created=None, job_reference=None, project=None, last_workflow_level=None, work_unit=None, import_status=None, imported=None, continuous=None, continuous_job_info=None, original_file_directory=None):  # noqa: E501
