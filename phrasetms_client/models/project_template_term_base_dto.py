...
class ProjectTemplateTermBaseDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProjectTemplateTermBaseDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProjectTemplateTermBaseDto:
        ...
        _obj = ProjectTemplateTermBaseDto.parse_obj({
            ...
            "quality_assurance": obj.get("qualityAssurance")
        })
        return _obj
