...
class LanguageDto(BaseModel):
    ...
    rfc: Optional[StrictStr] = None
    android: Optional[StrictStr] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LanguageDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LanguageDto:
        ...
        _obj = LanguageDto.parse_obj({
            ...
            "android_bcp": obj.get("androidBcp")
        })
        return _obj
