...
from phrasetms_client.models import TranslationPriceDto
...
class TranslationPriceSetDto(object):
    ...
    def __init__(
        self, source_lang=None, target_lang=None, minimum_price=None, prices=None
    ):  # noqa: E501
    ...
    @property
    def prices(self) -> list[TranslationPriceDto]:
