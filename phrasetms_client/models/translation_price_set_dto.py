...
class TranslationPriceSetDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TranslationPriceSetDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TranslationPriceSetDto:
        ...
        _obj = TranslationPriceSetDto.model_validate({
            ...
            "prices": [TranslationPriceDto.from_dict(_item) for _item in obj.get("prices")] if obj.get("prices") is not None else None
        })
        return _obj
