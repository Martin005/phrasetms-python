...
class PptSettingsDto(BaseModel):
    ...
    PptSettingsDto
    """
    hidden_slides: Optional[StrictBool] = Field(None, alias="hiddenSlides", description="Default: false")
    other: Optional[StrictBool] = Field(None, description="Default: false")
    notes: Optional[StrictBool] = Field(None, description="Default: false")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PptSettingsDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PptSettingsDto:
        ...
        _obj = PptSettingsDto.parse_obj({
            ...
            "other": obj.get("other"),
            "notes": obj.get("notes"),
            "master_slides": obj.get("masterSlides")
        })
        return _obj
