...
class CustomFieldInstanceDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomFieldInstanceDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomFieldInstanceDto:
        ...
        _obj = CustomFieldInstanceDto.parse_obj({
            ...
            "created_by": UidReference.from_dict(obj.get("createdBy")) if obj.get("createdBy") is not None else None,
            "updated_at": obj.get("updatedAt"),
            "updated_by": UidReference.from_dict(obj.get("updatedBy")) if obj.get("updatedBy") is not None else None
        })
        return _obj
