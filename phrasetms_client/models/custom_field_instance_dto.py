...
from phrasetms_client.models import UidReference, CustomFieldOptionDto, CustomFieldDto
...
class CustomFieldInstanceDto(object):
    ...
    @property
    def custom_field(self) -> CustomFieldDto:
    ...
    @property
    def selected_options(self) -> list[CustomFieldOptionDto]:
    ...
    @property
    def created_by(self) -> UidReference:
    ...
    @property
    def updated_by(self) -> UidReference:
