...
class AsciidocSettingsDto(object):
    ...
    def __init__(self, tag_regexp=None, html_in_passthrough=None, nontranslatable_monospace_custom_styles_regexp=None, extract_custom_document_attribute_name_regexp=None, extract_btn_menu_labels=None):  # noqa: E501
        ...
        if nontranslatable_monospace_custom_styles_regexp is not None:
            self.nontranslatable_monospace_custom_styles_regexp = nontranslatable_monospace_custom_styles_regexp
        if extract_custom_document_attribute_name_regexp is not None:
            self.extract_custom_document_attribute_name_regexp = extract_custom_document_attribute_name_regexp
    ...
    @property
    def nontranslatable_monospace_custom_styles_regexp(self):
    ...
    def nontranslatable_monospace_custom_styles_regexp(self, nontranslatable_monospace_custom_styles_regexp):
        ...
        self._nontranslatable_monospace_custom_styles_regexp = nontranslatable_monospace_custom_styles_regexp

    @property
    def extract_custom_document_attribute_name_regexp(self):
    ...
    def extract_custom_document_attribute_name_regexp(self, extract_custom_document_attribute_name_regexp):
        ...
        self._extract_custom_document_attribute_name_regexp = extract_custom_document_attribute_name_regexp

    @property
    def extract_btn_menu_labels(self):
