...
class AsciidocSettingsDto(BaseModel):
    ...
    html_in_passthrough: Optional[StrictBool] = Field(None, alias="htmlInPassthrough", description="Default: `false`")
    nontranslatable_monospace_custom_styles_regexp: Optional[StrictStr] = Field(None, alias="nontranslatableMonospaceCustomStylesRegexp")
    extract_custom_document_attribute_name_regexp: Optional[StrictStr] = Field(None, alias="extractCustomDocumentAttributeNameRegexp", description="Default: `.*`")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AsciidocSettingsDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AsciidocSettingsDto:
        ...
        _obj = AsciidocSettingsDto.parse_obj({
            ...
            "extract_custom_document_attribute_name_regexp": obj.get("extractCustomDocumentAttributeNameRegexp"),
            "extract_btn_menu_labels": obj.get("extractBtnMenuLabels")
        })
        return _obj
