...
class OrganizationEmailTemplateDto(object):
    ...
    def __init__(self, id=None, uid=None, type=None, name=None, subject=None, body=None, cc_address=None, bcc_address=None):  # noqa: E501
    ...
    @property
    def uid(self):
        """Gets the uid of this OrganizationEmailTemplateDto.  # noqa: E501


        :return: The uid of this OrganizationEmailTemplateDto.  # noqa: E501
        :rtype: str
        """
        return self._uid
    ...
    @uid.setter
    def uid(self, uid):
        """Sets the uid of this OrganizationEmailTemplateDto.


        :param uid: The uid of this OrganizationEmailTemplateDto.  # noqa: E501
        :type: str
        """
    ...
    def type(self, type):
        ...
        :type: str
        """
        allowed_values = ["JobAssigned", "JobStatusChanged", "NextWorkflowStep", "JobRejected", "LoginInfo", "ProjectTransferredToBuyer", "SharedProjectAssigned", "SharedProjectStatusChanged", "AutomatedProjectCreated", "AutomatedProjectSourceUpdated", "AutomatedProjectStatusChanged", "JobWidgetProjectQuotePrepared", "JobWidgetProjectQuotePreparationFailure", "JobWidgetProjectCreated", "JobWidgetProjectCompleted", "CmsQuoteReady", "CmsWorkCompleted", "CmsJobRejected", "QUOTE_UPDATED", "QUOTE_STATUS_CHANGED", "LQA_SHARE_REPORT"]  # noqa: E501
