...
class ProjectTemplateEditDto(object):
    ...
    def __init__(self, name=None, template_name=None, source_lang=None, target_langs=None, use_dynamic_title=None, dynamic_title=None, notify_provider=None, work_flow_settings=None, client=None, cost_center=None, business_unit=None, domain=None, sub_domain=None, vendor=None, import_settings=None, note=None, file_handover=None, assigned_to=None):  # noqa: E501
