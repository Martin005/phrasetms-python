...
class CountsDto(BaseModel):
    ...
    CountsDto
    """
    segments: Optional[Union[StrictFloat, StrictInt]] = None
    words: Optional[Union[StrictFloat, StrictInt]] = None
    characters: Optional[Union[StrictFloat, StrictInt]] = None
    normalized_pages: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="normalizedPages")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CountsDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CountsDto:
        ...
        _obj = CountsDto.parse_obj({
            ...
            "normalized_pages": obj.get("normalizedPages"),
            "percent": obj.get("percent"),
            "editing_time": obj.get("editingTime")
        })
        return _obj
