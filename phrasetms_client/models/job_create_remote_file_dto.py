...
class JobCreateRemoteFileDto(object):
    ...
    def connector_token(self, connector_token):
        ...
        if connector_token is None:
            raise ValueError(
                "Invalid value for `connector_token`, must not be `None`"
            )  # noqa: E501
    ...
    def remote_file_name(self, remote_file_name):
        ...
        if remote_file_name is None:
            raise ValueError(
                "Invalid value for `remote_file_name`, must not be `None`"
            )  # noqa: E501

        self._remote_file_name = remote_file_name

    @property
    def remote_file_name_regex(self) -> bool:
