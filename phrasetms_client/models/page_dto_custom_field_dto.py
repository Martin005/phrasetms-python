...
class PageDtoCustomFieldDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoCustomFieldDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoCustomFieldDto:
        ...
        _obj = PageDtoCustomFieldDto.parse_obj({
            ...
            "content": [CustomFieldDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
