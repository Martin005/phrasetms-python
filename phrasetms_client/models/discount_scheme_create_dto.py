...
from phrasetms_client.models import NetRateSchemeWorkflowStepCreate, DiscountSettingsDto
...
class DiscountSchemeCreateDto(object):
    ...
    def __init__(
        self, name=None, rates=None, workflow_step_net_schemes=None
    ):  # noqa: E501
    ...
    @property
    def workflow_step_net_schemes(self) -> list[NetRateSchemeWorkflowStepCreate]:
