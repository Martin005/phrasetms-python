...
class PageDtoLqaProfileReferenceDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoLqaProfileReferenceDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoLqaProfileReferenceDto:
        ...
        _obj = PageDtoLqaProfileReferenceDto.parse_obj({
            ...
            "content": [LqaProfileReferenceDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
