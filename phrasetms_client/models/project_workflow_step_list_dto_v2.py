...
class ProjectWorkflowStepListDtoV2(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProjectWorkflowStepListDtoV2:
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of each item in project_workflow_steps (list)
        _items = []
        if self.project_workflow_steps:
            for _item in self.project_workflow_steps:
                if _item:
                    _items.append(_item.to_dict())
            _dict['projectWorkflowSteps'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> ProjectWorkflowStepListDtoV2:
