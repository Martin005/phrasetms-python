...
from phrasetms_client.models import TermDto, TermBaseDto
...
class SearchResponseTbDto(object):
    ...
    def __init__(
        self, term_base=None, concept_id=None, source_term=None, translation_terms=None
    ):  # noqa: E501
    ...
    @property
    def term_base(self) -> TermBaseDto:
    ...
    @property
    def translation_terms(self) -> list[TermDto]:
