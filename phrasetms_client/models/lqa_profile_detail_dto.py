...
class LqaProfileDetailDto(BaseModel):
    ...
    penalty_points: PenaltyPointsDto = Field(..., alias="penaltyPoints")
    pass_fail_threshold: PassFailThresholdDto = Field(..., alias="passFailThreshold")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LqaProfileDetailDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LqaProfileDetailDto:
