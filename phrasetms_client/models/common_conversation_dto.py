...
'LQA': 'LQA'    }
    ...
    def __init__(self, id=None, type=None, date_created=None, date_modified=None, date_edited=None, created_by=None, comments=None, status=None, deleted=None):  # noqa: E501
