...
class ProjectTemplateDto(object):
    ...
    def __init__(self, id=None, uid=None, template_name=None, name=None, source_lang=None, target_langs=None, note=None, use_dynamic_title=None, dynamic_title=None, owner=None, client=None, domain=None, sub_domain=None, vendor=None, created_by=None, date_created=None, modified_by=None, date_modified=None, date_time_modified=None, workflow_steps=None, workflow_settings=None, business_unit=None, notify_providers=None, assigned_to=None, import_settings=None):  # noqa: E501
