...
class PageDtoTranslationPriceListDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoTranslationPriceListDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoTranslationPriceListDto:
        ...
        _obj = PageDtoTranslationPriceListDto.parse_obj({
            ...
            "content": [TranslationPriceListDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
