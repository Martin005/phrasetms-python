...
class PageDtoVendorDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoVendorDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoVendorDto:
        ...
        _obj = PageDtoVendorDto.parse_obj({
            ...
            "content": [VendorDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
