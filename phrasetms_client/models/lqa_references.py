...
class LQAReferences(object):
    ...
    def __init__(self, task_id=None, job_part_uid=None, trans_group_id=None, segment_id=None, conversation_title=None, conversation_title_offset=None, commented_text=None, correlation=None, lqa=None):  # noqa: E501
