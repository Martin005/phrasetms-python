...
class AddPlainCommentResultDto(BaseModel):
    ...
    """
    id: Optional[StrictStr] = Field(None, description="ID of created comment")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddPlainCommentResultDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddPlainCommentResultDto:
