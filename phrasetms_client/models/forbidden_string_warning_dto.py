...
class ForbiddenStringWarningDto(SegmentWarning):
    ...
    """
    swagger_types = {"forbidden_string": "str", "positions": "list[Position]"}
    if hasattr(SegmentWarning, "swagger_types"):
        swagger_types.update(SegmentWarning.swagger_types)

    attribute_map = {"forbidden_string": "forbiddenString", "positions": "positions"}
    if hasattr(SegmentWarning, "attribute_map"):
        attribute_map.update(SegmentWarning.attribute_map)

    def __init__(
        self, forbidden_string=None, positions=None, *args, **kwargs
    ):  # noqa: E501
    ...
    def positions(self) -> list[Position]:
        """Gets the positions of this ForbiddenStringWarningDto.  # noqa: E501


        :return: The positions of this ForbiddenStringWarningDto.  # noqa: E501
        :rtype: list[Position]
        """
    ...
    def positions(self, positions):
        """Sets the positions of this ForbiddenStringWarningDto.


        :param positions: The positions of this ForbiddenStringWarningDto.  # noqa: E501
        :type: list[Position]
        """
