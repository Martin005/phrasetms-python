...
from phrasetms_client.models import MarketoSegmentationMappingDto, VariableDto
...
class Marketo(AbstractConnectorDto):
    ...
    def identity_url(self, identity_url):
        ...
        if identity_url is None:
            raise ValueError(
                "Invalid value for `identity_url`, must not be `None`"
            )  # noqa: E501
    ...
    def connector_type(self, connector_type):
        ...
        if connector_type is None:
            raise ValueError(
                "Invalid value for `connector_type`, must not be `None`"
            )  # noqa: E501

        self._connector_type = connector_type

    @property
    def variables(self) -> list[VariableDto]:
    ...
    @property
    def segmentation_mapping(self) -> MarketoSegmentationMappingDto:
    ...
    @property
    def translate_tokens(self) -> bool:
