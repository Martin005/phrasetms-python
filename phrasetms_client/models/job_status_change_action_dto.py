...
class JobStatusChangeActionDto(BaseModel):
    ...
    """
    requested_status: Optional[StrictStr] = Field(None, alias="requestedStatus")
    notify_owner: Optional[StrictBool] = Field(None, alias="notifyOwner", description="Default: false; Both project owner and job owner are notified;                     the parameter is subordinated to notification settings in the project")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> JobStatusChangeActionDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> JobStatusChangeActionDto:
