...
class SeverityDto(BaseModel):
    ...
    SeverityDto
    """
    code: Optional[StrictInt] = Field(None, description="Code of the severity category")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeverityDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SeverityDto:
