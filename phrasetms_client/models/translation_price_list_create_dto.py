...
class TranslationPriceListCreateDto(BaseModel):
    ...
    def billing_unit_validate_enum(cls, value):
        ...
        if value not in ('Word', 'Page', 'Character', 'Hour'):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TranslationPriceListCreateDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TranslationPriceListCreateDto:
