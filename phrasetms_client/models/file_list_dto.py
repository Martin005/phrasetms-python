...
from phrasetms_client.models import FileDto
...
class FileListDto(object):
    ...
    @property
    def encoded_current_folder(self) -> str:
    ...
    @property
    def last_changed_files(self) -> list[FileDto]:
