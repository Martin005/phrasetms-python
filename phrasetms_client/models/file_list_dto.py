...
class FileListDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FileListDto:
    ...
    def to_dict(self):
        ...
        if self.files:
            ...
            _dict['files'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in last_changed_files (list)
        _items = []
        if self.last_changed_files:
            for _item in self.last_changed_files:
                if _item:
                    _items.append(_item.to_dict())
            _dict['lastChangedFiles'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> FileListDto:
        ...
        _obj = FileListDto.parse_obj({
            ...
            "last_changed_files": [FileDto.from_dict(_item) for _item in obj.get("lastChangedFiles")] if obj.get("lastChangedFiles") is not None else None
        })
        return _obj
