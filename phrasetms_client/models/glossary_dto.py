...
class GlossaryDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GlossaryDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GlossaryDto:
        ...
        _obj = GlossaryDto.parse_obj({
            ...
            "profiles": [MemsourceTranslateProfileSimpleDto.from_dict(_item) for _item in obj.get("profiles")] if obj.get("profiles") is not None else None
        })
        return _obj
