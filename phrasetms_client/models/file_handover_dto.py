...
class FileHandoverDto(BaseModel):
    ...
    FileHandoverDto
    """
    file_id: Optional[StrictStr] = Field(None, alias="fileId", description="ID of the uploaded file")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FileHandoverDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FileHandoverDto:
