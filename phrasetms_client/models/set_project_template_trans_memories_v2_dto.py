...
class SetProjectTemplateTransMemoriesV2Dto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SetProjectTemplateTransMemoriesV2Dto:
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of each item in data_per_context (list)
        _items = []
        if self.data_per_context:
            for _item in self.data_per_context:
                if _item:
                    _items.append(_item.to_dict())
            _dict['dataPerContext'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> SetProjectTemplateTransMemoriesV2Dto:
