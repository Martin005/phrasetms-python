...
class AnalyseV3Dto(object):
    ...
    def __init__(self, id=None, uid=None, inner_id=None, type=None, name=None, provider=None, created_by=None, date_created=None, net_rate_scheme=None, can_change_net_rate_scheme=None, analyse_language_parts=None, settings=None, outdated=None, import_status=None, pure_warnings=None, project=None):  # noqa: E501
    ...
    @property
    def can_change_net_rate_scheme(self):
