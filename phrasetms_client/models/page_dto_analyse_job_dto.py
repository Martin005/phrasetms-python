...
class PageDtoAnalyseJobDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoAnalyseJobDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoAnalyseJobDto:
        ...
        _obj = PageDtoAnalyseJobDto.parse_obj({
            ...
            "content": [AnalyseJobDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
