...
class AsyncExportTMByQueryDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AsyncExportTMByQueryDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AsyncExportTMByQueryDto:
        ...
        _obj = AsyncExportTMByQueryDto.parse_obj({
            ...
            "queries": [Query.from_dict(_item) for _item in obj.get("queries")] if obj.get("queries") is not None else None
        })
        return _obj
