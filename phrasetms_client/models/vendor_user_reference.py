...
class VendorUserReference(BaseModel):
    ...
    vendor_uid: Optional[StrictStr] = Field(None, alias="vendorUid")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VendorUserReference:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VendorUserReference:
