...
class SearchTbByJobRequestDto(BaseModel):
    ...
    count: Optional[StrictInt] = Field(None, description="Default: 15")
    offset: Optional[StrictInt] = Field(None, description="Default: 0")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SearchTbByJobRequestDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SearchTbByJobRequestDto:
