...
from phrasetms_client.models import LqaErrorCategoryDto, LqaSeverityDto
...
class LqaSettingsDto(object):
    ...
    @property
    def severities(self) -> list[LqaSeverityDto]:
    ...
    @property
    def categories(self) -> list[LqaErrorCategoryDto]:
