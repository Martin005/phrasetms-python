...
from phrasetms_client.models import SegmentsCountsResponseDto
...
class SegmentsCountsResponseListDto(object):
    ...
    """
    swagger_types = {"segments_counts_results": "list[SegmentsCountsResponseDto]"}

    attribute_map = {"segments_counts_results": "segmentsCountsResults"}
    ...
    @property
    def segments_counts_results(self) -> list[SegmentsCountsResponseDto]:
