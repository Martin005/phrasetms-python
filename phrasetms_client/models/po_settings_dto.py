...
class PoSettingsDto(object):
    ...
    def __init__(self, tag_regexp=None, export_multiline=None, html_sub_filter=None, segment=None, markup_sub_filter_translatable=None, markup_sub_filter_non_translatable=None, save_confirmed_segments=None, import_set_segment_confirmed_when=None, import_set_segment_locked_when=None, export_confirmed_locked=None, export_confirmed_not_locked=None, export_not_confirmed_locked=None, export_not_confirmed_not_locked=None, icu_sub_filter=None):  # noqa: E501
    ...
    @property
    def markup_sub_filter_translatable(self):
    ...
    @property
    def markup_sub_filter_non_translatable(self):
    ...
    @property
    def import_set_segment_confirmed_when(self):
    ...
    def import_set_segment_confirmed_when(self, import_set_segment_confirmed_when):
        ...
        if import_set_segment_confirmed_when not in allowed_values:
            raise ValueError(
                "Invalid value for `import_set_segment_confirmed_when` ({0}), must be one of {1}"  # noqa: E501
                .format(import_set_segment_confirmed_when, allowed_values)
            )

        self._import_set_segment_confirmed_when = import_set_segment_confirmed_when

    @property
    def import_set_segment_locked_when(self):
    ...
    def import_set_segment_locked_when(self, import_set_segment_locked_when):
        ...
        if import_set_segment_locked_when not in allowed_values:
            raise ValueError(
                "Invalid value for `import_set_segment_locked_when` ({0}), must be one of {1}"  # noqa: E501
                .format(import_set_segment_locked_when, allowed_values)
            )

        self._import_set_segment_locked_when = import_set_segment_locked_when

    @property
    def export_confirmed_locked(self):
    ...
    def export_confirmed_locked(self, export_confirmed_locked):
        ...
        if export_confirmed_locked not in allowed_values:
            raise ValueError(
                "Invalid value for `export_confirmed_locked` ({0}), must be one of {1}"  # noqa: E501
                .format(export_confirmed_locked, allowed_values)
            )

        self._export_confirmed_locked = export_confirmed_locked

    @property
    def export_confirmed_not_locked(self):
    ...
    def export_confirmed_not_locked(self, export_confirmed_not_locked):
        ...
        if export_confirmed_not_locked not in allowed_values:
            raise ValueError(
                "Invalid value for `export_confirmed_not_locked` ({0}), must be one of {1}"  # noqa: E501
                .format(export_confirmed_not_locked, allowed_values)
            )

        self._export_confirmed_not_locked = export_confirmed_not_locked

    @property
    def export_not_confirmed_locked(self):
    ...
    def export_not_confirmed_locked(self, export_not_confirmed_locked):
        ...
        if export_not_confirmed_locked not in allowed_values:
            raise ValueError(
                "Invalid value for `export_not_confirmed_locked` ({0}), must be one of {1}"  # noqa: E501
                .format(export_not_confirmed_locked, allowed_values)
            )

        self._export_not_confirmed_locked = export_not_confirmed_locked

    @property
    def export_not_confirmed_not_locked(self):
    ...
    def export_not_confirmed_not_locked(self, export_not_confirmed_not_locked):
        ...
        if export_not_confirmed_not_locked not in allowed_values:
            raise ValueError(
                "Invalid value for `export_not_confirmed_not_locked` ({0}), must be one of {1}"  # noqa: E501
                .format(export_not_confirmed_not_locked, allowed_values)
            )
