...
class LqaErrorCategoryDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LqaErrorCategoryDto:
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of each item in error_categories (list)
        _items = []
        if self.error_categories:
            for _item in self.error_categories:
                if _item:
                    _items.append(_item.to_dict())
            _dict['errorCategories'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> LqaErrorCategoryDto:
        ...
        _obj = LqaErrorCategoryDto.parse_obj({
            ...
            "error_categories": [LqaErrorCategoryDto.from_dict(_item) for _item in obj.get("errorCategories")] if obj.get("errorCategories") is not None else None
        })
        return _obj
