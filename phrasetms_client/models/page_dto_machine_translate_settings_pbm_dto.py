...
class PageDtoMachineTranslateSettingsPbmDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoMachineTranslateSettingsPbmDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoMachineTranslateSettingsPbmDto:
        ...
        _obj = PageDtoMachineTranslateSettingsPbmDto.parse_obj({
            ...
            "content": [MachineTranslateSettingsPbmDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
