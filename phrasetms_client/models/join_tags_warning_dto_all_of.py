...
class JoinTagsWarningDtoAllOf(BaseModel):
    ...
    """
    source_tags_count: Optional[StrictInt] = Field(None, alias="sourceTagsCount")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> JoinTagsWarningDtoAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> JoinTagsWarningDtoAllOf:
