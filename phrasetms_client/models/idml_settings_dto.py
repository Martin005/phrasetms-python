...
class IdmlSettingsDto(object):
    ...
    swagger_types = {
        ...
        "tag_regexp": "str",
        "extract_cross_reference_formats": "bool",
    ...
    attribute_map = {
        ...
        "extract_cross_reference_formats": "extractCrossReferenceFormats",
    ...
    def __init__(
        ...
        extract_notes=None,
        simplify_codes=None,
        extract_master_spreads=None,
        extract_locked_layers=None,
        extract_invisible_layers=None,
        extract_hidden_conditional_text=None,
        extract_hyperlinks=None,
        keep_kerning=None,
        keep_tracking=None,
        target_font=None,
        replace_font=None,
        remove_xml_elements=None,
        tag_regexp=None,
        extract_cross_reference_formats=None,
        ...
        self._extract_cross_reference_formats = None
        ...
        if extract_cross_reference_formats is not None:
            self.extract_cross_reference_formats = extract_cross_reference_formats
    ...
    @property
    def extract_master_spreads(self) -> bool:
    ...
    @property
    def extract_locked_layers(self) -> bool:
    ...
    @property
    def extract_invisible_layers(self) -> bool:
    ...
    @property
    def extract_hidden_conditional_text(self) -> bool:
    ...
    @property
    def extract_hyperlinks(self) -> bool:
    ...
    @property
    def remove_xml_elements(self) -> bool:
    ...
    @property
    def extract_cross_reference_formats(self) -> bool:
        """Gets the extract_cross_reference_formats of this IdmlSettingsDto.  # noqa: E501

        Default: true  # noqa: E501

        :return: The extract_cross_reference_formats of this IdmlSettingsDto.  # noqa: E501
        :rtype: bool
        """
        return self._extract_cross_reference_formats

    @extract_cross_reference_formats.setter
    def extract_cross_reference_formats(self, extract_cross_reference_formats):
        """Sets the extract_cross_reference_formats of this IdmlSettingsDto.

        Default: true  # noqa: E501

        :param extract_cross_reference_formats: The extract_cross_reference_formats of this IdmlSettingsDto.  # noqa: E501
        :type: bool
        """

        self._extract_cross_reference_formats = extract_cross_reference_formats
