...
class PageDtoQuoteDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoQuoteDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoQuoteDto:
        ...
        _obj = PageDtoQuoteDto.parse_obj({
            ...
            "content": [QuoteDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
