...
class Name(object):
    ...
    """
    swagger_types = {"given_name": "str", "family_name": "str"}

    attribute_map = {"given_name": "givenName", "family_name": "familyName"}
    ...
    def given_name(self, given_name):
        ...
        if given_name is None:
            raise ValueError(
                "Invalid value for `given_name`, must not be `None`"
            )  # noqa: E501
    ...
    def family_name(self, family_name):
        ...
        if family_name is None:
            raise ValueError(
                "Invalid value for `family_name`, must not be `None`"
            )  # noqa: E501
