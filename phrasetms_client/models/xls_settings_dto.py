...
class XlsSettingsDto(object):
    ...
    def __init__(self, sheet_names=None, hidden=None, comments=None, other=None, cell_flow=None, html_subfilter=None, tag_regexp=None, specified_columns=None):  # noqa: E501
