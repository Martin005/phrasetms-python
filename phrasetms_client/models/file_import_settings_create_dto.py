...
class FileImportSettingsCreateDto(object):
    ...
    def __init__(
        ...
        segmentation_rule_id=None,
        target_segmentation_rule_id=None,
        android=None,
        csv=None,
        dita=None,
        doc_book=None,
    ...
    def file_format(self, file_format):
        ...
        if file_format not in allowed_values:
            raise ValueError(
                "Invalid value for `file_format` ({0}), must be one of {1}".format(  # noqa: E501
                    file_format, allowed_values
                )
            )
    ...
    @property
    def segmentation_rule_id(self) -> int:
    ...
    @property
    def target_segmentation_rule_id(self) -> int:
