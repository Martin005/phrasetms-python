...
class EditAnalyseSettingsDto(object):
    ...
    def __init__(self, type=None, include_fuzzy_repetitions=None, separate_fuzzy_repetitions=None, include_non_translatables=None, include_machine_translation_matches=None, include_confirmed_segments=None, include_numbers=None, include_locked_segments=None, trans_memory_post_editing=None, non_translatable_post_editing=None, machine_translate_post_editing=None, count_source_units=None, include_trans_memory=None, naming_pattern=None, analyze_by_language=None, analyze_by_provider=None, allow_automatic_post_analysis=None):  # noqa: E501
    ...
    @property
    def allow_automatic_post_analysis(self):
