...
class MatchCounts101Dto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatchCounts101Dto:
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic by calling `to_dict()` of match101
        if self.match101:
            _dict['match101'] = self.match101.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> MatchCounts101Dto:
        ...
        _obj = MatchCounts101Dto.parse_obj({
            ...
            "match101": CountsDto.from_dict(obj.get("match101")) if obj.get("match101") is not None else None
        })
        return _obj
