...
class SegmentDto(object):
    ...
    def __init__(
        ...
        next_source_segment=None,
        source_tag_metadata=None,
        target_tag_metadata=None,
    ):  # noqa: E501
    ...
    def source_segment(self, source_segment):
        ...
        if source_segment is None:
            raise ValueError(
                "Invalid value for `source_segment`, must not be `None`"
            )  # noqa: E501
    ...
    def target_segment(self, target_segment):
        ...
        if target_segment is None:
            raise ValueError(
                "Invalid value for `target_segment`, must not be `None`"
            )  # noqa: E501

        self._target_segment = target_segment

    @property
    def previous_source_segment(self) -> str:
    ...
    @property
    def next_source_segment(self) -> str:
    ...
    @property
    def source_tag_metadata(self) -> list[TagMetadataDto]:
    ...
    @property
    def target_tag_metadata(self) -> list[TagMetadataDto]:
