...
from phrasetms_client.models import PreviousWorkflowDto, SegmentsCountsDto
...
class SegmentsCountsResponseDto(object):
    ...
    def __init__(
        self, job_part_uid=None, counts=None, previous_workflow=None
    ):  # noqa: E501
    ...
    @property
    def counts(self) -> SegmentsCountsDto:
    ...
    @property
    def previous_workflow(self) -> PreviousWorkflowDto:
