...
class MentionDto(object):
    ...
    def __init__(
        self,
        mention_type=None,
        mention_group_type=None,
        uid_reference=None,
        user_references=None,
        mentionable_group=None,
        tag=None,
    ):  # noqa: E501
    ...
    def mention_type(self, mention_type):
        ...
        if mention_type is None:
            raise ValueError(
                "Invalid value for `mention_type`, must not be `None`"
            )  # noqa: E501
        allowed_values = ["USER", "GROUP"]  # noqa: E501
        if mention_type not in allowed_values:
            raise ValueError(
                "Invalid value for `mention_type` ({0}), must be one of {1}".format(  # noqa: E501
                    mention_type, allowed_values
                )
            )
    ...
    @property
    def mention_group_type(self) -> str:
    ...
    def mention_group_type(self, mention_group_type):
        ...
        if mention_group_type not in allowed_values:
            raise ValueError(
                "Invalid value for `mention_group_type` ({0}), must be one of {1}".format(  # noqa: E501
                    mention_group_type, allowed_values
                )
            )
    ...
    @property
    def uid_reference(self) -> UidReference:
    ...
    @property
    def user_references(self) -> list[MentionableUserDto]:
    ...
    @property
    def mentionable_group(self) -> MentionableGroupDto:
