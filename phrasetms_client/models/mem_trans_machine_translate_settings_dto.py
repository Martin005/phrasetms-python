...
class MemTransMachineTranslateSettingsDto(BaseModel):
    ...
    glossary_supported: Optional[StrictBool] = Field(None, alias="glossarySupported")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MemTransMachineTranslateSettingsDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MemTransMachineTranslateSettingsDto:
        ...
        _obj = MemTransMachineTranslateSettingsDto.parse_obj({
            ...
            "glossary_supported": obj.get("glossarySupported"),
            "args": obj.get("args"),
