...
class PageDtoAbstractProjectDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoAbstractProjectDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoAbstractProjectDto:
        ...
        _obj = PageDtoAbstractProjectDto.parse_obj({
            ...
            "content": [AbstractProjectDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
