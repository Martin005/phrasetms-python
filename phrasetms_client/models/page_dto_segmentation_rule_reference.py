...
class PageDtoSegmentationRuleReference(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoSegmentationRuleReference:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoSegmentationRuleReference:
        ...
        _obj = PageDtoSegmentationRuleReference.parse_obj({
            ...
            "content": [SegmentationRuleReference.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
