...
class ReferenceFilePageDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReferenceFilePageDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReferenceFilePageDto:
        ...
        _obj = ReferenceFilePageDto.parse_obj({
            ...
            "content": [ReferenceFileReference.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
            "access": ReferenceFileAccessDto.from_dict(obj.get("access")) if obj.get("access") is not None else None
        })
        return _obj
