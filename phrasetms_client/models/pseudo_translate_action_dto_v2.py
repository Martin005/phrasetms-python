...
class PseudoTranslateActionDtoV2(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PseudoTranslateActionDtoV2:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PseudoTranslateActionDtoV2:
        ...
        _obj = PseudoTranslateActionDtoV2.parse_obj({
            ...
            "substitution": [SubstituteDtoV2.from_dict(_item) for _item in obj.get("substitution")] if obj.get("substitution") is not None else None
        })
        return _obj
