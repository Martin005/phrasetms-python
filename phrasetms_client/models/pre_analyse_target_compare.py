...
class PreAnalyseTargetCompare(AbstractAnalyseSettingsDto):
    ...
    def __init__(self, trans_memory_post_editing=None, non_translatable_post_editing=None, machine_translate_post_editing=None, include_fuzzy_repetitions=None, separate_fuzzy_repetitions=None, include_non_translatables=None, include_machine_translation_matches=None, *args, **kwargs):  # noqa: E501
