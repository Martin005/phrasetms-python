...
class QualityAssuranceDto(BaseModel):
    ...
    warnings_count: Optional[StrictInt] = Field(None, alias="warningsCount")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QualityAssuranceDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> QualityAssuranceDto:
