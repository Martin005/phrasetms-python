...
class PageDtoProjectTemplateReference(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoProjectTemplateReference:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoProjectTemplateReference:
        ...
        _obj = PageDtoProjectTemplateReference.parse_obj({
            ...
            "content": [ProjectTemplateReference.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
