...
class CreateTermsDto(BaseModel):
    ...
    CreateTermsDto
    """
    source_term: TermCreateByJobDto = Field(..., alias="sourceTerm")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateTermsDto:
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic by calling `to_dict()` of target_term
        if self.target_term:
            _dict['targetTerm'] = self.target_term.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> CreateTermsDto:
