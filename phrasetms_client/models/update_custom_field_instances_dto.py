...
class UpdateCustomFieldInstancesDto(object):
    ...
    def __init__(
        self, add_instances=None, remove_instances=None, update_instances=None
    ):  # noqa: E501
    ...
    @property
    def add_instances(self) -> list[CreateCustomFieldInstanceDto]:
    ...
    @property
    def remove_instances(self) -> list[UidReference]:
    ...
    @property
    def update_instances(self) -> list[UpdateCustomFieldInstanceWithUidDto]:
