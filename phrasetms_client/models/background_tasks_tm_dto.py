...
from phrasetms_client.models import MetadataResponse, AsyncRequestDto
...
class BackgroundTasksTmDto(object):
    ...
    def __init__(
        self,
        status=None,
        finished_data_text=None,
        async_request=None,
        last_task_string=None,
        metadata=None,
        last_task_ok=None,
        last_task_error=None,
        last_task_error_html=None,
    ):  # noqa: E501
    ...
    @property
    def finished_data_text(self) -> str:
    ...
    @property
    def last_task_error_html(self) -> str:
