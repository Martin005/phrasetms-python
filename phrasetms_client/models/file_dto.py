...
class FileDto(object):
    ...
    def __init__(self, id=None, name=None, encoded_name=None, content_type=None, note=None, size=None, directory=None, last_modified=None, selected=None, error=None):  # noqa: E501
