...
class AbstractUserEditDto(BaseModel):
    ...
    receive_newsletter: Optional[StrictBool] = Field(
        None, alias="receiveNewsletter", description="Default: true"
    )
    note: Optional[
        Annotated[str, StringConstraints(strict=True, max_length=4096, min_length=0)]
    ] = None
    ...
    def role_validate_enum(cls, value):
        ...
        if value not in (
            ...
            raise ValueError(
                "must be one of enum values ('SYS_ADMIN', 'SYS_ADMIN_READ', 'ADMIN', 'PROJECT_MANAGER', 'LINGUIST', 'GUEST', 'SUBMITTER')"
            )
        return value

    model_config = ConfigDict(populate_by_name=True, validate_assignment=True)
    # JSON field name that stores the object type
    _discriminator_property_name = "role"
    ...
    def from_json(
        ...
        "ADMINEDIT", "GUESTEDIT", "LINGUISTEDIT", "PROJECTMANAGEREDIT", "SUBMITTEREDIT"
    ]:
    ...
    def from_dict(
        ...
        if object_type:
            ...
            raise ValueError(
                "AbstractUserEditDto failed to lookup discriminator value from "
                + json.dumps(obj)
