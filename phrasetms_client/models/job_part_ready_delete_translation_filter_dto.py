...
class JobPartReadyDeleteTranslationFilterDto(object):
    ...
    def __init__(self, filename=None, statuses=None, target_lang=None, provider=None, owner=None, date_due=None, due_in_hours=None, overdue=None):  # noqa: E501
