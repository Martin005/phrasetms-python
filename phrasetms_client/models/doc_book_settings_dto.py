...
class DocBookSettingsDto(BaseModel):
    ...
    DocBookSettingsDto
    """
    include_tags: Optional[StrictStr] = Field(None, alias="includeTags")
    exclude_tags: Optional[StrictStr] = Field(None, alias="excludeTags")
    inline_tags: Optional[StrictStr] = Field(None, alias="inlineTags")
    inline_tags_non_translatable: Optional[StrictStr] = Field(None, alias="inlineTagsNonTranslatable")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocBookSettingsDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocBookSettingsDto:
        ...
        _obj = DocBookSettingsDto.parse_obj({
            ...
            "inline_tags_non_translatable": obj.get("inlineTagsNonTranslatable"),
