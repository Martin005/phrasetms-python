...
class SitecoreAllOf(BaseModel):
    ...
    sitecore_database: StrictStr = Field(..., alias="sitecoreDatabase")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SitecoreAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SitecoreAllOf:
        ...
        _obj = SitecoreAllOf.parse_obj({
            ...
            "host": obj.get("host"),
            "sitecore_database": obj.get("sitecoreDatabase"),
