...
class PageDtoAsyncRequestDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoAsyncRequestDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoAsyncRequestDto:
        ...
        _obj = PageDtoAsyncRequestDto.parse_obj({
            ...
            "content": [AsyncRequestDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
