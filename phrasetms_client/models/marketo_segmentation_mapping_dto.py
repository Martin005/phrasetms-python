...
class MarketoSegmentationMappingDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MarketoSegmentationMappingDto:
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of each item in segments_mapping (list)
        _items = []
        if self.segments_mapping:
            for _item in self.segments_mapping:
                if _item:
                    _items.append(_item.to_dict())
            _dict['segmentsMapping'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> MarketoSegmentationMappingDto:
