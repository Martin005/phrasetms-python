...
class FeaturesDto(object):
    ...
    def __init__(
        ...
        icu_enabled=None,
        reject_jobs=None,
        qa_highlights_enabled=None,
        lqa_bulk_comments_creation=None,
        mt_for_tm_above100_enabled=None,
    ):  # noqa: E501
    ...
    @property
    def qa_highlights_enabled(self) -> bool:
    ...
    @property
    def lqa_bulk_comments_creation(self) -> bool:
    ...
    @property
    def mt_for_tm_above100_enabled(self) -> bool:
