...
class TxtSettingsDto(BaseModel):
    ...
    translatable_text_regexp: Optional[StrictStr] = Field(None, alias="translatableTextRegexp")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TxtSettingsDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TxtSettingsDto:
        ...
        _obj = TxtSettingsDto.parse_obj({
            ...
            "regexp_capturing_groups": obj.get("regexpCapturingGroups")
        })
        return _obj
