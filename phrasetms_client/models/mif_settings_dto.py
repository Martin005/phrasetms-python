...
class MifSettingsDto(object):
    ...
    def __init__(
        self,
        extract_body_pages=None,
        extract_reference_pages=None,
        extract_master_pages=None,
        extract_hidden_pages=None,
        extract_variables=None,
        extract_index_markers=None,
        extract_links=None,
        extract_x_ref_def=None,
        extract_pgf_num_format=None,
        extract_custom_reference_pages=None,
        extract_default_reference_pages=None,
        extract_used_variables=None,
        extract_hidden_cond_text=None,
        extract_used_x_ref_def=None,
        extract_used_pgf_num_format=None,
        tag_regexp=None,
    ):  # noqa: E501
    ...
    @property
    def extract_body_pages(self) -> bool:
    ...
    @property
    def extract_reference_pages(self) -> bool:
    ...
    @property
    def extract_master_pages(self) -> bool:
    ...
    @property
    def extract_hidden_pages(self) -> bool:
    ...
    @property
    def extract_index_markers(self) -> bool:
    ...
    @property
    def extract_x_ref_def(self) -> bool:
    ...
    @property
    def extract_pgf_num_format(self) -> bool:
    ...
    @property
    def extract_custom_reference_pages(self) -> bool:
    ...
    @property
    def extract_default_reference_pages(self) -> bool:
    ...
    @property
    def extract_used_variables(self) -> bool:
    ...
    @property
    def extract_hidden_cond_text(self) -> bool:
    ...
    @property
    def extract_used_x_ref_def(self) -> bool:
    ...
    @property
    def extract_used_pgf_num_format(self) -> bool:
    ...
    def tag_regexp(self) -> str:
        """Gets the tag_regexp of this MifSettingsDto.  # noqa: E501


        :return: The tag_regexp of this MifSettingsDto.  # noqa: E501
        :rtype: str
        """
    ...
    def tag_regexp(self, tag_regexp):
        """Sets the tag_regexp of this MifSettingsDto.


        :param tag_regexp: The tag_regexp of this MifSettingsDto.  # noqa: E501
        :type: str
        """
