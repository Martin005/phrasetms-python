...
from phrasetms_client.models import SegmentWarningsDto
...
class QualityAssuranceResponseDto(object):
    ...
    """
    swagger_types = {"segment_warnings": "list[SegmentWarningsDto]", "finished": "bool"}

    attribute_map = {"segment_warnings": "segmentWarnings", "finished": "finished"}
    ...
    @property
    def segment_warnings(self) -> list[SegmentWarningsDto]:
