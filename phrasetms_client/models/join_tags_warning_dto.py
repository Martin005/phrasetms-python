...
class JoinTagsWarningDto(SegmentWarning):
    ...
    """
    swagger_types = {"source_tags_count": "int", "translation_tags_count": "int"}
    ...
    def __init__(
        self, source_tags_count=None, translation_tags_count=None, *args, **kwargs
    ):  # noqa: E501
    ...
    @property
    def source_tags_count(self) -> int:
    ...
    @property
    def translation_tags_count(self) -> int:
