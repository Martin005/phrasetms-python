...
class PageDtoNetRateSchemeReference(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoNetRateSchemeReference:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoNetRateSchemeReference:
        ...
        _obj = PageDtoNetRateSchemeReference.parse_obj({
            ...
            "content": [NetRateSchemeReference.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
