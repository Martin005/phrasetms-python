...
class PageDtoTermBaseDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoTermBaseDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoTermBaseDto:
        ...
        _obj = PageDtoTermBaseDto.parse_obj({
            ...
            "content": [TermBaseDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
