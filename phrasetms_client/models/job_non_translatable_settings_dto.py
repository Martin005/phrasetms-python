...
class JobNonTranslatableSettingsDto(BaseModel):
    ...
    """
    pre_translate_non_translatables: Optional[StrictBool] = Field(None, alias="preTranslateNonTranslatables", description="Pre-translate non-translatables. Default: true")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> JobNonTranslatableSettingsDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> JobNonTranslatableSettingsDto:
