...
class PageDtoAssignedJobDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoAssignedJobDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoAssignedJobDto:
        ...
        _obj = PageDtoAssignedJobDto.parse_obj({
            ...
            "content": [AssignedJobDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
