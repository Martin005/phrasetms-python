...
class UploadResultDto(BaseModel):
    ...
    async_task_id: Optional[StrictStr] = Field(None, alias="asyncTaskId")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UploadResultDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UploadResultDto:
        ...
        _obj = UploadResultDto.parse_obj({
            ...
            "size": obj.get("size"),
            "error": obj.get("error"),
            "async_task_id": obj.get("asyncTaskId"),
            "errors": ConnectorErrorsDto.from_dict(obj.get("errors")) if obj.get("errors") is not None else None
        })
        return _obj
