...
class MalformedWarningDto(SegmentWarning):
    ...
    def __init__(self, message=None, *args, **kwargs):  # noqa: E501
        """MalformedWarningDto - a model defined in Swagger"""  # noqa: E501
        self._message = None
    ...
    @property
    def message(self):
        """Gets the message of this MalformedWarningDto.  # noqa: E501


        :return: The message of this MalformedWarningDto.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this MalformedWarningDto.


        :param message: The message of this MalformedWarningDto.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MalformedWarningDto, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MalformedWarningDto):
            return False
