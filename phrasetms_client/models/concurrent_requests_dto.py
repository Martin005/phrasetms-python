...
class ConcurrentRequestsDto(BaseModel):
    ...
    """
    limit: Optional[StrictInt] = Field(None, description="Max number of allowed concurrent request, null value means no limit")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConcurrentRequestsDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConcurrentRequestsDto:
