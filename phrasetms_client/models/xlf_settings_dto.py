...
class XlfSettingsDto(object):
    ...
    def __init__(
        ...
        import_x_path=None,
        import_as_confirmed_x_path=None,
        import_as_locked_x_path=None,
        xsl_url=None,
        xsl_file=None,
        tag_regexp=None,
    ):  # noqa: E501
    ...
    @property
    def import_as_confirmed_x_path(self) -> str:
    ...
    @property
    def import_as_locked_x_path(self) -> str:
