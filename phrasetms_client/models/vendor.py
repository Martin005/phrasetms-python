...
class Vendor(AbstractProjectDto):
    ...
    buyer_owner: Optional[USER] = Field(None, alias="buyerOwner")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Vendor:
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic by calling `to_dict()` of buyer_owner
        if self.buyer_owner:
            _dict["buyerOwner"] = self.buyer_owner.to_dict()
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Vendor:
        ...
        _obj = Vendor.parse_obj(
            {
                ...
                "buyer_owner": USER.from_dict(obj.get("buyerOwner"))
                if obj.get("buyerOwner") is not None
                else None,
                "buyer": BuyerReference.from_dict(obj.get("buyer"))
                if obj.get("buyer") is not None
                else None,
            }
        )
        return _obj
