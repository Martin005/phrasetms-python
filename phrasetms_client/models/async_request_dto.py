...
from phrasetms_client.models import UserReference, AsyncResponseDto, ProjectReference
...
class AsyncRequestDto(object):
    ...
    @property
    def async_response(self) -> AsyncResponseDto:
    ...
    @property
    def parent(self) -> AsyncRequestDto:
