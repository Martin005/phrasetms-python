...
class ProvidersPerLanguage(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProvidersPerLanguage:
    ...
    def to_dict(self):
        ...
        if self.assigned_users:
            for _item in self.assigned_users:
                if _item:
                    _items.append(_item.to_dict())
            _dict['assignedUsers'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> ProvidersPerLanguage:
