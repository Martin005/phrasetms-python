...
class PageDtoWorkflowStepDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoWorkflowStepDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoWorkflowStepDto:
        ...
        _obj = PageDtoWorkflowStepDto.parse_obj({
            ...
            "content": [WorkflowStepDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
