...
class MarketoSegmentMappingDto(BaseModel):
    ...
    """
    segment_id: Optional[StrictInt] = Field(None, alias="segmentId")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MarketoSegmentMappingDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MarketoSegmentMappingDto:
