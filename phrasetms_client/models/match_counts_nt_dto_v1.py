...
class MatchCountsNTDtoV1(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatchCountsNTDtoV1:
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic by calling `to_dict()` of match99
        if self.match99:
            _dict['match99'] = self.match99.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> MatchCountsNTDtoV1:
