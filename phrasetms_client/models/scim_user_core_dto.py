...
from phrasetms_client.models import ScimMeta, Email, Name
...
class ScimUserCoreDto(object):
    ...
    def __init__(
        self, id=None, user_name=None, name=None, active=None, emails=None, meta=None
    ):  # noqa: E501
    ...
    def emails(self, emails):
        ...
        if emails is None:
            raise ValueError(
                "Invalid value for `emails`, must not be `None`"
            )  # noqa: E501

        self._emails = emails

    @property
    def meta(self) -> ScimMeta:
