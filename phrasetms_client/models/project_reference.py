...
class ProjectReference(object):
    ...
    def __init__(self, uid=None, inner_id=None, name=None, business_unit=None, domain=None, sub_domain=None, client=None, cost_center=None, due_date=None, created_date=None, created_by=None, owner=None, vendor=None, purchase_order=None, source_lang=None, target_langs=None, status=None, progress=None, metadata=None, note=None, deleted=None, archived=None):  # noqa: E501
