...
class CustomFieldOptionsTruncatedDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomFieldOptionsTruncatedDto:
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of each item in truncated_options (list)
        _items = []
        if self.truncated_options:
            for _item in self.truncated_options:
                if _item:
                    _items.append(_item.to_dict())
            _dict['truncatedOptions'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> CustomFieldOptionsTruncatedDto:
