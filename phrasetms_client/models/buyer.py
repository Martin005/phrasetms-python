...
class Buyer(AbstractProjectDto):
    ...
    is_published_on_job_board: Optional[StrictBool] = Field(
        None, alias="isPublishedOnJobBoard", description="Default: false"
    )
    ...
    financial_settings: Optional[Dict[str, Any]] = Field(
        None, alias="financialSettings"
    )
    archived: Optional[StrictBool] = None
    vendor_owner: Optional[USER] = Field(None, alias="vendorOwner")
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in (
            ...
            raise ValueError(
                "must be one of enum values ('NEW', 'ASSIGNED', 'COMPLETED', 'ACCEPTED_BY_VENDOR', 'DECLINED_BY_VENDOR', 'COMPLETED_BY_VENDOR', 'CANCELLED')"
            )
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Buyer:
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic by calling `to_dict()` of vendor_owner
        if self.vendor_owner:
            _dict["vendorOwner"] = self.vendor_owner.to_dict()
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Buyer:
        ...
        _obj = Buyer.parse_obj(
            {
                ...
                "domain": DomainReference.from_dict(obj.get("domain"))
                if obj.get("domain") is not None
                else None,
                "sub_domain": SubDomainReference.from_dict(obj.get("subDomain"))
                if obj.get("subDomain") is not None
                else None,
                "owner": UserReference.from_dict(obj.get("owner"))
                if obj.get("owner") is not None
                else None,
                "source_lang": obj.get("sourceLang"),
                "target_langs": obj.get("targetLangs"),
                "references": [
                    ReferenceFileReference.from_dict(_item)
                    for _item in obj.get("references")
                ]
                if obj.get("references") is not None
                else None,
                "mt_settings_per_language_list": [
                    MTSettingsPerLanguageReference.from_dict(_item)
                    for _item in obj.get("mtSettingsPerLanguageList")
                ]
                if obj.get("mtSettingsPerLanguageList") is not None
                else None,
                ...
                "client": ClientReference.from_dict(obj.get("client"))
                if obj.get("client") is not None
                else None,
                "cost_center": CostCenterReference.from_dict(obj.get("costCenter"))
                if obj.get("costCenter") is not None
                else None,
                "business_unit": BusinessUnitReference.from_dict(
                    obj.get("businessUnit")
                )
                if obj.get("businessUnit") is not None
                else None,
                ...
                "note": obj.get("note"),
                "created_by": UserReference.from_dict(obj.get("createdBy"))
                if obj.get("createdBy") is not None
                else None,
                "quality_assurance_settings": obj.get("qualityAssuranceSettings"),
                "workflow_steps": [
                    ProjectWorkflowStepDto.from_dict(_item)
                    for _item in obj.get("workflowSteps")
                ]
                ...
                "vendor_owner": USER.from_dict(obj.get("vendorOwner"))
                if obj.get("vendorOwner") is not None
                else None,
                "vendor": VendorReference.from_dict(obj.get("vendor"))
                if obj.get("vendor") is not None
                else None,
            }
        )
        return _obj
