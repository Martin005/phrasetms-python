...
class PageDtoCostCenterDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoCostCenterDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoCostCenterDto:
        ...
        _obj = PageDtoCostCenterDto.parse_obj({
            ...
            "content": [CostCenterDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
