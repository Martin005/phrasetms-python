...
class AccuracyWeightsDto(object):
    ...
    def __init__(
        ...
        untranslated=None,
        improper_tm_match=None,
        over_translation=None,
    ):  # noqa: E501
    ...
    @property
    def accuracy(self) -> ToggleableWeightDto:
    ...
    @property
    def addition(self) -> ToggleableWeightDto:
    ...
    @property
    def omission(self) -> ToggleableWeightDto:
    ...
    @property
    def mistranslation(self) -> ToggleableWeightDto:
    ...
    @property
    def under_translation(self) -> ToggleableWeightDto:
    ...
    @property
    def untranslated(self) -> ToggleableWeightDto:
    ...
    @property
    def improper_tm_match(self) -> ToggleableWeightDto:
    ...
    @property
    def over_translation(self) -> ToggleableWeightDto:
