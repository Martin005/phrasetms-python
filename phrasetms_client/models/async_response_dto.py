...
class AsyncResponseDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AsyncResponseDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AsyncResponseDto:
        ...
        _obj = AsyncResponseDto.parse_obj({
            ...
            "error_details": [ErrorDetailDto.from_dict(_item) for _item in obj.get("errorDetails")] if obj.get("errorDetails") is not None else None,
            "warnings": [ErrorDetailDto.from_dict(_item) for _item in obj.get("warnings")] if obj.get("warnings") is not None else None,
            "accepted_segments_count": obj.get("acceptedSegmentsCount")
        })
        return _obj
