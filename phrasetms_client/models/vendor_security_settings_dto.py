...
class VendorSecuritySettingsDto(object):
    ...
    def __init__(self, can_change_shared_job_due_date_enabled=None, can_change_shared_job_due_date=None, job_vendors_may_upload_references=None):  # noqa: E501
        ...
        if can_change_shared_job_due_date_enabled is not None:
            self.can_change_shared_job_due_date_enabled = can_change_shared_job_due_date_enabled
    ...
    @property
    def can_change_shared_job_due_date_enabled(self):
    ...
    def can_change_shared_job_due_date_enabled(self, can_change_shared_job_due_date_enabled):
        ...
        self._can_change_shared_job_due_date_enabled = can_change_shared_job_due_date_enabled

    @property
    def can_change_shared_job_due_date(self):
    ...
    @property
    def job_vendors_may_upload_references(self):
