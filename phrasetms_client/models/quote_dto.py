...
class QuoteDto(object):
    ...
    def __init__(self, id=None, uid=None, name=None, status=None, currency=None, billing_unit=None, created_by=None, date_created=None, total_price=None, net_rate_scheme=None, price_list=None, workflow_step_list=None, provider=None, customer_email=None, quote_type=None, editable=None, outdated=None):  # noqa: E501
