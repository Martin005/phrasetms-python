...
class PageDtoTranslationPriceSetDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoTranslationPriceSetDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoTranslationPriceSetDto:
        ...
        _obj = PageDtoTranslationPriceSetDto.parse_obj({
            ...
            "content": [TranslationPriceSetDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
