...
class PageDtoUserDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoUserDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoUserDto:
        ...
        _obj = PageDtoUserDto.parse_obj({
            ...
            "content": [UserDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
