...
class PageDtoCustomFieldOptionDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoCustomFieldOptionDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoCustomFieldOptionDto:
        ...
        _obj = PageDtoCustomFieldOptionDto.parse_obj({
            ...
            "content": [CustomFieldOptionDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
