...
class PageDtoProviderReference(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoProviderReference:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoProviderReference:
        ...
        _obj = PageDtoProviderReference.parse_obj({
            ...
            "content": [ProviderReference.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
