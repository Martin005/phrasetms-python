...
class QualityAssuranceChecksDtoV2(object):
    ...
    def __init__(self, forbidden_strings=None, enabled_checks=None, exclude_locked_segments=None, user_can_set_instant_qa=None, strict_job_status=None, regexp_rules=None):  # noqa: E501
