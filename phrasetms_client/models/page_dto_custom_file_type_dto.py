...
class PageDtoCustomFileTypeDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoCustomFileTypeDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoCustomFileTypeDto:
        ...
        _obj = PageDtoCustomFileTypeDto.parse_obj({
            ...
            "content": [CustomFileTypeDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
