...
class JobCreateRequestDto(object):
    ...
    def __init__(self, target_langs=None, due=None, workflow_settings=None, assignments=None, import_settings=None, use_project_file_import_settings=None, pre_translate=None, notify_provider=None, callback_url=None, path=None, remote_file=None):  # noqa: E501
    ...
    @property
    def use_project_file_import_settings(self):
