...
class PageDtoUploadedFileDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoUploadedFileDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoUploadedFileDto:
        ...
        _obj = PageDtoUploadedFileDto.parse_obj({
            ...
            "content": [UploadedFileDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
