...
class AnalyseReference(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AnalyseReference:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AnalyseReference:
        ...
        _obj = AnalyseReference.parse_obj({
            ...
            "analyse_language_parts": [AnalyseLanguagePartReference.from_dict(_item) for _item in obj.get("analyseLanguageParts")] if obj.get("analyseLanguageParts") is not None else None,
