...
class EditProjectV2Dto(object):
    ...
    def __init__(self, name=None, status=None, client=None, business_unit=None, domain=None, sub_domain=None, owner=None, purchase_order=None, date_due=None, note=None, file_handover=None, lqa_profiles=None, archived=None, custom_fields=None):  # noqa: E501
