...
class PageDtoWorkflowStepReference(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoWorkflowStepReference:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoWorkflowStepReference:
        ...
        _obj = PageDtoWorkflowStepReference.parse_obj({
            ...
            "content": [WorkflowStepReference.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
