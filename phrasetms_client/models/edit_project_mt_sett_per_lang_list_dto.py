...
class EditProjectMTSettPerLangListDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EditProjectMTSettPerLangListDto:
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of each item in mt_settings_per_lang_list (list)
        _items = []
        if self.mt_settings_per_lang_list:
            for _item in self.mt_settings_per_lang_list:
                if _item:
                    _items.append(_item.to_dict())
            _dict['mtSettingsPerLangList'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> EditProjectMTSettPerLangListDto:
