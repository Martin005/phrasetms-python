...
class DeleteCustomFileTypeDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteCustomFileTypeDto:
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of each item in custom_file_types (list)
        _items = []
        if self.custom_file_types:
            for _item in self.custom_file_types:
                if _item:
                    _items.append(_item.to_dict())
            _dict['customFileTypes'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> DeleteCustomFileTypeDto:
