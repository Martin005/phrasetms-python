...
class LoginResponseV3Dto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoginResponseV3Dto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoginResponseV3Dto:
        ...
        _obj = LoginResponseV3Dto.parse_obj({
            ...
            "last_invalidate_all_sessions_performed": obj.get("lastInvalidateAllSessionsPerformed")
        })
        return _obj
