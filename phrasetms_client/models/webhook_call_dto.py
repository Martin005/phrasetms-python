...
class WebhookCallDto(object):
    ...
    def __init__(self, uid=None, parent_uid=None, event_uid=None, webhook_settings=None, created_at=None, url=None, forced=None, last_forced_at=None, body=None, trigger_event=None, retry_attempt=None, status_code=None, error_message=None):  # noqa: E501
