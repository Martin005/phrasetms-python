...
from phrasetms_client.models import ConceptWithMetadataDto
...
class ConceptListResponseDto(object):
    ...
    """
    swagger_types = {"concepts": "list[ConceptWithMetadataDto]", "total_count": "int"}

    attribute_map = {"concepts": "concepts", "total_count": "totalCount"}
    ...
    @property
    def concepts(self) -> list[ConceptWithMetadataDto]:
