...
class MachineTranslateSettingsDto(object):
    ...
    def __init__(self, id=None, uid=None, base_name=None, name=None, type=None, category=None, default_=None, include_tags=None, mt_quality_estimation=None, enabled=None, args=None, langs=None):  # noqa: E501
