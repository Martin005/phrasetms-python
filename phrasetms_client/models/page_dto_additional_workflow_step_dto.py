...
class PageDtoAdditionalWorkflowStepDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoAdditionalWorkflowStepDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoAdditionalWorkflowStepDto:
        ...
        _obj = PageDtoAdditionalWorkflowStepDto.parse_obj({
            ...
            "content": [AdditionalWorkflowStepDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
