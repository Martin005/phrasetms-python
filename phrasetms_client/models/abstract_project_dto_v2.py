...
class AbstractProjectDtoV2(BaseModel):
    ...
    mt_settings_per_language_list: Optional[List[MTSettingsPerLanguageReference]] = (
        Field(None, alias="mtSettingsPerLanguageList")
    )
    user_role: Optional[StrictStr] = Field(
        None, alias="userRole", description="Response differs based on user's role"
    )
    __properties = [
        "uid",
        "internalId",
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AbstractProjectDtoV2:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AbstractProjectDtoV2:
