...
class AdobeExperienceManagerAllOf(BaseModel):
    ...
    """
    url_rewrite_find: Optional[StrictStr] = Field(None, alias="urlRewriteFind")
    url_rewrite_replace: Optional[StrictStr] = Field(None, alias="urlRewriteReplace")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AdobeExperienceManagerAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AdobeExperienceManagerAllOf:
