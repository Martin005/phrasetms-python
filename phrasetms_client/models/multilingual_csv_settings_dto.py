...
class MultilingualCsvSettingsDto(object):
    ...
    def __init__(self, source_columns=None, target_columns=None, context_note_columns=None, context_key_columns=None, tag_regexp=None, html_sub_filter=None, segmentation=None, delimiter=None, delimiter_type=None, import_rows=None, max_len_columns=None, all_target_columns=None, non_empty_segment_action=None, save_confirmed_segments_to_tm=None):  # noqa: E501
