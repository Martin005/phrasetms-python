...
class YamlSettingsDto(object):
    ...
    def __init__(
        ...
        exclude_value_regexp=None,
        context_path=None,
        context_key_path=None,
        markdown_subfilter=None,
        update_root_element_lang=None,
        locale_format=None,
        indent_empty_lines_in_string=None,
        icu_sub_filter=None,
    ):  # noqa: E501
    ...
    @property
    def exclude_value_regexp(self) -> str:
    ...
    @property
    def markdown_subfilter(self) -> bool:
    ...
    @property
    def update_root_element_lang(self) -> bool:
    ...
    def locale_format(self, locale_format):
        ...
        if locale_format not in allowed_values:
            raise ValueError(
                "Invalid value for `locale_format` ({0}), must be one of {1}".format(  # noqa: E501
                    locale_format, allowed_values
                )
            )
    ...
    @property
    def indent_empty_lines_in_string(self) -> bool:
