...
class PageDtoCustomFieldInstanceDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoCustomFieldInstanceDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoCustomFieldInstanceDto:
        ...
        _obj = PageDtoCustomFieldInstanceDto.parse_obj({
            ...
            "content": [CustomFieldInstanceDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
