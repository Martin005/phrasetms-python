...
class Contentstack(AbstractConnectorDto):
    ...
    def __init__(self, auth_type=None, region=None, non_localizable_blocks_uids=None, target_langs_field_id=None, api_key=None, source_lang=None, translate_urls=None, translate_tags=None, management_token=None, password=None, user_name=None, stack_wf_observed=None, stack_wf_upon_import=None, stack_wf_export_source=None, stack_wf_export_translate=None, *args, **kwargs):  # noqa: E501
    ...
    @property
    def non_localizable_blocks_uids(self):
    ...
    @property
    def target_langs_field_id(self):
    ...
    @property
    def stack_wf_export_source(self):
    ...
    @property
    def stack_wf_export_translate(self):
