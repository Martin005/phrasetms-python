...
class LQAReference(object):
    ...
    def __init__(self, error_category_id=None, severity_id=None, user=None, repeated=None):  # noqa: E501
    ...
    def repeated(self, repeated):
        ...
        if repeated not in allowed_values:
            raise ValueError(
                "Invalid value for `repeated` ({0}), must be one of {1}"  # noqa: E501
                .format(repeated, allowed_values)
            )
