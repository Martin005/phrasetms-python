...
class MemsourceTranslateProfileSimpleDto(BaseModel):
    ...
    memsource_translate: Optional[MemTransMachineTranslateSettingsDto] = Field(None, alias="memsourceTranslate")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MemsourceTranslateProfileSimpleDto:
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic by calling `to_dict()` of memsource_translate
        if self.memsource_translate:
            _dict['memsourceTranslate'] = self.memsource_translate.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> MemsourceTranslateProfileSimpleDto:
        ...
        _obj = MemsourceTranslateProfileSimpleDto.parse_obj({
            ...
            "memsource_translate": MemTransMachineTranslateSettingsDto.from_dict(obj.get("memsourceTranslate")) if obj.get("memsourceTranslate") is not None else None,
