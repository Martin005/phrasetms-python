...
class MdSettingsDto(object):
    ...
    def __init__(self, hard_line_breaks_segments=None, preserve_white_spaces=None, tag_regexp=None, custom_elements=None, ignored_block_prefixes=None, flavor=None, process_jekyll_front_matter=None, extract_code_blocks=None, not_escaped_characters=None, exclude_code_elements=None):  # noqa: E501
    ...
    @property
    def exclude_code_elements(self):
