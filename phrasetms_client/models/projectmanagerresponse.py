...
class PROJECTMANAGERRESPONSE(UserDetailsDtoV3):
    ...
    @property
    def project_clients(self) -> list[ClientReference]:
    ...
    @property
    def project_business_units(self) -> list[BusinessUnitReference]:
    ...
    @property
    def project_template_clients(self) -> list[ClientReference]:
    ...
    @property
    def project_template_business_units(self) -> list[BusinessUnitReference]:
    ...
    @property
    def trans_memory_clients(self) -> list[ClientReference]:
    ...
    @property
    def trans_memory_business_units(self) -> list[BusinessUnitReference]:
    ...
    @property
    def term_base_clients(self) -> list[ClientReference]:
    ...
    @property
    def term_base_business_units(self) -> list[BusinessUnitReference]:
