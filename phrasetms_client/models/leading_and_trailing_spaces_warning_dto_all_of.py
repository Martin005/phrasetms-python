...
class LeadingAndTrailingSpacesWarningDtoAllOf(BaseModel):
    """
    LeadingAndTrailingSpacesWarningDtoAllOf
    """
    src_position: Optional[Position] = Field(None, alias="srcPosition")
    src_whitespaces: Optional[StrictStr] = Field(None, alias="srcWhitespaces")
    tgt_position: Optional[Position] = Field(None, alias="tgtPosition")
    tgt_whitespaces: Optional[StrictStr] = Field(None, alias="tgtWhitespaces")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LeadingAndTrailingSpacesWarningDtoAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LeadingAndTrailingSpacesWarningDtoAllOf:
        ...
        _obj = LeadingAndTrailingSpacesWarningDtoAllOf.parse_obj({
            ...
            "tgt_whitespaces": obj.get("tgtWhitespaces"),
            "suggestion": Suggestion.from_dict(obj.get("suggestion")) if obj.get("suggestion") is not None else None
        })
        return _obj
