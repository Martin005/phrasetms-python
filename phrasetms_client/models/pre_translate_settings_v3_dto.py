...
class PreTranslateSettingsV3Dto(object):
    ...
    def __init__(
        self,
        pre_translate_on_job_creation=None,
    ...
    @property
    def pre_translate_on_job_creation(self) -> bool:
    ...
    @property
    def translation_memory_settings(self) -> TranslationMemorySettingsDto:
    ...
    @property
    def machine_translation_settings(self) -> MachineTranslationSettingsDto:
    ...
    @property
    def non_translatable_settings(self) -> NonTranslatableSettingsDto:
    ...
    @property
    def repetitions_settings(self) -> RepetitionsSettingsDto:
