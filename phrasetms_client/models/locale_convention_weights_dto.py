...
class LocaleConventionWeightsDto(object):
    ...
    def __init__(self, locale_convention=None, address_format=None, date_format=None, currency_format=None, measurement_format=None, shortcut_key=None, telephone_format=None):  # noqa: E501
