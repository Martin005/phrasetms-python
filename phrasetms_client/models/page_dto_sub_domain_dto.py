...
class PageDtoSubDomainDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoSubDomainDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoSubDomainDto:
        ...
        _obj = PageDtoSubDomainDto.parse_obj({
            ...
            "content": [SubDomainDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
