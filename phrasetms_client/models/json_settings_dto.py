...
class JsonSettingsDto(object):
    ...
    def __init__(
        ...
        icu_sub_filter=None,
        exclude_key_regexp=None,
        include_key_regexp=None,
        context_note_path=None,
        max_len_path=None,
    ...
    @property
    def exclude_key_regexp(self) -> str:
    ...
    @property
    def include_key_regexp(self) -> str:
    ...
    @property
    def context_note_path(self) -> str:
