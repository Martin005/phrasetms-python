...
class TrailingPunctuationWarningDtoAllOf(BaseModel):
    ...
    src_end_punctuation: Optional[StrictStr] = Field(None, alias="srcEndPunctuation")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TrailingPunctuationWarningDtoAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TrailingPunctuationWarningDtoAllOf:
        ...
        _obj = TrailingPunctuationWarningDtoAllOf.parse_obj({
            ...
            "tgt_end_punctuation": obj.get("tgtEndPunctuation")
        })
        return _obj
