...
class AsyncFileOpResponseDto(BaseModel):
    ...
    def action_validate_enum(cls, value):
        ...
        if value not in ('GUI_UPLOAD', 'GUI_DOWNLOAD', 'GUI_REIMPORT', 'GUI_REIMPORT_TARGET', 'CJ_UPLOAD', 'CJ_DOWNLOAD', 'APC_UPLOAD', 'APC_DOWNLOAD', 'API_UPLOAD', 'API_DOWNLOAD', 'SUBMITTER_PORTAL_DOWNLOAD'):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AsyncFileOpResponseDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AsyncFileOpResponseDto:
