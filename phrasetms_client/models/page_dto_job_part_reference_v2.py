...
class PageDtoJobPartReferenceV2(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoJobPartReferenceV2:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoJobPartReferenceV2:
        ...
        _obj = PageDtoJobPartReferenceV2.parse_obj({
            ...
            "content": [JobPartReferenceV2.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
