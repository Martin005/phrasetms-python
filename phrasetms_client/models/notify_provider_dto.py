...
class NotifyProviderDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NotifyProviderDto:
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of organization_email_template
        if self.organization_email_template:
            _dict['organizationEmailTemplate'] = self.organization_email_template.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> NotifyProviderDto:
