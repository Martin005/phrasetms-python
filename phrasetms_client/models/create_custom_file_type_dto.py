...
class CreateCustomFileTypeDto(BaseModel):
    ...
    filename_pattern: StrictStr = Field(..., alias="filenamePattern")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateCustomFileTypeDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateCustomFileTypeDto:
