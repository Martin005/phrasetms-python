...
class PageDtoWebhookCallDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDtoWebhookCallDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDtoWebhookCallDto:
        ...
        _obj = PageDtoWebhookCallDto.parse_obj({
            ...
            "content": [WebhookCallDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
