...
class UnmodifiedFuzzyTranslationTMWarningDto(SegmentWarning):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UnmodifiedFuzzyTranslationTMWarningDto:
        """Create an instance of UnmodifiedFuzzyTranslationTMWarningDto from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UnmodifiedFuzzyTranslationTMWarningDto:
        """Create an instance of UnmodifiedFuzzyTranslationTMWarningDto from a dict"""
        if obj is None:
            return None
