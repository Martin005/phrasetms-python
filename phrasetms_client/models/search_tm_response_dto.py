...
from phrasetms_client.models import SearchTMTransMemoryDto, SearchTMSegmentDto
...
class SearchTMResponseDto(object):
    ...
    @property
    def source(self) -> SearchTMSegmentDto:
    ...
    @property
    def translations(self) -> list[SearchTMSegmentDto]:
    ...
    @property
    def trans_memory(self) -> SearchTMTransMemoryDto:
