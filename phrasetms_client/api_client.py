...
from phrasetms_client.exceptions import ApiValueError, ApiException
...
class ApiClient(object):
    ...
    def __init__(
        ...
        self.user_agent = (
            "Phrase-TMS_Python-Client-(https://github.com/Martin005/phrasetms-python)"
        )
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(phrasetms_client.models, klass)
