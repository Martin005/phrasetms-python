...
from phrasetms_client.models.add_lqa_comment_result_dto import AddLqaCommentResultDto  # noqa: E501
from phrasetms_client.rest import ApiException

class TestAddLqaCommentResultDto(unittest.TestCase):
    """AddLqaCommentResultDto unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test AddLqaCommentResultDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddLqaCommentResultDto`
        """
        model = phrasetms_client.models.add_lqa_comment_result_dto.AddLqaCommentResultDto()  # noqa: E501
        if include_optional :
            return AddLqaCommentResultDto(
                id = '', 
                conversation = phrasetms_client.models.lqa_conversation_dto.LQAConversationDto(
                    id = '', 
                    type = '', 
                    ...
                    deleted = True, 
                    references = phrasetms_client.models.lqa_references.LQAReferences(
                        task_id = '', 
                        job_part_uid = '', 
                        trans_group_id = 0, 
                        segment_id = '', 
    ...
    def testAddLqaCommentResultDto(self):
        """Test AddLqaCommentResultDto"""
