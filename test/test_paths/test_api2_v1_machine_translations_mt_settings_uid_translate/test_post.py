...
class TestApi2V1MachineTranslationsMtSettingsUidTranslate(ApiTestMixin, unittest.TestCase):
    """
    Api2V1MachineTranslationsMtSettingsUidTranslate unit test stubs
