...
from phrasetms_client.models.async_export_tmby_query_response_dto import AsyncExportTMByQueryResponseDto  # noqa: E501
from phrasetms_client.rest import ApiException

class TestAsyncExportTMByQueryResponseDto(unittest.TestCase):
    """AsyncExportTMByQueryResponseDto unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test AsyncExportTMByQueryResponseDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AsyncExportTMByQueryResponseDto`
        """
        model = phrasetms_client.models.async_export_tmby_query_response_dto.AsyncExportTMByQueryResponseDto()  # noqa: E501
        if include_optional :
            return AsyncExportTMByQueryResponseDto(
                async_request = phrasetms_client.models.async_request_dto.AsyncRequestDto(
                    ...
                    project = phrasetms_client.models.project_reference.ProjectReference(
                        ...
                        deleted = True, 
                        archived = True, ), ), 
                async_export = phrasetms_client.models.async_export_tmby_query_dto.AsyncExportTMByQueryDto(
                    async_request = phrasetms_client.models.analyse.analyse(), 
                    trans_memory = phrasetms_client.models.analyse.analyse(), 
                    export_target_langs = [
                        ''
                        ], 
                    queries = [
                        phrasetms_client.models.query.Query(
                            query = '', 
                            lang = '', )
                        ], )
            )
    ...
    def testAsyncExportTMByQueryResponseDto(self):
        """Test AsyncExportTMByQueryResponseDto"""
