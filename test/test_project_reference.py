...
from phrasetms_client.models.project_reference import ProjectReference  # noqa: E501
...
class TestProjectReference(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `ProjectReference`
        """
        model = phrasetms_client.models.project_reference.ProjectReference()  # noqa: E501
        if include_optional :
