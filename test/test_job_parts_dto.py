...
from phrasetms_client.models.job_parts_dto import JobPartsDto  # noqa: E501
from phrasetms_client.rest import ApiException

class TestJobPartsDto(unittest.TestCase):
    """JobPartsDto unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `JobPartsDto`
        """
        model = phrasetms_client.models.job_parts_dto.JobPartsDto()  # noqa: E501
        if include_optional :
            return JobPartsDto(
                jobs = [
