...
from phrasetms_client.models.analyse_v2_dto import AnalyseV2Dto  # noqa: E501
...
class TestAnalyseV2Dto(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `AnalyseV2Dto`
        """
        model = phrasetms_client.models.analyse_v2_dto.AnalyseV2Dto()  # noqa: E501
        if include_optional :
            return AnalyseV2Dto(
                id = '', 
                uid = '', 
