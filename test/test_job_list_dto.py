...
from phrasetms_client.models.job_list_dto import JobListDto  # noqa: E501
from phrasetms_client.rest import ApiException

class TestJobListDto(unittest.TestCase):
    """JobListDto unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `JobListDto`
        """
        model = phrasetms_client.models.job_list_dto.JobListDto()  # noqa: E501
        if include_optional :
            return JobListDto(
                unsupported_files = [
                    ''
