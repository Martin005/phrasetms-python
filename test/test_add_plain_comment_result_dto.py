...
from phrasetms_client.models.add_plain_comment_result_dto import AddPlainCommentResultDto  # noqa: E501
from phrasetms_client.rest import ApiException

class TestAddPlainCommentResultDto(unittest.TestCase):
    """AddPlainCommentResultDto unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test AddPlainCommentResultDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddPlainCommentResultDto`
        """
        model = phrasetms_client.models.add_plain_comment_result_dto.AddPlainCommentResultDto()  # noqa: E501
        if include_optional :
            return AddPlainCommentResultDto(
                id = '', 
                conversation = phrasetms_client.models.plain_conversation_dto.PlainConversationDto(
                    id = '', 
                    type = '', 
    ...
    def testAddPlainCommentResultDto(self):
        """Test AddPlainCommentResultDto"""
