...
from phrasetms_client.models.projectmanageredit_all_of import PROJECTMANAGEREDITAllOf  # noqa: E501
from phrasetms_client.rest import ApiException

class TestPROJECTMANAGEREDITAllOf(unittest.TestCase):
    """PROJECTMANAGEREDITAllOf unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test PROJECTMANAGEREDITAllOf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PROJECTMANAGEREDITAllOf`
        """
        model = phrasetms_client.models.projectmanageredit_all_of.PROJECTMANAGEREDITAllOf()  # noqa: E501
        if include_optional :
            return PROJECTMANAGEREDITAllOf(
                source_locales = [
                    ''
                    ], 
                target_locales = [
    ...
    def testPROJECTMANAGEREDITAllOf(self):
        """Test PROJECTMANAGEREDITAllOf"""
