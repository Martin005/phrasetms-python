...
from phrasetms_client.models.term_base_dto import TermBaseDto  # noqa: E501
from phrasetms_client.rest import ApiException

class TestTermBaseDto(unittest.TestCase):
    """TermBaseDto unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `TermBaseDto`
        """
        model = phrasetms_client.models.term_base_dto.TermBaseDto()  # noqa: E501
        if include_optional :
            return TermBaseDto(
                id = '', 
                uid = '', 
