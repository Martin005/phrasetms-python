...
from phrasetms_client.models.search_response_list_tm_dto import SearchResponseListTmDto  # noqa: E501
from phrasetms_client.rest import ApiException

class TestSearchResponseListTmDto(unittest.TestCase):
    """SearchResponseListTmDto unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SearchResponseListTmDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchResponseListTmDto`
        """
        model = phrasetms_client.models.search_response_list_tm_dto.SearchResponseListTmDto()  # noqa: E501
        if include_optional :
            return SearchResponseListTmDto(
                search_results = [
                    phrasetms_client.models.search_tm_response_dto.SearchTMResponseDto(
                        segment_id = '', 
    ...
    def testSearchResponseListTmDto(self):
        """Test SearchResponseListTmDto"""
