...
from phrasetms_client.models.analyse_recalculate_response_dto import AnalyseRecalculateResponseDto  # noqa: E501
from phrasetms_client.rest import ApiException

class TestAnalyseRecalculateResponseDto(unittest.TestCase):
    """AnalyseRecalculateResponseDto unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test AnalyseRecalculateResponseDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnalyseRecalculateResponseDto`
        """
        model = phrasetms_client.models.analyse_recalculate_response_dto.AnalyseRecalculateResponseDto()  # noqa: E501
        if include_optional :
            return AnalyseRecalculateResponseDto(
                analyses = [
                    phrasetms_client.models.async_analyse_response_dto.AsyncAnalyseResponseDto(
    ...
    def testAnalyseRecalculateResponseDto(self):
        """Test AnalyseRecalculateResponseDto"""
