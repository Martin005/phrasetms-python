...
from phrasetms_client.models.lqa_conversations_list_dto import LQAConversationsListDto  # noqa: E501
from phrasetms_client.rest import ApiException

class TestLQAConversationsListDto(unittest.TestCase):
    """LQAConversationsListDto unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test LQAConversationsListDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LQAConversationsListDto`
        """
        model = phrasetms_client.models.lqa_conversations_list_dto.LQAConversationsListDto()  # noqa: E501
        if include_optional :
            return LQAConversationsListDto(
                conversations = [
                    phrasetms_client.models.lqa_conversation_dto.LQAConversationDto(
                        id = '', 
                        type = '', 
    ...
    def testLQAConversationsListDto(self):
        """Test LQAConversationsListDto"""
