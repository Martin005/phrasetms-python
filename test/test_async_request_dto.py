...
from phrasetms_client.models.async_request_dto import AsyncRequestDto  # noqa: E501
from phrasetms_client.rest import ApiException

class TestAsyncRequestDto(unittest.TestCase):
    """AsyncRequestDto unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test AsyncRequestDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AsyncRequestDto`
        """
        model = phrasetms_client.models.async_request_dto.AsyncRequestDto()  # noqa: E501
        if include_optional :
