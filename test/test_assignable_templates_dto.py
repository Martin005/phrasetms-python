...
from phrasetms_client.models.assignable_templates_dto import AssignableTemplatesDto  # noqa: E501
from phrasetms_client.rest import ApiException

class TestAssignableTemplatesDto(unittest.TestCase):
    """AssignableTemplatesDto unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test AssignableTemplatesDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssignableTemplatesDto`
        """
        model = phrasetms_client.models.assignable_templates_dto.AssignableTemplatesDto()  # noqa: E501
        if include_optional :
            return AssignableTemplatesDto(
                assignable_templates = [
                    phrasetms_client.models.project_template_dto.ProjectTemplateDto(
                        id = '', 
                        uid = '', 
                        template_name = '', 
                        name = '', 
    ...
    def testAssignableTemplatesDto(self):
        """Test AssignableTemplatesDto"""
