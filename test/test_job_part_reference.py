...
from phrasetms_client.models.job_part_reference import JobPartReference  # noqa: E501
from phrasetms_client.rest import ApiException

class TestJobPartReference(unittest.TestCase):
    """JobPartReference unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test JobPartReference
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JobPartReference`
        """
        model = phrasetms_client.models.job_part_reference.JobPartReference()  # noqa: E501
        if include_optional :
