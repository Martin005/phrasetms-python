...
from phrasetms_client.models.search_jobs_dto import SearchJobsDto  # noqa: E501
from phrasetms_client.rest import ApiException

class TestSearchJobsDto(unittest.TestCase):
    """SearchJobsDto unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `SearchJobsDto`
        """
        model = phrasetms_client.models.search_jobs_dto.SearchJobsDto()  # noqa: E501
        if include_optional :
            return SearchJobsDto(
                jobs = [
                    phrasetms_client.models.job_part_extended_dto.JobPartExtendedDto(
                        uid = '', 
                        inner_id = '', 
                        status = 'NEW', 
                        providers = [
                        ...
                        begin_index = 56, 
                        end_index = 56, 
                        is_parent_job_split = True, 
                        update_source_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        update_target_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        date_created = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        job_reference = phrasetms_client.models.job_reference.JobReference(
                            uid = '', 
                            filename = '', ), 
                        project = phrasetms_client.models.project_reference.ProjectReference(
                            ...
                            deleted = True, 
                            archived = True, ), 
                        last_workflow_level = 56, 
                        work_unit = phrasetms_client.models.analyse.analyse(), 
                        import_status = phrasetms_client.models.import_status_dto.ImportStatusDto(
                            status = 'RUNNING', 
                            error_message = '', ), 
                        imported = True, 
                        continuous = True, 
                        continuous_job_info = phrasetms_client.models.continuous_job_info_dto.ContinuousJobInfoDto(
