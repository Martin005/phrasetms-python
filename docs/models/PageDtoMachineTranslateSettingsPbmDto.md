# phrasetms_client.model.page_dto_machine_translate_settings_pbm_dto.PageDtoMachineTranslateSettingsPbmDto
...
| ----------------------------------------------------------------------- | ----------------------------------------------------------------------- | ----------------------------------------------------------------------- | ----------- | ----- |
| [**MachineTranslateSettingsPbmDto**](MachineTranslateSettingsPbmDto.md) | [**MachineTranslateSettingsPbmDto**](MachineTranslateSettingsPbmDto.md) | [**MachineTranslateSettingsPbmDto**](MachineTranslateSettingsPbmDto.md) |             |
