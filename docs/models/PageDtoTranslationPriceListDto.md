# phrasetms_client.model.page_dto_translation_price_list_dto.PageDtoTranslationPriceListDto
...
| --------------------------------------------------------- | --------------------------------------------------------- | --------------------------------------------------------- | ----------- | ----- |
| [**TranslationPriceListDto**](TranslationPriceListDto.md) | [**TranslationPriceListDto**](TranslationPriceListDto.md) | [**TranslationPriceListDto**](TranslationPriceListDto.md) |             |
