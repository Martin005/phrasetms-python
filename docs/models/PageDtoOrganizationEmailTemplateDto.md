# phrasetms_client.model.page_dto_organization_email_template_dto.PageDtoOrganizationEmailTemplateDto
...
| ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ----------- | ----- |
| [**OrganizationEmailTemplateDto**](OrganizationEmailTemplateDto.md) | [**OrganizationEmailTemplateDto**](OrganizationEmailTemplateDto.md) | [**OrganizationEmailTemplateDto**](OrganizationEmailTemplateDto.md) |             |
