# phrasetms_client.model.page_dto_project_template_reference.PageDtoProjectTemplateReference
...
| ----------------------------------------------------------- | ----------------------------------------------------------- | ----------------------------------------------------------- | ----------- | ----- |
| [**ProjectTemplateReference**](ProjectTemplateReference.md) | [**ProjectTemplateReference**](ProjectTemplateReference.md) | [**ProjectTemplateReference**](ProjectTemplateReference.md) |             |
