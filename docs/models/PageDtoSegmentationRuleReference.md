# phrasetms_client.model.page_dto_segmentation_rule_reference.PageDtoSegmentationRuleReference
...
| ------------------------------------------------------------- | ------------------------------------------------------------- | ------------------------------------------------------------- | ----------- | ----- |
| [**SegmentationRuleReference**](SegmentationRuleReference.md) | [**SegmentationRuleReference**](SegmentationRuleReference.md) | [**SegmentationRuleReference**](SegmentationRuleReference.md) |             |
