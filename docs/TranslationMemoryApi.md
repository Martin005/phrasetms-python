...
api_instance = phrasetms_client.TranslationMemoryApi()
...
> AsyncRequestWrapperV2Dto import_trans_memory_v2(content_disposition, trans_memory_uid, body=body, content_length=content_length, strict_lang_matching=strict_lang_matching, strip_native_codes=strip_native_codes)
...
try:
    # Import TMX
    api_response = api_instance.import_trans_memory_v2(content_disposition, trans_memory_uid, body=body, content_length=content_length, strict_lang_matching=strict_lang_matching, strip_native_codes=strip_native_codes)
    pprint(api_response)
except ApiException as e:
